...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [activityid](#index-activityid) | Task | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [5](#3-views) |  |  |  |  |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 2 | [activitytypecode](#index-activitytypecode) | Activity Type | entityname |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [azt_historicalowner](#index-azt_historicalowner) | Historical Owner | nvarchar |  | Yes | none | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  |  |  |  |
| 4 | [azt_recordownerid](#index-azt_recordownerid) | Record Owner | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [6](#3-views) |  |  |  | [37](#7-workflows) |  | [9](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 5 | [azt_reorderopportunityid](#index-azt_reorderopportunityid) | Reorder Opportunity | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 6 | [azt_tasktype](#index-azt_tasktype) | Task Type | picklist | 327630000: Standard Task, 327630001: Reorder Task | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 7 | [category](#index-category) | Category | nvarchar |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  | Task | CreatedById | CreatedById |  | [1](#3-views) |  |  |  | [1](#7-workflows) |  |  |  |  |  |  |
| 9 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  | Task | CreatedDate | CreatedDate |  |  |  |  |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [description](#index-description) | Description | ntext |  | No | none | true |  |  |  | Task | Description | Description |  |  |  |  |  |  |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 11 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  | Task | LastModifiedDate | LastModifiedDate |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 12 | [ownerid](#index-ownerid) | Owner | lookup |  | No | required | true |  |  |  | Task | OwnerId | OwnerId |  | [4](#3-views) |  |  |  | [1](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [prioritycode](#index-prioritycode) | Priority | picklist |  | No | none | true |  |  |  | Task | Priority | Priority |  | [5](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 14 | [regardingobjectid](#index-regardingobjectid) | Regarding | lookup |  | No | none | true |  |  |  |  |  |  |  | [5](#3-views) |  |  |  | [14](#7-workflows) |  | [8](#10-plugin-source-code-analysis) |  | [32](#12-relationships) |  |  |
| 15 | [scheduledend](#index-scheduledend) | Due Date | datetime |  | No | none | true |  |  |  | Task | ActivityDate | ActivityDate |  | [8](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 16 | [statecode](#index-statecode) | Activity Status | picklist |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 17 | [statuscode](#index-statuscode) | Status Reason | picklist |  | No | none | true |  |  |  |  |  |  |  | [2](#3-views) |  |  |  |  |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 18 | [subject](#index-subject) | Subject | nvarchar |  | No | required | true |  |  |  | Task | Subject | Subject |  | [7](#3-views) |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 19 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
