...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_customerid](#index-azt_customerid) | Customer | lookup |  | Yes | none | true |  |  |  |  |  |  | [2](#2-forms) | [7](#3-views) |  |  |  | [1](#7-workflows) |  | [5](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 2 | [azt_isbn](#index-azt_isbn) | ISBN | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [8](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [azt_name](#index-azt_name) | Name | nvarchar |  | Yes | required | true |  |  |  |  |  |  | [3](#2-forms) | [1](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [azt_printproductid](#index-azt_printproductid) | Print Product | lookup |  | Yes | none | true |  |  |  |  |  |  | [2](#2-forms) | [15](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 5 | [azt_printpurchaseid](#index-azt_printpurchaseid) | Print Purchase | primarykey |  | No | systemrequired | true |  |  |  |  |  |  |  | [8](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 6 | [azt_purchasedate](#index-azt_purchasedate) | Purchase Date | datetime |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [14](#3-views) |  |  |  | [1](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [azt_quantity](#index-azt_quantity) | Quantity | int |  | Yes | required | true |  |  |  |  |  |  | [2](#2-forms) | [7](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [azt_recordownerid](#index-azt_recordownerid) | Record Owner | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [37](#7-workflows) |  | [9](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 9 | [azt_writeinproduct](#index-azt_writeinproduct) | Write-In Product | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 10 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 11 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 12 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 13 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 14 | [modifiedby](#index-modifiedby) | Modified By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 15 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 16 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 17 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 18 | [ownerid](#index-ownerid) | Owner | owner |  | No | systemrequired | true |  |  |  |  |  |  | [3](#2-forms) | [1](#3-views) |  |  |  | [24](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 19 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 20 | [owningteam](#index-owningteam) | Owning Team | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 21 | [owninguser](#index-owninguser) | Owning User | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 22 | [statecode](#index-statecode) | Status | state |  | No | systemrequired | true |  |  |  |  |  |  |  | [7](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
