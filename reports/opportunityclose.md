...
- [7. Workflows](#7.%20Workflows)
  ...
  - [7.7. ExpenseNotificationManager](#7.7.%20ExpenseNotificationManager)
  - [7.8. ExpenseReportRejectedNotification](#7.8.%20ExpenseReportRejectedNotification)
  - [7.9. FSRLeadDistibutionNotification](#7.9.%20FSRLeadDistibutionNotification)
  - [7.10. NewFSRLeadNotification](#7.10.%20NewFSRLeadNotification)
  - [7.11. PhonecallAuto-Assign](#7.11.%20PhonecallAuto-Assign)
  - [7.12. SendQuote](#7.12.%20SendQuote)
  - [7.13. TaskAuto-Assign](#7.13.%20TaskAuto-Assign)
  - [7.14. WonOpportunityEmail](#7.14.%20WonOpportunityEmail)
...
| 192 | [description](#description) | Description | ntext |  | No | none |  | R | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [7](#10.%20Plugin%20Source%20Code%20Analysis) |  |  |  |  |
...
| 257 | [regardingobjectid](#regardingobjectid) | Regarding | lookup |  | No | none |  | C R U | true |  |  |  |  |  |  |  |  |  |  |  | [14](#7.%20Workflows) |  | [8](#10.%20Plugin%20Source%20Code%20Analysis) |  | [2](#12.%20Relationships) |  |  |
...
| 278 | [subject](#subject) |  |  |  | No |  |  |  | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [3](#10.%20Plugin%20Source%20Code%20Analysis) |  |  |  |  |
...
### 7.7. ExpenseNotificationManager
...
### 7.8. ExpenseReportRejectedNotification
...
### 7.9. FSRLeadDistibutionNotification
...
|-------------------|------|-------------------|-------------------|-------------|
| account_OpportunityCloses | N:1 | Account | OpportunityClose | [RegardingObjectId](#RegardingObjectId) |
| incident_OpportunityCloses | N:1 | Incident | OpportunityClose | [RegardingObjectId](#RegardingObjectId) |
...
- [Workflow: ExpenseNotificationManager (Write)](#7.7.%20ExpenseNotificationManager)
- [Workflow: ExpenseReportRejectedNotification (Write)](#7.8.%20ExpenseReportRejectedNotification)
- [Workflow: FSRLeadDistibutionNotification (Write)](#7.9.%20FSRLeadDistibutionNotification)
- [Workflow: NewFSRLeadNotification (Write)](#7.10.%20NewFSRLeadNotification)
- [Workflow: PhonecallAuto-Assign (Read)](#7.11.%20PhonecallAuto-Assign)
- [Workflow: SendQuote (Write)](#7.12.%20SendQuote)
- [Workflow: TaskAuto-Assign (Read)](#7.13.%20TaskAuto-Assign)
- [Workflow: WonOpportunityEmail (Write)](#7.14.%20WonOpportunityEmail)
