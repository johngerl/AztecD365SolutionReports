...
| 12 | [azt_accountid](#index-azt_accountid) | Account | lookup | Yes | none | Solution Export |
...
| 57 | [azt_evaluate](#index-azt_evaluate) |  |  | Yes |  | Inferred from Usage |
...
| 117 | [azt_paid](#index-azt_paid) | Paid? | bit | Yes | none | Solution Export |
...
| 159 | [azt_servicetype](#index-azt_servicetype) | Training Type | picklist | Yes | none | Solution Export |
...
| 170 | [azt_total](#index-azt_total) |  |  | Yes |  | Inferred from Usage |
| 171 | [azt_totalamountpaid](#index-azt_totalamountpaid) |  |  | Yes |  | Inferred from Usage |
| 172 | [azt_totalfunding](#index-azt_totalfunding) |  |  | Yes |  | Inferred from Usage |
| 173 | [azt_totalreimbursement](#index-azt_totalreimbursement) |  |  | Yes |  | Inferred from Usage |
| 174 | [azt_trackingnumber](#index-azt_trackingnumber) |  |  | Yes |  | Inferred from Usage |
| 175 | [azt_trackingnumbers](#index-azt_trackingnumbers) |  |  | Yes |  | Inferred from Usage |
| 176 | [azt_trainerid](#index-azt_trainerid) | Trainer | lookup | Yes | none | Solution Export |
| 177 | [azt_trainingcourse](#index-azt_trainingcourse) | Training Course | picklist | Yes | none | Solution Export |
| 178 | [azt_trainingdate](#index-azt_trainingdate) | Training Date | datetime | Yes | none | Solution Export |
| 179 | [azt_trainingid](#index-azt_trainingid) | Training | primarykey | No | systemrequired | Solution Export |
...
| 203 | [createdby](#index-createdby) | Created By | lookup | No | none | Solution Export |
| 204 | [createdon](#index-createdon) | Created On | datetime | No | none | Solution Export |
| 205 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup | No | none | Solution Export |
| 206 | [crm3_expenseamount](#index-crm3_expenseamount) |  |  | No |  | Inferred from Usage |
| 207 | [crm3_parentleadid](#index-crm3_parentleadid) |  |  | No |  | Inferred from Usage |
| 208 | [customerid](#index-customerid) |  |  | No |  | Inferred from Usage |
| 209 | [datefulfilled](#index-datefulfilled) |  |  | No |  | Inferred from Usage |
| 210 | [defaultuomid](#index-defaultuomid) |  |  | No |  | Inferred from Usage |
| 211 | [description](#index-description) |  |  | No |  | Inferred from Usage |
| 212 | [discountamount](#index-discountamount) |  |  | No |  | Inferred from Usage |
| 213 | [discountpercentage](#index-discountpercentage) |  |  | No |  | Inferred from Usage |
| 214 | [emailaddress1](#index-emailaddress1) |  |  | No |  | Inferred from Usage |
| 215 | [estimatedclosedate](#index-estimatedclosedate) |  |  | No |  | Inferred from Usage |
| 216 | [estimatedvalue](#index-estimatedvalue) |  |  | No |  | Inferred from Usage |
...
| 231 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int | No | none | Solution Export |
...
| 250 | [modifiedby](#index-modifiedby) | Modified By | lookup | No | none | Solution Export |
| 251 | [modifiedon](#index-modifiedon) | Modified On | datetime | No | none | Solution Export |
| 252 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup | No | none | Solution Export |
| 253 | [name](#index-name) |  |  | No |  | Inferred from Usage |
| 254 | [notescontrol](#index-notescontrol) |  |  | No |  | Inferred from Usage |
| 255 | [objectid](#index-objectid) |  |  | No |  | Inferred from Usage |
| 256 | [objecttypecode](#index-objecttypecode) |  |  | No |  | Inferred from Usage |
| 257 | [opportunityid](#index-opportunityid) |  |  | No |  | Inferred from Usage |
| 258 | [opportunityproductid](#index-opportunityproductid) |  |  | No |  | Inferred from Usage |
| 259 | [originatingleadid](#index-originatingleadid) |  |  | No |  | Inferred from Usage |
| 260 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime | No | none | Solution Export |
| 261 | [ownerid](#index-ownerid) | Owner | owner | No | systemrequired | Solution Export |
| 262 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup | No | none | Solution Export |
| 263 | [owningteam](#index-owningteam) | Owning Team | lookup | No | none | Solution Export |
| 264 | [owninguser](#index-owninguser) | Owning User | lookup | No | none | Solution Export |
| 265 | [parentaccountid](#index-parentaccountid) |  |  | No |  | Inferred from Usage |
| 266 | [parentcontactid](#index-parentcontactid) |  |  | No |  | Inferred from Usage |
| 267 | [parentcustomerid](#index-parentcustomerid) |  |  | No |  | Inferred from Usage |
| 268 | [parentgoalid](#index-parentgoalid) |  |  | No |  | Inferred from Usage |
| 269 | [parentsystemuserid](#index-parentsystemuserid) |  |  | No |  | Inferred from Usage |
| 270 | [partyid](#index-partyid) |  |  | No |  | Inferred from Usage |
| 271 | [phonenumber](#index-phonenumber) |  |  | No |  | Inferred from Usage |
| 272 | [pricelevelid](#index-pricelevelid) |  |  | No |  | Inferred from Usage |
| 273 | [priceperunit](#index-priceperunit) |  |  | No |  | Inferred from Usage |
| 274 | [primarycontactid](#index-primarycontactid) |  |  | No |  | Inferred from Usage |
| 275 | [prod.productid](#index-prodproductid) |  |  | No |  | Inferred from Usage |
| 276 | [productdescription](#index-productdescription) |  |  | No |  | Inferred from Usage |
| 277 | [productid](#index-productid) |  |  | No |  | Inferred from Usage |
| 278 | [productname](#index-productname) |  |  | No |  | Inferred from Usage |
| 279 | [productnumber](#index-productnumber) |  |  | No |  | Inferred from Usage |
| 280 | [producttypecode](#index-producttypecode) |  |  | No |  | Inferred from Usage |
| 281 | [quantity](#index-quantity) |  |  | No |  | Inferred from Usage |
| 282 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 283 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 284 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 285 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 286 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
| 287 | [record1id](#index-record1id) |  |  | No |  | Inferred from Usage |
| 288 | [record1roleid](#index-record1roleid) |  |  | No |  | Inferred from Usage |
| 289 | [record2id](#index-record2id) |  |  | No |  | Inferred from Usage |
| 290 | [record2roleid](#index-record2roleid) |  |  | No |  | Inferred from Usage |
| 291 | [regardingobjectid](#index-regardingobjectid) |  |  | No |  | Inferred from Usage |
| 292 | [requestdeliveryby](#index-requestdeliveryby) |  |  | No |  | Inferred from Usage |
| 293 | [roleid](#index-roleid) |  |  | No |  | Inferred from Usage |
| 294 | [rolluponlyfromchildgoals](#index-rolluponlyfromchildgoals) |  |  | No |  | Inferred from Usage |
| 295 | [rollupqueryactualmoneyid](#index-rollupqueryactualmoneyid) |  |  | No |  | Inferred from Usage |
| 296 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 297 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 298 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 299 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 300 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 301 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 302 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 303 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 304 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 305 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 306 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 307 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 308 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 309 | [statecode](#index-statecode) | Status | state | No | systemrequired | Solution Export |
| 310 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 311 | [statuscode](#index-statuscode) | Training Status | status | No | none | Solution Export |
| 312 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 313 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 314 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 315 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 316 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 317 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 318 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 319 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int | No | none | Solution Export |
| 320 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 321 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 322 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 323 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 324 | [trainingattendees](#index-trainingattendees) |  |  | No |  | Inferred from Usage |
| 325 | [transactioncurrencyid](#index-transactioncurrencyid) |  |  | No |  | Inferred from Usage |
| 326 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 327 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int | No | none | Solution Export |
| 328 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 329 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 330 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
