...
Step 6:  /evaluate-d365-migration       d365-entities/*.json          →  d365-entities/*.json (with sfSuggestedMapping)
Step 7:  /generate-d365-sf-suggestions  JSON + SF entities + matrix   →  d365-entities/*.json (with sfSuggested*)
