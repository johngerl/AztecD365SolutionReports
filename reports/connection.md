...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_verticalname](#index-azt_verticalname) | Vertical Name | picklist | 100000000: CTE, 327630000: Academic, 327630001: Workforce, 327630002: Wellness | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 2 | [connectionid](#index-connectionid) | Connection | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [description](#index-description) | Description | ntext |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [effectiveend](#index-effectiveend) | Ending | datetime |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 6 | [effectivestart](#index-effectivestart) | Starting | datetime |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 7 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [name](#index-name) | Connection Name | nvarchar |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [23](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [ownerid](#index-ownerid) | Owner | lookup |  | No | required | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [record1id](#index-record1id) | Connected From | lookup |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [5](#10-plugin-source-code-analysis) |  | [38](#12-relationships) |  |  |
| 11 | [record1roleid](#index-record1roleid) | Role (From) | lookup |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 12 | [record2id](#index-record2id) | Connected To | lookup |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [6](#3-views) |  |  |  |  |  | [6](#10-plugin-source-code-analysis) |  | [38](#12-relationships) |  |  |
| 13 | [record2roleid](#index-record2roleid) | Role (To) | lookup |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [5](#10-plugin-source-code-analysis) |  |  |  |  |
| 14 | [statecode](#index-statecode) | Status | picklist |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [statuscode](#index-statuscode) | Status Reason | picklist |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 16 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
