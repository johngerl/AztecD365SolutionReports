...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_duedate](#index-azt_duedate) | Due Date | datetime |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [3](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 2 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [enteredon](#index-enteredon) | Entered Queue | datetime |  | No | none | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 4 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [msdyn_liveworkstreamid](#index-msdyn_liveworkstreamid) | Live workstream | lookup |  | Yes | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 6 | [objectid](#index-objectid) | Object | lookup |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [objecttypecode](#index-objecttypecode) | Type | picklist |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [ownerid](#index-ownerid) | Owner | lookup |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [queueid](#index-queueid) | Queue | lookup |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [queueitemid](#index-queueitemid) | Queue Item | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 11 | [state](#index-state) | Status (deprecated) | int |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#11-pcf-controls) |  |  |  |
| 12 | [statecode](#index-statecode) | Status | picklist |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [statuscode](#index-statuscode) | Status Reason | picklist |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 14 | [title](#index-title) | Title | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 16 | [workerid](#index-workerid) | Worked By | lookup |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  |  |  |  |  |  |
