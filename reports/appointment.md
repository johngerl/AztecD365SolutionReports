...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [activityid](#index-activityid) | Appointment | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [34](#3-views) |  | [1](#5-reports) |  |  |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 2 | [activitytypecode](#index-activitytypecode) | Activity Type | entityname |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [actualend](#index-actualend) | Actual End | datetime |  | No | none | true |  |  |  |  |  |  |  | [12](#3-views) | [1](#4-chart-visualizations) |  |  |  |  |  |  |  |  |  |
| 4 | [actualstart](#index-actualstart) | Actual Start | datetime |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) | [1](#4-chart-visualizations) | [1](#5-reports) |  |  |  |  |  |  |  |  |
| 5 | [azt_appointmenttype](#index-azt_appointmenttype) | Appointment Type | picklist | 100000000: Conference Call, 100000001: Offsite Cold Call, 100000002: Onsite Customer Service, 100000003: Onsite Meeting, 100000004: Onsite Presentation, 100000005: Onsite Technical, 100000006: Onsite Training, 100000010: Other, 293130000: Trade Show, 100000007: Web Implementation, 100000008: Web Training, 100000009: Webinar | Yes | required | true |  |  |  |  |  |  | [2](#2-forms) | [32](#3-views) |  | [1](#5-reports) |  |  |  |  |  |  |  |  |
| 6 | [azt_historicalowner](#index-azt_historicalowner) | Historical Owner | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [2](#7-workflows) |  |  |  |  |  |  |
| 7 | [azt_isleadershipappointment](#index-azt_isleadershipappointment) | Is Leadership Appointment | bit | 1: Yes, 0: No | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 8 | [azt_leadershipcallwithid](#index-azt_leadershipcallwithid) | Leadership Call With | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 9 | [azt_recordownerid](#index-azt_recordownerid) | Record Owner | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [36](#3-views) | [46](#4-chart-visualizations) | [1](#5-reports) |  | [37](#7-workflows) |  | [9](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 10 | [category](#index-category) | Category | nvarchar |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 11 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  | [2](#3-views) |  | [2](#5-reports) |  | [2](#7-workflows) |  |  |  |  |  |  |
| 12 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  | [3](#5-reports) |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [description](#index-description) | Description | ntext |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 14 | [instancetypecode](#index-instancetypecode) | Recurring Type | picklist | 0: Not Recurring, 1: Recurring Master, 2: Recurring Instance, 3: Recurring Exception, 4: Recurring Future Exception | No | systemrequired | true |  |  |  |  |  |  |  | [1](#3-views) |  | [1](#5-reports) |  |  |  |  |  |  |  |  |
| 15 | [isonlinemeeting](#index-isonlinemeeting) | Is Online Meeting | bit |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 16 | [location](#index-location) | Location | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 17 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 18 | [ownerid](#index-ownerid) | Owner | lookup |  | No | required | true |  |  |  |  |  |  |  | [7](#3-views) |  | [1](#5-reports) |  | [1](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 19 | [prioritycode](#index-prioritycode) | Priority | picklist |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 20 | [regardingobjectid](#index-regardingobjectid) | Regarding | lookup |  | No | none | true |  |  |  |  |  |  |  | [2](#3-views) |  | [1](#5-reports) |  | [14](#7-workflows) |  | [8](#10-plugin-source-code-analysis) |  | [33](#12-relationships) |  |  |
| 21 | [requiredattendees](#index-requiredattendees) | Required Attendees | partylist |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 22 | [scheduledend](#index-scheduledend) | End Time | datetime |  | No | required | true |  |  |  |  |  |  |  | [30](#3-views) | [8](#4-chart-visualizations) | [1](#5-reports) |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 23 | [scheduledstart](#index-scheduledstart) | Start Time | datetime |  | No | required | true |  |  |  |  |  |  |  | [12](#3-views) | [3](#4-chart-visualizations) | [1](#5-reports) |  |  |  |  |  |  |  |  |
| 24 | [statecode](#index-statecode) | Status | picklist |  | No | required | true |  |  |  |  |  |  |  | [2](#3-views) |  | [1](#5-reports) |  |  |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 25 | [statuscode](#index-statuscode) | Status Reason | picklist |  | No | none | true |  |  |  |  |  |  |  |  |  | [1](#5-reports) |  |  |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 26 | [subject](#index-subject) | Subject | nvarchar |  | No | required | true |  |  |  |  |  |  | [2](#2-forms) | [50](#3-views) |  | [2](#5-reports) |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 27 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
