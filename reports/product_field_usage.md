...
| 81 | [azt_iscompanion](#index-azt_iscompanion) | Is Companion | bit | Yes | none | Solution Export |
| 82 | [azt_isprint](#index-azt_isprint) | Is Print | bit | Yes | none | Solution Export |
...
| 104 | [azt_nonsaastype](#index-azt_nonsaastype) | Non-SaaS Type | picklist | Yes | none | Solution Export |
...
| 142 | [azt_productcategory](#index-azt_productcategory) | Product Category | picklist | Yes | none | Solution Export |
| 143 | [azt_productdiscountid](#index-azt_productdiscountid) |  |  | Yes |  | Inferred from Usage |
| 144 | [azt_productfamily](#index-azt_productfamily) | Product Family | multiselectpicklist | Yes | none | Solution Export |
| 145 | [azt_productgroup](#index-azt_productgroup) | Product Group | picklist | Yes | none | Solution Export |
| 146 | [azt_productlanguage](#index-azt_productlanguage) | Product Language | picklist | Yes | none | Solution Export |
...
| 155 | [azt_replacementproductid](#index-azt_replacementproductid) | Replacement Product | lookup | Yes | none | Solution Export |
...
| 159 | [azt_saas](#index-azt_saas) | SAAS | bit | Yes | required | Solution Export |
| 160 | [azt_saasstatus](#index-azt_saasstatus) |  |  | Yes |  | Inferred from Usage |
| 161 | [azt_salesfamily](#index-azt_salesfamily) | Sales Family | picklist | Yes | none | Solution Export |
| 162 | [azt_salesrepid](#index-azt_salesrepid) |  |  | Yes |  | Inferred from Usage |
| 163 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) |  |  | Yes |  | Inferred from Usage |
| 164 | [azt_softwareproductid](#index-azt_softwareproductid) |  |  | Yes |  | Inferred from Usage |
| 165 | [azt_startdate](#index-azt_startdate) |  |  | Yes |  | Inferred from Usage |
| 166 | [azt_stateabbreviation](#index-azt_stateabbreviation) |  |  | Yes |  | Inferred from Usage |
| 167 | [azt_stateprovince](#index-azt_stateprovince) |  |  | Yes |  | Inferred from Usage |
...
| 189 | [bpf_duration](#index-bpf_duration) |  |  | No |  | Inferred from Usage |
| 190 | [bpf_salesorderid](#index-bpf_salesorderid) |  |  | No |  | Inferred from Usage |
| 191 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) |  |  | No |  | Inferred from Usage |
| 192 | [businessunitid](#index-businessunitid) |  |  | No |  | Inferred from Usage |
| 193 | [category](#index-category) |  |  | No |  | Inferred from Usage |
| 194 | [city](#index-city) |  |  | No |  | Inferred from Usage |
| 195 | [closeprobability](#index-closeprobability) |  |  | No |  | Inferred from Usage |
| 196 | [companyname](#index-companyname) |  |  | No |  | Inferred from Usage |
| 197 | [connectionid](#index-connectionid) |  |  | No |  | Inferred from Usage |
| 198 | [connectionroleid](#index-connectionroleid) |  |  | No |  | Inferred from Usage |
| 199 | [consideronlygoalownersrecords](#index-consideronlygoalownersrecords) |  |  | No |  | Inferred from Usage |
| 200 | [contactid](#index-contactid) |  |  | No |  | Inferred from Usage |
| 201 | [country](#index-country) |  |  | No |  | Inferred from Usage |
| 202 | [county](#index-county) |  |  | No |  | Inferred from Usage |
| 203 | [createdon](#index-createdon) |  |  | No |  | Inferred from Usage |
| 204 | [crm3_expenseamount](#index-crm3_expenseamount) |  |  | No |  | Inferred from Usage |
| 205 | [crm3_parentleadid](#index-crm3_parentleadid) |  |  | No |  | Inferred from Usage |
| 206 | [customerid](#index-customerid) |  |  | No |  | Inferred from Usage |
| 207 | [datefulfilled](#index-datefulfilled) |  |  | No |  | Inferred from Usage |
| 208 | [defaultuomid](#index-defaultuomid) |  |  | No |  | Inferred from Usage |
| 209 | [description](#index-description) | Description | ntext | No | none | Solution Export |
| 210 | [discountamount](#index-discountamount) |  |  | No |  | Inferred from Usage |
| 211 | [discountpercentage](#index-discountpercentage) |  |  | No |  | Inferred from Usage |
| 212 | [emailaddress1](#index-emailaddress1) |  |  | No |  | Inferred from Usage |
| 213 | [entityimage](#index-entityimage) | Entity Image | image | No | none | Solution Export |
...
| 216 | [exchangerate](#index-exchangerate) | Exchange Rate | decimal | No | none | Solution Export |
| 217 | [ext_amt](#index-ext_amt) |  |  | No |  | Inferred from Usage |
| 218 | [extendedamount](#index-extendedamount) |  |  | No |  | Inferred from Usage |
| 219 | [fetchxml](#index-fetchxml) |  |  | No |  | Inferred from Usage |
| 220 | [filename](#index-filename) |  |  | No |  | Inferred from Usage |
| 221 | [firstname](#index-firstname) |  |  | No |  | Inferred from Usage |
| 222 | [freightamount](#index-freightamount) |  |  | No |  | Inferred from Usage |
| 223 | [freighttermscode](#index-freighttermscode) |  |  | No |  | Inferred from Usage |
| 224 | [from](#index-from) |  |  | No |  | Inferred from Usage |
| 225 | [fullname](#index-fullname) |  |  | No |  | Inferred from Usage |
| 226 | [goalenddate](#index-goalenddate) |  |  | No |  | Inferred from Usage |
| 227 | [goalid](#index-goalid) |  |  | No |  | Inferred from Usage |
| 228 | [goalownerid](#index-goalownerid) |  |  | No |  | Inferred from Usage |
| 229 | [goalrollupqueryid](#index-goalrollupqueryid) |  |  | No |  | Inferred from Usage |
| 230 | [goalstartdate](#index-goalstartdate) |  |  | No |  | Inferred from Usage |
| 231 | [hierarchypath](#index-hierarchypath) | Hierarchy Path | nvarchar | No | none | Solution Export |
| 232 | [incidentid](#index-incidentid) |  |  | No |  | Inferred from Usage |
| 233 | [internalemailaddress](#index-internalemailaddress) |  |  | No |  | Inferred from Usage |
| 234 | [invline.productid](#index-invlineproductid) |  |  | No |  | Inferred from Usage |
| 235 | [invoicedetailid](#index-invoicedetailid) |  |  | No |  | Inferred from Usage |
| 236 | [invoiceid](#index-invoiceid) |  |  | No |  | Inferred from Usage |
| 237 | [invoicenumber](#index-invoicenumber) |  |  | No |  | Inferred from Usage |
| 238 | [isamount](#index-isamount) |  |  | No |  | Inferred from Usage |
| 239 | [isfiscalperiodgoal](#index-isfiscalperiodgoal) |  |  | No |  | Inferred from Usage |
| 240 | [isocurrencycode](#index-isocurrencycode) |  |  | No |  | Inferred from Usage |
| 241 | [ispriceoverridden](#index-ispriceoverridden) |  |  | No |  | Inferred from Usage |
| 242 | [isproductoverridden](#index-isproductoverridden) |  |  | No |  | Inferred from Usage |
| 243 | [isrevenuesystemcalculated](#index-isrevenuesystemcalculated) |  |  | No |  | Inferred from Usage |
| 244 | [jobtitle](#index-jobtitle) |  |  | No |  | Inferred from Usage |
| 245 | [lastname](#index-lastname) |  |  | No |  | Inferred from Usage |
| 246 | [manualdiscountamount](#index-manualdiscountamount) |  |  | No |  | Inferred from Usage |
| 247 | [metricid](#index-metricid) |  |  | No |  | Inferred from Usage |
| 248 | [mimetype](#index-mimetype) |  |  | No |  | Inferred from Usage |
| 249 | [mobilephone](#index-mobilephone) |  |  | No |  | Inferred from Usage |
| 250 | [modifiedon](#index-modifiedon) |  |  | No |  | Inferred from Usage |
| 251 | [name](#index-name) | Name | nvarchar | No | required | Solution Export |
| 252 | [objectid](#index-objectid) |  |  | No |  | Inferred from Usage |
| 253 | [objecttypecode](#index-objecttypecode) |  |  | No |  | Inferred from Usage |
| 254 | [opportunityid](#index-opportunityid) |  |  | No |  | Inferred from Usage |
| 255 | [opportunityproductid](#index-opportunityproductid) |  |  | No |  | Inferred from Usage |
| 256 | [originatingleadid](#index-originatingleadid) |  |  | No |  | Inferred from Usage |
| 257 | [ownerid](#index-ownerid) |  |  | No |  | Inferred from Usage |
| 258 | [parentaccountid](#index-parentaccountid) |  |  | No |  | Inferred from Usage |
| 259 | [parentcontactid](#index-parentcontactid) |  |  | No |  | Inferred from Usage |
| 260 | [parentcustomerid](#index-parentcustomerid) |  |  | No |  | Inferred from Usage |
| 261 | [parentgoalid](#index-parentgoalid) |  |  | No |  | Inferred from Usage |
| 262 | [parentproductid](#index-parentproductid) |  |  | No |  | Inferred from Usage |
| 263 | [parentsystemuserid](#index-parentsystemuserid) |  |  | No |  | Inferred from Usage |
| 264 | [partyid](#index-partyid) |  |  | No |  | Inferred from Usage |
| 265 | [phonenumber](#index-phonenumber) |  |  | No |  | Inferred from Usage |
| 266 | [price](#index-price) | List Price | money | No | none | Solution Export |
| 267 | [pricelevelid](#index-pricelevelid) |  |  | No |  | Inferred from Usage |
| 268 | [priceperunit](#index-priceperunit) |  |  | No |  | Inferred from Usage |
| 269 | [primarycontactid](#index-primarycontactid) |  |  | No |  | Inferred from Usage |
| 270 | [prod.productid](#index-prodproductid) |  |  | No |  | Inferred from Usage |
| 271 | [productdescription](#index-productdescription) |  |  | No |  | Inferred from Usage |
| 272 | [productid](#index-productid) |  |  | No |  | Inferred from Usage |
| 273 | [productname](#index-productname) |  |  | No |  | Inferred from Usage |
| 274 | [productnumber](#index-productnumber) | Product ID | nvarchar | No | systemrequired | Solution Export |
| 275 | [productstructure](#index-productstructure) | Product Structure | picklist | No | systemrequired | Solution Export |
| 276 | [producttypecode](#index-producttypecode) | Product Type | picklist | No | none | Solution Export |
| 277 | [quantity](#index-quantity) |  |  | No |  | Inferred from Usage |
| 278 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 279 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 280 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 281 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 282 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
| 283 | [record1id](#index-record1id) |  |  | No |  | Inferred from Usage |
| 284 | [record1roleid](#index-record1roleid) |  |  | No |  | Inferred from Usage |
| 285 | [record2id](#index-record2id) |  |  | No |  | Inferred from Usage |
| 286 | [record2roleid](#index-record2roleid) |  |  | No |  | Inferred from Usage |
| 287 | [regardingobjectid](#index-regardingobjectid) |  |  | No |  | Inferred from Usage |
| 288 | [requestdeliveryby](#index-requestdeliveryby) |  |  | No |  | Inferred from Usage |
| 289 | [roleid](#index-roleid) |  |  | No |  | Inferred from Usage |
| 290 | [rolluponlyfromchildgoals](#index-rolluponlyfromchildgoals) |  |  | No |  | Inferred from Usage |
| 291 | [rollupqueryactualmoneyid](#index-rollupqueryactualmoneyid) |  |  | No |  | Inferred from Usage |
| 292 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 293 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 294 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 295 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 296 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 297 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 298 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 299 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 300 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 301 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 302 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 303 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 304 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 305 | [statecode](#index-statecode) | Status | state | No | systemrequired | Solution Export |
| 306 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 307 | [statuscode](#index-statuscode) |  |  | No |  | Inferred from Usage |
| 308 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 309 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 310 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 311 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 312 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 313 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 314 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 315 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 316 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 317 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 318 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 319 | [transactioncurrencyid](#index-transactioncurrencyid) |  |  | No |  | Inferred from Usage |
| 320 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 321 | [validfromdate](#index-validfromdate) |  |  | No |  | Inferred from Usage |
| 322 | [validtodate](#index-validtodate) |  |  | No |  | Inferred from Usage |
| 323 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 324 | [volumediscountamount](#index-volumediscountamount) |  |  | No |  | Inferred from Usage |
| 325 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 326 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
