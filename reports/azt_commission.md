...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_bonuspoolamount](#index-azt_bonuspoolamount) | Bonus Pool Amount | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_bonuspoolamount_base](#index-azt_bonuspoolamount_base) | Bonus Pool Amount (Base) | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 3 | [azt_combinedsales](#index-azt_combinedsales) | Combined Sales | money |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  | [1](#9-formulas-rollups) |  |  |  |  |  |
| 4 | [azt_combinedsales_base](#index-azt_combinedsales_base) | Combined Sales (Base) | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 5 | [azt_commissionid](#index-azt_commissionid) | Commission | primarykey |  | No | systemrequired | true |  |  |  |  |  |  |  | [8](#3-views) |  |  |  | [2](#7-workflows) |  | [4](#10-plugin-source-code-analysis) |  | [2](#12-relationships) |  |  |
| 6 | [azt_fiscalperiodend](#index-azt_fiscalperiodend) | Fiscal Period End | datetime |  | Yes | required | true |  |  |  |  |  |  | [1](#2-forms) | [5](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [azt_fiscalperiodstart](#index-azt_fiscalperiodstart) | Fiscal Period Start | datetime |  | Yes | required | true |  |  |  |  |  |  | [1](#2-forms) | [8](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [azt_name](#index-azt_name) | Name | nvarchar |  | Yes | required | true |  |  |  |  |  |  | [3](#2-forms) | [5](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [azt_nonsaassales](#index-azt_nonsaassales) | Non-SaaS Sales | money |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  | [1](#9-formulas-rollups) |  |  |  |  |  |
| 10 | [azt_nonsaassales_base](#index-azt_nonsaassales_base) | Non-SaaS Sales (Base) | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 11 | [azt_saassales](#index-azt_saassales) | SaaS Sales Q1 | money |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  | [1](#9-formulas-rollups) |  |  |  |  |  |
| 12 | [azt_saassales_base](#index-azt_saassales_base) | SaaS Sales (Base) | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 13 | [azt_ytdcommissionamt](#index-azt_ytdcommissionamt) | YTD Commission Amt | money |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [3](#3-views) |  |  |  |  | [1](#9-formulas-rollups) |  |  |  |  |  |
| 14 | [azt_ytdcommissionamt_base](#index-azt_ytdcommissionamt_base) | YTD Commission Amt (Base) | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 15 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 16 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 17 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 18 | [exchangerate](#index-exchangerate) | Exchange Rate | decimal |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 19 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 20 | [modifiedby](#index-modifiedby) | Modified By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 21 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 22 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 23 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 24 | [ownerid](#index-ownerid) | Sales Rep | owner |  | No | systemrequired | true |  |  |  |  |  |  | [4](#2-forms) | [12](#3-views) |  |  |  | [24](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 25 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 26 | [owningteam](#index-owningteam) | Owning Team | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 27 | [owninguser](#index-owninguser) | Owning User | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
...
| 31 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [20](#7-workflows) |  | [8](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
