...
|---|-------------|-------------|------|-----------------|--------|----------|-------------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_age](#azt_age) | Age | int |  | Yes | none | Never | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_city](#azt_city) | City | nvarchar |  | Yes | none | Never | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 3 | [azt_email](#azt_email) | Email | nvarchar |  | Yes | none | Never | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [azt_firstname](#azt_firstname) | First Name | nvarchar |  | Yes | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [azt_lastname](#azt_lastname) | Last Name | nvarchar |  | Yes | none | Never | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 6 | [azt_lessonid](#azt_lessonid) | Lesson | lookup |  | Yes | none | Never | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 7 | [azt_lessonnumberid](#azt_lessonnumberid) | Lesson Number ID | int |  | Yes | none | Never | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 8 | [azt_name](#azt_name) | Name | nvarchar |  | Yes | required | Never | true |  |  |  |  |  |  | [3](#2-forms) | [10](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [azt_studentid](#azt_studentid) | Student | primarykey |  | No | systemrequired | Never | true |  |  |  |  |  |  |  | [7](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 10 | [azt_studentnumberid](#azt_studentnumberid) | Student Number ID | int |  | Yes | none | Never | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 11 | [createdby](#createdby) | Created By | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 12 | [createdon](#createdon) | Created On | datetime |  | No | none | Skipped (createdon) | true |  |  |  |  |  |  | [1](#2-forms) | [5](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 15 | [modifiedby](#modifiedby) | Modified By | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
...
| 18 | [organizationid](#organizationid) | Organization Id | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 19 | [overriddencreatedon](#overriddencreatedon) | Record Created On | datetime |  | No | none | Never | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 20 | [statecode](#statecode) | Status | state |  | No | systemrequired | Never | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 21 | [statuscode](#statuscode) | Status Reason | status |  | No | none | Never | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
