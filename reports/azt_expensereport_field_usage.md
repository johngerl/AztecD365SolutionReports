...
| 8 | [adx_resolutiondate](#index-adx_resolutiondate) |  |  | No |  | Inferred from Usage |
| 9 | [amountdatatype](#index-amountdatatype) |  |  | No |  | Inferred from Usage |
| 10 | [annotationid](#index-annotationid) |  |  | No |  | Inferred from Usage |
| 11 | [azt_account](#index-azt_account) |  |  | Yes |  | Inferred from Usage |
| 12 | [azt_accountid](#index-azt_accountid) |  |  | Yes |  | Inferred from Usage |
| 13 | [azt_accountleadgenerationid](#index-azt_accountleadgenerationid) |  |  | Yes |  | Inferred from Usage |
| 14 | [azt_accountleadgenname](#index-azt_accountleadgenname) |  |  | Yes |  | Inferred from Usage |
| 15 | [azt_accounttype](#index-azt_accounttype) |  |  | Yes |  | Inferred from Usage |
| 16 | [azt_addresssearch](#index-azt_addresssearch) |  |  | Yes |  | Inferred from Usage |
| 17 | [azt_addresssearch2](#index-azt_addresssearch2) |  |  | Yes |  | Inferred from Usage |
| 18 | [azt_addtocrtqueue](#index-azt_addtocrtqueue) |  |  | Yes |  | Inferred from Usage |
| 19 | [azt_ageendedstage](#index-azt_ageendedstage) |  |  | Yes |  | Inferred from Usage |
| 20 | [azt_allocatedtoid](#index-azt_allocatedtoid) |  |  | Yes |  | Inferred from Usage |
| 21 | [azt_allocationtype](#index-azt_allocationtype) |  |  | Yes |  | Inferred from Usage |
...
| 25 | [azt_approvingcorporatemanagerid](#index-azt_approvingcorporatemanagerid) | Approving Corporate Manager | lookup | Yes | none | Solution Export |
| 26 | [azt_approvingmanagerid](#index-azt_approvingmanagerid) | Approving Manager | lookup | Yes | none | Solution Export |
...
| 45 | [azt_corporateapproved](#index-azt_corporateapproved) | Corporate Approved? | bit | Yes | none | Solution Export |
| 46 | [azt_currentnumber](#index-azt_currentnumber) |  |  | Yes |  | Inferred from Usage |
| 47 | [azt_customerid](#index-azt_customerid) |  |  | Yes |  | Inferred from Usage |
| 48 | [azt_customertrainingid](#index-azt_customertrainingid) |  |  | Yes |  | Inferred from Usage |
| 49 | [azt_datecorporateapproved](#index-azt_datecorporateapproved) | Date Corporate Approved | datetime | Yes | none | Solution Export |
| 50 | [azt_dateexitedstage](#index-azt_dateexitedstage) |  |  | Yes |  | Inferred from Usage |
| 51 | [azt_datemanagerapproved](#index-azt_datemanagerapproved) | Date Manager Approved | datetime | Yes | none | Solution Export |
| 52 | [azt_datepaid](#index-azt_datepaid) | Date Paid | datetime | Yes | none | Solution Export |
| 53 | [azt_datesubmitted](#index-azt_datesubmitted) | Date Submitted | datetime | Yes | none | Solution Export |
...
| 61 | [azt_enddate](#index-azt_enddate) | End Date | datetime | Yes | none | Solution Export |
| 62 | [azt_engagementid](#index-azt_engagementid) |  |  | Yes |  | Inferred from Usage |
...
| 66 | [azt_expenseid](#index-azt_expenseid) | Expense ID | nvarchar | Yes | none | Solution Export |
| 67 | [azt_expensereportid](#index-azt_expensereportid) | Expense Report | primarykey | No | systemrequired | Solution Export |
...
| 73 | [azt_fiscalperiodend](#index-azt_fiscalperiodend) |  |  | Yes |  | Inferred from Usage |
| 74 | [azt_fiscalperiodstart](#index-azt_fiscalperiodstart) |  |  | Yes |  | Inferred from Usage |
| 75 | [azt_freightamtapproved](#index-azt_freightamtapproved) |  |  | Yes |  | Inferred from Usage |
| 76 | [azt_fsrassignedon](#index-azt_fsrassignedon) |  |  | Yes |  | Inferred from Usage |
| 77 | [azt_fsremail](#index-azt_fsremail) |  |  | Yes |  | Inferred from Usage |
| 78 | [azt_fsrid](#index-azt_fsrid) |  |  | Yes |  | Inferred from Usage |
| 79 | [azt_fsrmobiletelephone](#index-azt_fsrmobiletelephone) |  |  | Yes |  | Inferred from Usage |
| 80 | [azt_fsrtelephone](#index-azt_fsrtelephone) |  |  | Yes |  | Inferred from Usage |
| 81 | [azt_fsrtelephoneextension](#index-azt_fsrtelephoneextension) |  |  | Yes |  | Inferred from Usage |
| 82 | [azt_fundingid](#index-azt_fundingid) |  |  | Yes |  | Inferred from Usage |
| 83 | [azt_fundingyear](#index-azt_fundingyear) |  |  | Yes |  | Inferred from Usage |
| 84 | [azt_goaltype](#index-azt_goaltype) |  |  | Yes |  | Inferred from Usage |
| 85 | [azt_importname](#index-azt_importname) |  |  | Yes |  | Inferred from Usage |
| 86 | [azt_invoiceid](#index-azt_invoiceid) |  |  | Yes |  | Inferred from Usage |
| 87 | [azt_invoiceproductid](#index-azt_invoiceproductid) |  |  | Yes |  | Inferred from Usage |
| 88 | [azt_isbn](#index-azt_isbn) |  |  | Yes |  | Inferred from Usage |
| 89 | [azt_iscompanion](#index-azt_iscompanion) |  |  | Yes |  | Inferred from Usage |
| 90 | [azt_ispaid](#index-azt_ispaid) | Is Paid? | bit | Yes | none | Solution Export |
| 91 | [azt_isprint](#index-azt_isprint) |  |  | Yes |  | Inferred from Usage |
| 92 | [azt_issaas](#index-azt_issaas) |  |  | Yes |  | Inferred from Usage |
| 93 | [azt_jobrole](#index-azt_jobrole) |  |  | Yes |  | Inferred from Usage |
| 94 | [azt_jobtitle](#index-azt_jobtitle) |  |  | Yes |  | Inferred from Usage |
| 95 | [azt_lastactivitydate](#index-azt_lastactivitydate) |  |  | Yes |  | Inferred from Usage |
| 96 | [azt_lastmodifiedbyid](#index-azt_lastmodifiedbyid) |  |  | Yes |  | Inferred from Usage |
| 97 | [azt_lastname](#index-azt_lastname) |  |  | Yes |  | Inferred from Usage |
| 98 | [azt_leadimportid](#index-azt_leadimportid) |  |  | Yes |  | Inferred from Usage |
| 99 | [azt_leadsourceid](#index-azt_leadsourceid) |  |  | Yes |  | Inferred from Usage |
| 100 | [azt_licensestatus](#index-azt_licensestatus) |  |  | Yes |  | Inferred from Usage |
| 101 | [azt_licenseterm](#index-azt_licenseterm) |  |  | Yes |  | Inferred from Usage |
| 102 | [azt_licensetermmonths](#index-azt_licensetermmonths) |  |  | Yes |  | Inferred from Usage |
| 103 | [azt_licensetype](#index-azt_licensetype) |  |  | Yes |  | Inferred from Usage |
| 104 | [azt_managerapproved](#index-azt_managerapproved) | Manager Approved? | bit | Yes | none | Solution Export |
...
| 108 | [azt_name](#index-azt_name) | Name | nvarchar | Yes | required | Solution Export |
...
| 127 | [azt_paidbyid](#index-azt_paidbyid) | Paid By | lookup | Yes | none | Solution Export |
| 128 | [azt_paidon](#index-azt_paidon) |  |  | Yes |  | Inferred from Usage |
| 129 | [azt_parentopportunityid](#index-azt_parentopportunityid) |  |  | Yes |  | Inferred from Usage |
| 130 | [azt_parentorderid](#index-azt_parentorderid) |  |  | Yes |  | Inferred from Usage |
| 131 | [azt_payablecommission](#index-azt_payablecommission) |  |  | Yes |  | Inferred from Usage |
| 132 | [azt_paymentdate](#index-azt_paymentdate) |  |  | Yes |  | Inferred from Usage |
| 133 | [azt_paymentid](#index-azt_paymentid) |  |  | Yes |  | Inferred from Usage |
| 134 | [azt_percentage](#index-azt_percentage) |  |  | Yes |  | Inferred from Usage |
| 135 | [azt_percentagepaid](#index-azt_percentagepaid) |  |  | Yes |  | Inferred from Usage |
| 136 | [azt_periodend](#index-azt_periodend) |  |  | Yes |  | Inferred from Usage |
| 137 | [azt_periodstart](#index-azt_periodstart) |  |  | Yes |  | Inferred from Usage |
| 138 | [azt_phone](#index-azt_phone) |  |  | Yes |  | Inferred from Usage |
| 139 | [azt_ponumber](#index-azt_ponumber) |  |  | Yes |  | Inferred from Usage |
| 140 | [azt_prefix](#index-azt_prefix) |  |  | Yes |  | Inferred from Usage |
| 141 | [azt_prefixhasseparator](#index-azt_prefixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 142 | [azt_prefixseparator](#index-azt_prefixseparator) |  |  | Yes |  | Inferred from Usage |
| 143 | [azt_prefixseparatorisspace](#index-azt_prefixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 144 | [azt_previousestclosedate](#index-azt_previousestclosedate) |  |  | Yes |  | Inferred from Usage |
| 145 | [azt_previousestimatedvalue](#index-azt_previousestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 146 | [azt_previousownerid](#index-azt_previousownerid) |  |  | Yes |  | Inferred from Usage |
| 147 | [azt_previousprobability](#index-azt_previousprobability) |  |  | Yes |  | Inferred from Usage |
| 148 | [azt_printproductid](#index-azt_printproductid) |  |  | Yes |  | Inferred from Usage |
| 149 | [azt_printpurchaseid](#index-azt_printpurchaseid) |  |  | Yes |  | Inferred from Usage |
| 150 | [azt_probability](#index-azt_probability) |  |  | Yes |  | Inferred from Usage |
| 151 | [azt_probabilitychangedon](#index-azt_probabilitychangedon) |  |  | Yes |  | Inferred from Usage |
| 152 | [azt_probabilityincreased](#index-azt_probabilityincreased) |  |  | Yes |  | Inferred from Usage |
| 153 | [azt_productdiscountid](#index-azt_productdiscountid) |  |  | Yes |  | Inferred from Usage |
| 154 | [azt_producttype](#index-azt_producttype) |  |  | Yes |  | Inferred from Usage |
| 155 | [azt_purchasedate](#index-azt_purchasedate) |  |  | Yes |  | Inferred from Usage |
| 156 | [azt_quantity](#index-azt_quantity) |  |  | Yes |  | Inferred from Usage |
| 157 | [azt_quotenumber](#index-azt_quotenumber) |  |  | Yes |  | Inferred from Usage |
| 158 | [azt_quoteproductid](#index-azt_quoteproductid) |  |  | Yes |  | Inferred from Usage |
| 159 | [azt_reasonforexpense](#index-azt_reasonforexpense) |  |  | Yes |  | Inferred from Usage |
| 160 | [azt_recordowner](#index-azt_recordowner) |  |  | Yes |  | Inferred from Usage |
| 161 | [azt_recordownerid](#index-azt_recordownerid) |  |  | Yes |  | Inferred from Usage |
| 162 | [azt_reject](#index-azt_reject) | Reject | bit | Yes | none | Solution Export |
| 163 | [azt_replacementproductid](#index-azt_replacementproductid) |  |  | Yes |  | Inferred from Usage |
| 164 | [azt_requestedfreightamt](#index-azt_requestedfreightamt) |  |  | Yes |  | Inferred from Usage |
...
| 170 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) |  |  | Yes |  | Inferred from Usage |
| 171 | [azt_softwareproductid](#index-azt_softwareproductid) |  |  | Yes |  | Inferred from Usage |
| 172 | [azt_startdate](#index-azt_startdate) | Start Date | datetime | Yes | none | Solution Export |
| 173 | [azt_stateabbreviation](#index-azt_stateabbreviation) |  |  | Yes |  | Inferred from Usage |
| 174 | [azt_stateprovince](#index-azt_stateprovince) |  |  | Yes |  | Inferred from Usage |
| 175 | [azt_submitted](#index-azt_submitted) | Submitted? | bit | Yes | none | Solution Export |
| 176 | [azt_submittedbyid](#index-azt_submittedbyid) | Submitted By | lookup | Yes | none | Solution Export |
...
| 185 | [azt_totalreimbursement](#index-azt_totalreimbursement) | Total Reimbursement | money | Yes | none | Solution Export |
| 186 | [azt_totalreimbursement_base](#index-azt_totalreimbursement_base) | Total Reimbursement (Base) | money | Yes | none | Solution Export |
| 187 | [azt_trackingnumber](#index-azt_trackingnumber) |  |  | Yes |  | Inferred from Usage |
| 188 | [azt_trackingnumbers](#index-azt_trackingnumbers) |  |  | Yes |  | Inferred from Usage |
| 189 | [azt_trainingid](#index-azt_trainingid) |  |  | Yes |  | Inferred from Usage |
| 190 | [azt_year](#index-azt_year) |  |  | Yes |  | Inferred from Usage |
| 191 | [baseamount](#index-baseamount) |  |  | No |  | Inferred from Usage |
| 192 | [billto_line1](#index-billto_line1) |  |  | No |  | Inferred from Usage |
| 193 | [billto_line2](#index-billto_line2) |  |  | No |  | Inferred from Usage |
| 194 | [billto_line3](#index-billto_line3) |  |  | No |  | Inferred from Usage |
| 195 | [billto_name](#index-billto_name) |  |  | No |  | Inferred from Usage |
| 196 | [billto_postalcode](#index-billto_postalcode) |  |  | No |  | Inferred from Usage |
| 197 | [billto_stateorprovince](#index-billto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 198 | [body](#index-body) |  |  | No |  | Inferred from Usage |
| 199 | [bpf_azt_expensereportid](#index-bpf_azt_expensereportid) |  |  | No |  | Inferred from Usage |
| 200 | [bpf_duration](#index-bpf_duration) |  |  | No |  | Inferred from Usage |
| 201 | [bpf_salesorderid](#index-bpf_salesorderid) |  |  | No |  | Inferred from Usage |
| 202 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) |  |  | No |  | Inferred from Usage |
| 203 | [businessunitid](#index-businessunitid) |  |  | No |  | Inferred from Usage |
| 204 | [category](#index-category) |  |  | No |  | Inferred from Usage |
| 205 | [city](#index-city) |  |  | No |  | Inferred from Usage |
| 206 | [closeprobability](#index-closeprobability) |  |  | No |  | Inferred from Usage |
| 207 | [companyname](#index-companyname) |  |  | No |  | Inferred from Usage |
| 208 | [connectionid](#index-connectionid) |  |  | No |  | Inferred from Usage |
| 209 | [connectionroleid](#index-connectionroleid) |  |  | No |  | Inferred from Usage |
| 210 | [consideronlygoalownersrecords](#index-consideronlygoalownersrecords) |  |  | No |  | Inferred from Usage |
| 211 | [contactid](#index-contactid) |  |  | No |  | Inferred from Usage |
| 212 | [country](#index-country) |  |  | No |  | Inferred from Usage |
| 213 | [county](#index-county) |  |  | No |  | Inferred from Usage |
| 214 | [createdby](#index-createdby) | Created By | lookup | No | none | Solution Export |
| 215 | [createdon](#index-createdon) | Created On | datetime | No | none | Solution Export |
| 216 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup | No | none | Solution Export |
| 217 | [crm3_expenseamount](#index-crm3_expenseamount) |  |  | No |  | Inferred from Usage |
| 218 | [crm3_parentleadid](#index-crm3_parentleadid) |  |  | No |  | Inferred from Usage |
| 219 | [customerid](#index-customerid) |  |  | No |  | Inferred from Usage |
| 220 | [datefulfilled](#index-datefulfilled) |  |  | No |  | Inferred from Usage |
| 221 | [defaultuomid](#index-defaultuomid) |  |  | No |  | Inferred from Usage |
| 222 | [description](#index-description) |  |  | No |  | Inferred from Usage |
| 223 | [discountamount](#index-discountamount) |  |  | No |  | Inferred from Usage |
| 224 | [discountpercentage](#index-discountpercentage) |  |  | No |  | Inferred from Usage |
| 225 | [emailaddress1](#index-emailaddress1) |  |  | No |  | Inferred from Usage |
| 226 | [estimatedclosedate](#index-estimatedclosedate) |  |  | No |  | Inferred from Usage |
| 227 | [estimatedvalue](#index-estimatedvalue) |  |  | No |  | Inferred from Usage |
| 228 | [exchangerate](#index-exchangerate) | Exchange Rate | decimal | No | none | Solution Export |
| 229 | [expenses](#index-expenses) |  |  | No |  | Inferred from Usage |
| 230 | [ext_amt](#index-ext_amt) |  |  | No |  | Inferred from Usage |
| 231 | [extendedamount](#index-extendedamount) |  |  | No |  | Inferred from Usage |
| 232 | [fetchxml](#index-fetchxml) |  |  | No |  | Inferred from Usage |
| 233 | [filename](#index-filename) |  |  | No |  | Inferred from Usage |
| 234 | [firstname](#index-firstname) |  |  | No |  | Inferred from Usage |
| 235 | [freightamount](#index-freightamount) |  |  | No |  | Inferred from Usage |
| 236 | [freighttermscode](#index-freighttermscode) |  |  | No |  | Inferred from Usage |
| 237 | [from](#index-from) |  |  | No |  | Inferred from Usage |
| 238 | [fullname](#index-fullname) |  |  | No |  | Inferred from Usage |
| 239 | [goalenddate](#index-goalenddate) |  |  | No |  | Inferred from Usage |
| 240 | [goalid](#index-goalid) |  |  | No |  | Inferred from Usage |
| 241 | [goalownerid](#index-goalownerid) |  |  | No |  | Inferred from Usage |
| 242 | [goalrollupqueryid](#index-goalrollupqueryid) |  |  | No |  | Inferred from Usage |
| 243 | [goalstartdate](#index-goalstartdate) |  |  | No |  | Inferred from Usage |
| 244 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int | No | none | Solution Export |
| 245 | [incidentid](#index-incidentid) |  |  | No |  | Inferred from Usage |
| 246 | [internalemailaddress](#index-internalemailaddress) |  |  | No |  | Inferred from Usage |
| 247 | [invline.productid](#index-invlineproductid) |  |  | No |  | Inferred from Usage |
| 248 | [invoicedetailid](#index-invoicedetailid) |  |  | No |  | Inferred from Usage |
| 249 | [invoiceid](#index-invoiceid) |  |  | No |  | Inferred from Usage |
| 250 | [invoicenumber](#index-invoicenumber) |  |  | No |  | Inferred from Usage |
| 251 | [isamount](#index-isamount) |  |  | No |  | Inferred from Usage |
| 252 | [isfiscalperiodgoal](#index-isfiscalperiodgoal) |  |  | No |  | Inferred from Usage |
| 253 | [isocurrencycode](#index-isocurrencycode) |  |  | No |  | Inferred from Usage |
| 254 | [ispriceoverridden](#index-ispriceoverridden) |  |  | No |  | Inferred from Usage |
| 255 | [isproductoverridden](#index-isproductoverridden) |  |  | No |  | Inferred from Usage |
| 256 | [isrevenuesystemcalculated](#index-isrevenuesystemcalculated) |  |  | No |  | Inferred from Usage |
| 257 | [jobtitle](#index-jobtitle) |  |  | No |  | Inferred from Usage |
| 258 | [lastname](#index-lastname) |  |  | No |  | Inferred from Usage |
| 259 | [manualdiscountamount](#index-manualdiscountamount) |  |  | No |  | Inferred from Usage |
| 260 | [metricid](#index-metricid) |  |  | No |  | Inferred from Usage |
| 261 | [mimetype](#index-mimetype) |  |  | No |  | Inferred from Usage |
| 262 | [mobilephone](#index-mobilephone) |  |  | No |  | Inferred from Usage |
| 263 | [modifiedby](#index-modifiedby) | Modified By | lookup | No | none | Solution Export |
| 264 | [modifiedon](#index-modifiedon) | Modified On | datetime | No | none | Solution Export |
| 265 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup | No | none | Solution Export |
| 266 | [name](#index-name) |  |  | No |  | Inferred from Usage |
| 267 | [notescontrol](#index-notescontrol) |  |  | No |  | Inferred from Usage |
| 268 | [objectid](#index-objectid) |  |  | No |  | Inferred from Usage |
| 269 | [objecttypecode](#index-objecttypecode) |  |  | No |  | Inferred from Usage |
| 270 | [opportunityid](#index-opportunityid) |  |  | No |  | Inferred from Usage |
| 271 | [opportunityproductid](#index-opportunityproductid) |  |  | No |  | Inferred from Usage |
| 272 | [originatingleadid](#index-originatingleadid) |  |  | No |  | Inferred from Usage |
| 273 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime | No | none | Solution Export |
| 274 | [ownerid](#index-ownerid) | Owner | owner | No | systemrequired | Solution Export |
| 275 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup | No | none | Solution Export |
| 276 | [owningteam](#index-owningteam) | Owning Team | lookup | No | none | Solution Export |
| 277 | [owninguser](#index-owninguser) | Owning User | lookup | No | none | Solution Export |
| 278 | [parentaccountid](#index-parentaccountid) |  |  | No |  | Inferred from Usage |
| 279 | [parentcontactid](#index-parentcontactid) |  |  | No |  | Inferred from Usage |
| 280 | [parentcustomerid](#index-parentcustomerid) |  |  | No |  | Inferred from Usage |
| 281 | [parentgoalid](#index-parentgoalid) |  |  | No |  | Inferred from Usage |
| 282 | [parentsystemuserid](#index-parentsystemuserid) |  |  | No |  | Inferred from Usage |
| 283 | [partyid](#index-partyid) |  |  | No |  | Inferred from Usage |
| 284 | [phonenumber](#index-phonenumber) |  |  | No |  | Inferred from Usage |
| 285 | [pricelevelid](#index-pricelevelid) |  |  | No |  | Inferred from Usage |
| 286 | [priceperunit](#index-priceperunit) |  |  | No |  | Inferred from Usage |
| 287 | [primarycontactid](#index-primarycontactid) |  |  | No |  | Inferred from Usage |
| 288 | [processid](#index-processid) | Process Id | uniqueidentifier | No | none | Solution Export |
| 289 | [prod.productid](#index-prodproductid) |  |  | No |  | Inferred from Usage |
| 290 | [productdescription](#index-productdescription) |  |  | No |  | Inferred from Usage |
| 291 | [productid](#index-productid) |  |  | No |  | Inferred from Usage |
| 292 | [productname](#index-productname) |  |  | No |  | Inferred from Usage |
| 293 | [productnumber](#index-productnumber) |  |  | No |  | Inferred from Usage |
| 294 | [producttypecode](#index-producttypecode) |  |  | No |  | Inferred from Usage |
| 295 | [quantity](#index-quantity) |  |  | No |  | Inferred from Usage |
| 296 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 297 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 298 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 299 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 300 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
| 301 | [record1id](#index-record1id) |  |  | No |  | Inferred from Usage |
| 302 | [record1roleid](#index-record1roleid) |  |  | No |  | Inferred from Usage |
| 303 | [record2id](#index-record2id) |  |  | No |  | Inferred from Usage |
| 304 | [record2roleid](#index-record2roleid) |  |  | No |  | Inferred from Usage |
| 305 | [regardingobjectid](#index-regardingobjectid) |  |  | No |  | Inferred from Usage |
| 306 | [requestdeliveryby](#index-requestdeliveryby) |  |  | No |  | Inferred from Usage |
| 307 | [roleid](#index-roleid) |  |  | No |  | Inferred from Usage |
| 308 | [rolluponlyfromchildgoals](#index-rolluponlyfromchildgoals) |  |  | No |  | Inferred from Usage |
| 309 | [rollupqueryactualmoneyid](#index-rollupqueryactualmoneyid) |  |  | No |  | Inferred from Usage |
| 310 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 311 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 312 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 313 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 314 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 315 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 316 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 317 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 318 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 319 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 320 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 321 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 322 | [stageid](#index-stageid) | (Deprecated) Stage Id | uniqueidentifier | No | none | Solution Export |
| 323 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 324 | [statecode](#index-statecode) | Status | state | No | systemrequired | Solution Export |
| 325 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 326 | [statuscode](#index-statuscode) | Expense Status | status | No | none | Solution Export |
| 327 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 328 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 329 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 330 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 331 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 332 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 333 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 334 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int | No | none | Solution Export |
| 335 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 336 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 337 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 338 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 339 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup | No | none | Solution Export |
| 340 | [traversedpath](#index-traversedpath) | (Deprecated) Traversed Path | nvarchar | No | none | Solution Export |
| 341 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 342 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int | No | none | Solution Export |
| 343 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 344 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 345 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
