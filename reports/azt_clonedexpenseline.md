...
|---|-------------|-------------|------|-----------------|--------|----------|-------------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_clonedexpenselineid](#azt_clonedexpenselineid) | Cloned Expense Line | primarykey |  | No | systemrequired | Never | true |  |  |  |  |  |  |  | [7](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_name](#azt_name) | Cloned Expense Line ID | nvarchar |  | Yes | required | Never | true |  |  |  |  |  |  | [3](#2-forms) | [12](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [createdby](#createdby) | Created By | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
...
| 7 | [modifiedby](#modifiedby) | Modified By | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
...
| 10 | [organizationid](#organizationid) | Organization Id | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 11 | [overriddencreatedon](#overriddencreatedon) | Record Created On | datetime |  | No | none | Never | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 12 | [statecode](#statecode) | Status | state |  | No | systemrequired | Never | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [statuscode](#statuscode) | Status Reason | status |  | No | none | Never | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
