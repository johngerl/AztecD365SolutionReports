...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [activestageid](#index-activestageid) | Active Stage | lookup |  | No | none | true |  |  |  |  |  |  |  | [9](#3-views) |  |  |  | [3](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 2 | [activestagestartedon](#index-activestagestartedon) | Active Stage Started On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 3 | [bpf_azt_expensereportid](#index-bpf_azt_expensereportid) | Azt_Expensereport | lookup |  | Yes | none | true |  |  |  |  |  |  |  | [9](#3-views) |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 4 | [bpf_duration](#index-bpf_duration) | Duration | int |  | Yes | none | true |  |  |  |  |  |  |  | [2](#3-views) |  |  |  |  | [1](#9-formulas-rollups) | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [bpf_name](#index-bpf_name) | Name | nvarchar |  | Yes | required | true |  |  |  |  |  |  |  | [18](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 6 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) | Expense Approval Process | primarykey |  | No | systemrequired | true |  |  |  |  |  |  |  | [10](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [completedon](#index-completedon) | Completed On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  | [1](#9-formulas-rollups) |  |  |  |  |  |
| 8 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
...
| 18 | [statecode](#index-statecode) | Status | state |  | No | systemrequired | true |  |  |  |  |  |  | [1](#2-forms) | [18](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
