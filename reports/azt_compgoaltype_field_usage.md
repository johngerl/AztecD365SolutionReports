...
| 21 | [azt_amount](#index-azt_amount) | Amount | money | Yes | none | Solution Export |
| 22 | [azt_amount_base](#index-azt_amount_base) | Amount (Base) | money | Yes | none | Solution Export |
| 23 | [azt_annualspend](#index-azt_annualspend) |  |  | Yes |  | Inferred from Usage |
| 24 | [azt_applybonus](#index-azt_applybonus) | Apply Bonus? | bit | Yes | none | Solution Export |
...
| 34 | [azt_commissionid](#index-azt_commissionid) | Commission | lookup | Yes | none | Solution Export |
...
| 39 | [azt_compgoaltypeid](#index-azt_compgoaltypeid) | Comp Goal Type | primarykey | No | systemrequired | Solution Export |
...
| 50 | [azt_details](#index-azt_details) | Details | ntext | Yes | none | Solution Export |
...
| 53 | [azt_donotaddtogoal](#index-azt_donotaddtogoal) | Do Not Add to Goal | bit | Yes | none | Solution Export |
| 54 | [azt_duedate](#index-azt_duedate) |  |  | Yes |  | Inferred from Usage |
| 55 | [azt_effectivedate](#index-azt_effectivedate) | Effective Date | datetime | Yes | none | Solution Export |
...
| 82 | [azt_invoiceid](#index-azt_invoiceid) | Invoice | lookup | Yes | none | Solution Export |
...
| 111 | [azt_opportunityid](#index-azt_opportunityid) | Opportunity | lookup | Yes | none | Solution Export |
| 112 | [azt_opportunityproductid](#index-azt_opportunityproductid) |  |  | Yes |  | Inferred from Usage |
| 113 | [azt_orderid](#index-azt_orderid) | Order | lookup | Yes | none | Solution Export |
...
| 127 | [azt_percentage](#index-azt_percentage) | Percentage | decimal | Yes | none | Solution Export |
...
| 147 | [azt_producttype](#index-azt_producttype) | Product Type | picklist | Yes | none | Solution Export |
...
| 161 | [azt_salesrepid](#index-azt_salesrepid) | Sales Rep | lookup | Yes | required | Solution Export |
...
| 172 | [azt_total](#index-azt_total) | Total | money | Yes | none | Solution Export |
| 173 | [azt_total_base](#index-azt_total_base) | Total (Base) | money | Yes | none | Solution Export |
...
| 217 | [exchangerate](#index-exchangerate) | Exchange Rate | decimal | No | none | Solution Export |
...
| 311 | [statuscode](#index-statuscode) | Status Reason | status | No | none | Solution Export |
...
| 324 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup | No | none | Solution Export |
| 325 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 326 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int | No | none | Solution Export |
| 327 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 328 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 329 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
