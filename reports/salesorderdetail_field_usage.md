...
| 49 | [azt_discretionarydiscount](#index-azt_discretionarydiscount) | Discretionary Discount | money | Yes | none | Solution Export |
| 50 | [azt_discretionarydiscount_base](#index-azt_discretionarydiscount_base) | Discretionary Discount (Base) | money | Yes | none | Solution Export |
| 51 | [azt_discretionarydiscountamt](#index-azt_discretionarydiscountamt) | Discretionary Discount Amt | money | Yes | none | Solution Export |
| 52 | [azt_discretionarydiscountamt_base](#index-azt_discretionarydiscountamt_base) | Discretionary Discount Amt (Base) | money | Yes | none | Solution Export |
...
| 58 | [azt_estfulfillmentdate](#index-azt_estfulfillmentdate) | Est Fulfillment Date | datetime | Yes | none | Solution Export |
...
| 80 | [azt_hasloadingdock](#index-azt_hasloadingdock) | Has Loading Dock? | bit | Yes | none | Solution Export |
...
| 87 | [azt_issaas](#index-azt_issaas) | Is SaaS? | bit | Yes | none | Solution Export |
| 88 | [azt_itemstatus](#index-azt_itemstatus) | Item Status | picklist | Yes | none | Solution Export |
...
| 96 | [azt_licenseenddate](#index-azt_licenseenddate) | License End Date | datetime | Yes | none | Solution Export |
| 97 | [azt_licensestartdate](#index-azt_licensestartdate) | License Start Date | datetime | Yes | none | Solution Export |
...
| 100 | [azt_licensetermmonths](#index-azt_licensetermmonths) | License Term (Months) | int | Yes | none | Solution Export |
| 101 | [azt_licensetype](#index-azt_licensetype) | License Type | picklist | Yes | none | Solution Export |
| 102 | [azt_lsebookfilesprovidedon](#index-azt_lsebookfilesprovidedon) | LSE Book Files Provided On | datetime | Yes | none | Solution Export |
| 103 | [azt_lsebooksfile](#index-azt_lsebooksfile) | LSE Books Files Provided? | picklist | Yes | none | Solution Export |
| 104 | [azt_lsecustomartapproved](#index-azt_lsecustomartapproved) | LSE Custom Art Approved? | picklist | Yes | none | Solution Export |
| 105 | [azt_lsecustomartapprovedon](#index-azt_lsecustomartapprovedon) | LSE Custom Art Approved On | datetime | Yes | none | Solution Export |
| 106 | [azt_lseproductionstartdate](#index-azt_lseproductionstartdate) | LSE Production Start Date | datetime | Yes | none | Solution Export |
| 107 | [azt_masecommission](#index-azt_masecommission) |  |  | Yes |  | Inferred from Usage |
| 108 | [azt_mileage](#index-azt_mileage) |  |  | Yes |  | Inferred from Usage |
| 109 | [azt_monthstofilteron](#index-azt_monthstofilteron) |  |  | Yes |  | Inferred from Usage |
| 110 | [azt_name](#index-azt_name) |  |  | Yes |  | Inferred from Usage |
| 111 | [azt_newestclosedate](#index-azt_newestclosedate) |  |  | Yes |  | Inferred from Usage |
| 112 | [azt_newestimatedvalue](#index-azt_newestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 113 | [azt_newownerid](#index-azt_newownerid) |  |  | Yes |  | Inferred from Usage |
| 114 | [azt_newprobability](#index-azt_newprobability) |  |  | Yes |  | Inferred from Usage |
| 115 | [azt_nonsaasstatus](#index-azt_nonsaasstatus) |  |  | Yes |  | Inferred from Usage |
| 116 | [azt_nonsaastype](#index-azt_nonsaastype) | Non-SaaS Type | picklist | Yes | none | Solution Export |
| 117 | [azt_numberoflicenses](#index-azt_numberoflicenses) |  |  | Yes |  | Inferred from Usage |
| 118 | [azt_opportunityauditrecordid](#index-azt_opportunityauditrecordid) |  |  | Yes |  | Inferred from Usage |
| 119 | [azt_opportunityid](#index-azt_opportunityid) |  |  | Yes |  | Inferred from Usage |
| 120 | [azt_opportunityproductid](#index-azt_opportunityproductid) |  |  | Yes |  | Inferred from Usage |
| 121 | [azt_orderdate](#index-azt_orderdate) | Order Date | datetime | Yes | none | Solution Export |
...
| 127 | [azt_ordertype](#index-azt_ordertype) | Order Type | picklist | Yes | none | Solution Export |
...
| 171 | [azt_shippingdate](#index-azt_shippingdate) | Shipping Date | datetime | Yes | none | Solution Export |
| 172 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) | Software License | lookup | Yes | none | Solution Export |
...
| 189 | [azt_year](#index-azt_year) |  |  | Yes |  | Inferred from Usage |
| 190 | [baseamount](#index-baseamount) |  |  | No |  | Inferred from Usage |
| 191 | [billto_line1](#index-billto_line1) |  |  | No |  | Inferred from Usage |
| 192 | [billto_line2](#index-billto_line2) |  |  | No |  | Inferred from Usage |
| 193 | [billto_line3](#index-billto_line3) |  |  | No |  | Inferred from Usage |
| 194 | [billto_name](#index-billto_name) |  |  | No |  | Inferred from Usage |
| 195 | [billto_postalcode](#index-billto_postalcode) |  |  | No |  | Inferred from Usage |
| 196 | [billto_stateorprovince](#index-billto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 197 | [body](#index-body) |  |  | No |  | Inferred from Usage |
| 198 | [bpf_duration](#index-bpf_duration) |  |  | No |  | Inferred from Usage |
| 199 | [bpf_salesorderid](#index-bpf_salesorderid) |  |  | No |  | Inferred from Usage |
| 200 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) |  |  | No |  | Inferred from Usage |
| 201 | [businessunitid](#index-businessunitid) |  |  | No |  | Inferred from Usage |
...
| 206 | [connectionid](#index-connectionid) |  |  | No |  | Inferred from Usage |
| 207 | [connectionroleid](#index-connectionroleid) |  |  | No |  | Inferred from Usage |
| 208 | [consideronlygoalownersrecords](#index-consideronlygoalownersrecords) |  |  | No |  | Inferred from Usage |
| 209 | [contactid](#index-contactid) |  |  | No |  | Inferred from Usage |
| 210 | [country](#index-country) |  |  | No |  | Inferred from Usage |
| 211 | [county](#index-county) |  |  | No |  | Inferred from Usage |
| 212 | [createdon](#index-createdon) |  |  | No |  | Inferred from Usage |
| 213 | [crm3_expenseamount](#index-crm3_expenseamount) |  |  | No |  | Inferred from Usage |
| 214 | [crm3_parentleadid](#index-crm3_parentleadid) |  |  | No |  | Inferred from Usage |
| 215 | [customerid](#index-customerid) |  |  | No |  | Inferred from Usage |
| 216 | [datefulfilled](#index-datefulfilled) |  |  | No |  | Inferred from Usage |
| 217 | [defaultuomid](#index-defaultuomid) |  |  | No |  | Inferred from Usage |
| 218 | [description](#index-description) |  |  | No |  | Inferred from Usage |
| 219 | [discountamount](#index-discountamount) |  |  | No |  | Inferred from Usage |
| 220 | [discountpercentage](#index-discountpercentage) |  |  | No |  | Inferred from Usage |
| 221 | [discounts](#index-discounts) |  |  | No |  | Inferred from Usage |
...
| 225 | [ext_amt](#index-ext_amt) |  |  | No |  | Inferred from Usage |
| 226 | [extendedamount](#index-extendedamount) |  |  | No |  | Inferred from Usage |
| 227 | [fetchxml](#index-fetchxml) |  |  | No |  | Inferred from Usage |
| 228 | [filename](#index-filename) |  |  | No |  | Inferred from Usage |
| 229 | [firstname](#index-firstname) |  |  | No |  | Inferred from Usage |
| 230 | [freightamount](#index-freightamount) |  |  | No |  | Inferred from Usage |
| 231 | [freighttermscode](#index-freighttermscode) |  |  | No |  | Inferred from Usage |
| 232 | [from](#index-from) |  |  | No |  | Inferred from Usage |
| 233 | [fullname](#index-fullname) |  |  | No |  | Inferred from Usage |
| 234 | [goalenddate](#index-goalenddate) |  |  | No |  | Inferred from Usage |
| 235 | [goalid](#index-goalid) |  |  | No |  | Inferred from Usage |
| 236 | [goalownerid](#index-goalownerid) |  |  | No |  | Inferred from Usage |
| 237 | [goalrollupqueryid](#index-goalrollupqueryid) |  |  | No |  | Inferred from Usage |
| 238 | [goalstartdate](#index-goalstartdate) |  |  | No |  | Inferred from Usage |
...
| 257 | [modifiedon](#index-modifiedon) |  |  | No |  | Inferred from Usage |
| 258 | [name](#index-name) |  |  | No |  | Inferred from Usage |
| 259 | [objectid](#index-objectid) |  |  | No |  | Inferred from Usage |
| 260 | [objecttypecode](#index-objecttypecode) |  |  | No |  | Inferred from Usage |
| 261 | [opportunityid](#index-opportunityid) |  |  | No |  | Inferred from Usage |
| 262 | [opportunityproductid](#index-opportunityproductid) |  |  | No |  | Inferred from Usage |
| 263 | [originatingleadid](#index-originatingleadid) |  |  | No |  | Inferred from Usage |
| 264 | [ownerid](#index-ownerid) |  |  | No |  | Inferred from Usage |
...
| 282 | [quantitybackordered](#index-quantitybackordered) |  |  | No |  | Inferred from Usage |
| 283 | [quantitycancelled](#index-quantitycancelled) |  |  | No |  | Inferred from Usage |
| 284 | [quantityshipped](#index-quantityshipped) |  |  | No |  | Inferred from Usage |
| 285 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 286 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 287 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 288 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 289 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
| 290 | [record1id](#index-record1id) |  |  | No |  | Inferred from Usage |
| 291 | [record1roleid](#index-record1roleid) |  |  | No |  | Inferred from Usage |
| 292 | [record2id](#index-record2id) |  |  | No |  | Inferred from Usage |
| 293 | [record2roleid](#index-record2roleid) |  |  | No |  | Inferred from Usage |
| 294 | [regardingobjectid](#index-regardingobjectid) |  |  | No |  | Inferred from Usage |
| 295 | [requestdeliveryby](#index-requestdeliveryby) |  |  | No |  | Inferred from Usage |
| 296 | [roleid](#index-roleid) |  |  | No |  | Inferred from Usage |
| 297 | [rolluponlyfromchildgoals](#index-rolluponlyfromchildgoals) |  |  | No |  | Inferred from Usage |
| 298 | [rollupqueryactualmoneyid](#index-rollupqueryactualmoneyid) |  |  | No |  | Inferred from Usage |
| 299 | [rolluprulestep1_1](#index-rolluprulestep1_1) |  |  | No |  | Inferred from Usage |
| 300 | [rolluprulestep1_2](#index-rolluprulestep1_2) |  |  | No |  | Inferred from Usage |
| 301 | [rolluprulestep1_3](#index-rolluprulestep1_3) |  |  | No |  | Inferred from Usage |
| 302 | [rolluprulestep1_4](#index-rolluprulestep1_4) |  |  | No |  | Inferred from Usage |
| 303 | [rolluprulestep1_5](#index-rolluprulestep1_5) |  |  | No |  | Inferred from Usage |
| 304 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 305 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 306 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 307 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 308 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 309 | [shipments](#index-shipments) |  |  | No |  | Inferred from Usage |
| 310 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 311 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 312 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 313 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 314 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 315 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 316 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 317 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 318 | [statecode](#index-statecode) |  |  | No |  | Inferred from Usage |
| 319 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 320 | [statuscode](#index-statuscode) |  |  | No |  | Inferred from Usage |
| 321 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 322 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 323 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 324 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 325 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 326 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 327 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 328 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 329 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 330 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 331 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 332 | [transactioncurrencyid](#index-transactioncurrencyid) |  |  | No |  | Inferred from Usage |
| 333 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 334 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 335 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 336 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
