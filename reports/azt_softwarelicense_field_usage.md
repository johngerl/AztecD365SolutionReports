...
| 11 | [azt_accountid](#index-azt_accountid) | Customer | lookup | Yes | required | Solution Export |
...
| 19 | [azt_allocatedtoid](#index-azt_allocatedtoid) |  |  | Yes |  | Inferred from Usage |
| 20 | [azt_allocationtype](#index-azt_allocationtype) |  |  | Yes |  | Inferred from Usage |
| 21 | [azt_amount](#index-azt_amount) |  |  | Yes |  | Inferred from Usage |
| 22 | [azt_annualspend](#index-azt_annualspend) |  |  | Yes |  | Inferred from Usage |
| 23 | [azt_approvalstatus](#index-azt_approvalstatus) |  |  | Yes |  | Inferred from Usage |
| 24 | [azt_autocreatecallback](#index-azt_autocreatecallback) |  |  | Yes |  | Inferred from Usage |
| 25 | [azt_autonumberid](#index-azt_autonumberid) |  |  | Yes |  | Inferred from Usage |
| 26 | [azt_azteccompanionserial](#index-azt_azteccompanionserial) | Aztec Companion Serial | nvarchar | Yes | none | Solution Export |
| 27 | [azt_azteccompaniontype](#index-azt_azteccompaniontype) | Aztec Companion Type | picklist | Yes | none | Solution Export |
| 28 | [azt_azteccustomerid](#index-azt_azteccustomerid) |  |  | Yes |  | Inferred from Usage |
| 29 | [azt_aztecsitename](#index-azt_aztecsitename) | Aztec Site Name | nvarchar | Yes | none | Solution Export |
| 30 | [azt_bookingurl](#index-azt_bookingurl) |  |  | Yes |  | Inferred from Usage |
| 31 | [azt_callbackin](#index-azt_callbackin) |  |  | Yes |  | Inferred from Usage |
| 32 | [azt_callbackon](#index-azt_callbackon) |  |  | Yes |  | Inferred from Usage |
| 33 | [azt_caseid](#index-azt_caseid) |  |  | Yes |  | Inferred from Usage |
| 34 | [azt_certificateissued](#index-azt_certificateissued) | Certificate Issued? | bit | Yes | none | Solution Export |
| 35 | [azt_certificateissuedon](#index-azt_certificateissuedon) | Certificate Issued On | datetime | Yes | none | Solution Export |
| 36 | [azt_certificatesignedby](#index-azt_certificatesignedby) | Certificate Signed By | picklist | Yes | none | Solution Export |
| 37 | [azt_commissionamount](#index-azt_commissionamount) |  |  | Yes |  | Inferred from Usage |
| 38 | [azt_commissionid](#index-azt_commissionid) |  |  | Yes |  | Inferred from Usage |
| 39 | [azt_commissionpaymentid](#index-azt_commissionpaymentid) |  |  | Yes |  | Inferred from Usage |
| 40 | [azt_companionid](#index-azt_companionid) |  |  | Yes |  | Inferred from Usage |
| 41 | [azt_companyname](#index-azt_companyname) |  |  | Yes |  | Inferred from Usage |
| 42 | [azt_compcompleted](#index-azt_compcompleted) |  |  | Yes |  | Inferred from Usage |
| 43 | [azt_compgoalid](#index-azt_compgoalid) |  |  | Yes |  | Inferred from Usage |
| 44 | [azt_compgoaltypeid](#index-azt_compgoaltypeid) |  |  | Yes |  | Inferred from Usage |
| 45 | [azt_compplanamountid](#index-azt_compplanamountid) |  |  | Yes |  | Inferred from Usage |
| 46 | [azt_concurrentusers](#index-azt_concurrentusers) | Concurrent Users | int | Yes | required | Solution Export |
| 47 | [azt_contactid](#index-azt_contactid) | Contact | lookup | Yes | none | Solution Export |
| 48 | [azt_copydescription](#index-azt_copydescription) |  |  | Yes |  | Inferred from Usage |
| 49 | [azt_copysubject](#index-azt_copysubject) |  |  | Yes |  | Inferred from Usage |
| 50 | [azt_cpu](#index-azt_cpu) | CPU | picklist | Yes | none | Solution Export |
| 51 | [azt_currentnumber](#index-azt_currentnumber) |  |  | Yes |  | Inferred from Usage |
| 52 | [azt_customerid](#index-azt_customerid) |  |  | Yes |  | Inferred from Usage |
| 53 | [azt_customertrainingid](#index-azt_customertrainingid) |  |  | Yes |  | Inferred from Usage |
| 54 | [azt_dateexitedstage](#index-azt_dateexitedstage) |  |  | Yes |  | Inferred from Usage |
| 55 | [azt_defaultfreightamount](#index-azt_defaultfreightamount) |  |  | Yes |  | Inferred from Usage |
| 56 | [azt_description](#index-azt_description) |  |  | Yes |  | Inferred from Usage |
| 57 | [azt_discountamount](#index-azt_discountamount) |  |  | Yes |  | Inferred from Usage |
| 58 | [azt_discretionarydiscountamt](#index-azt_discretionarydiscountamt) |  |  | Yes |  | Inferred from Usage |
| 59 | [azt_donationlicense](#index-azt_donationlicense) | Donation License | bit | Yes | none | Solution Export |
| 60 | [azt_duedate](#index-azt_duedate) |  |  | Yes |  | Inferred from Usage |
| 61 | [azt_effectivedate](#index-azt_effectivedate) |  |  | Yes |  | Inferred from Usage |
| 62 | [azt_eligiblecomputers](#index-azt_eligiblecomputers) | Eligible Computers | int | Yes | none | Solution Export |
| 63 | [azt_email](#index-azt_email) |  |  | Yes |  | Inferred from Usage |
| 64 | [azt_enddate](#index-azt_enddate) |  |  | Yes |  | Inferred from Usage |
| 65 | [azt_engagementid](#index-azt_engagementid) |  |  | Yes |  | Inferred from Usage |
| 66 | [azt_estfulfillmentdate](#index-azt_estfulfillmentdate) |  |  | Yes |  | Inferred from Usage |
| 67 | [azt_evaluate](#index-azt_evaluate) |  |  | Yes |  | Inferred from Usage |
| 68 | [azt_expenseamount](#index-azt_expenseamount) |  |  | Yes |  | Inferred from Usage |
| 69 | [azt_expenseid](#index-azt_expenseid) |  |  | Yes |  | Inferred from Usage |
| 70 | [azt_expensereportid](#index-azt_expensereportid) |  |  | Yes |  | Inferred from Usage |
| 71 | [azt_expensetype](#index-azt_expensetype) |  |  | Yes |  | Inferred from Usage |
| 72 | [azt_expirationdate](#index-azt_expirationdate) |  |  | Yes |  | Inferred from Usage |
| 73 | [azt_extension](#index-azt_extension) |  |  | Yes |  | Inferred from Usage |
| 74 | [azt_fieldtoautonumber](#index-azt_fieldtoautonumber) |  |  | Yes |  | Inferred from Usage |
| 75 | [azt_firstname](#index-azt_firstname) |  |  | Yes |  | Inferred from Usage |
| 76 | [azt_fiscalperiodend](#index-azt_fiscalperiodend) |  |  | Yes |  | Inferred from Usage |
| 77 | [azt_fiscalperiodstart](#index-azt_fiscalperiodstart) |  |  | Yes |  | Inferred from Usage |
| 78 | [azt_freightamtapproved](#index-azt_freightamtapproved) |  |  | Yes |  | Inferred from Usage |
| 79 | [azt_fsrassignedon](#index-azt_fsrassignedon) |  |  | Yes |  | Inferred from Usage |
| 80 | [azt_fsremail](#index-azt_fsremail) |  |  | Yes |  | Inferred from Usage |
| 81 | [azt_fsrid](#index-azt_fsrid) |  |  | Yes |  | Inferred from Usage |
| 82 | [azt_fsrmobiletelephone](#index-azt_fsrmobiletelephone) |  |  | Yes |  | Inferred from Usage |
| 83 | [azt_fsrtelephone](#index-azt_fsrtelephone) |  |  | Yes |  | Inferred from Usage |
| 84 | [azt_fsrtelephoneextension](#index-azt_fsrtelephoneextension) |  |  | Yes |  | Inferred from Usage |
| 85 | [azt_fundingid](#index-azt_fundingid) |  |  | Yes |  | Inferred from Usage |
| 86 | [azt_fundingyear](#index-azt_fundingyear) |  |  | Yes |  | Inferred from Usage |
| 87 | [azt_goaltype](#index-azt_goaltype) |  |  | Yes |  | Inferred from Usage |
| 88 | [azt_importname](#index-azt_importname) |  |  | Yes |  | Inferred from Usage |
| 89 | [azt_invoiceid](#index-azt_invoiceid) |  |  | Yes |  | Inferred from Usage |
| 90 | [azt_invoiceproductid](#index-azt_invoiceproductid) |  |  | Yes |  | Inferred from Usage |
| 91 | [azt_isbn](#index-azt_isbn) |  |  | Yes |  | Inferred from Usage |
| 92 | [azt_iscompanion](#index-azt_iscompanion) |  |  | Yes |  | Inferred from Usage |
| 93 | [azt_isprint](#index-azt_isprint) |  |  | Yes |  | Inferred from Usage |
| 94 | [azt_issaas](#index-azt_issaas) |  |  | Yes |  | Inferred from Usage |
| 95 | [azt_jobrole](#index-azt_jobrole) |  |  | Yes |  | Inferred from Usage |
| 96 | [azt_jobtitle](#index-azt_jobtitle) |  |  | Yes |  | Inferred from Usage |
| 97 | [azt_lastactivitydate](#index-azt_lastactivitydate) |  |  | Yes |  | Inferred from Usage |
| 98 | [azt_lastmodifiedbyid](#index-azt_lastmodifiedbyid) |  |  | Yes |  | Inferred from Usage |
| 99 | [azt_lastname](#index-azt_lastname) |  |  | Yes |  | Inferred from Usage |
| 100 | [azt_leadimportid](#index-azt_leadimportid) |  |  | Yes |  | Inferred from Usage |
| 101 | [azt_leadsourceid](#index-azt_leadsourceid) |  |  | Yes |  | Inferred from Usage |
| 102 | [azt_licensestatus](#index-azt_licensestatus) | License Status | picklist | Yes | none | Solution Export |
| 103 | [azt_licenseterm](#index-azt_licenseterm) |  |  | Yes |  | Inferred from Usage |
| 104 | [azt_licensetermmonths](#index-azt_licensetermmonths) | License Term (Months) | int | Yes | none | Solution Export |
| 105 | [azt_licensetype](#index-azt_licensetype) | License Type | picklist | Yes | none | Solution Export |
| 106 | [azt_masecommission](#index-azt_masecommission) |  |  | Yes |  | Inferred from Usage |
| 107 | [azt_mileage](#index-azt_mileage) |  |  | Yes |  | Inferred from Usage |
| 108 | [azt_monthstofilteron](#index-azt_monthstofilteron) |  |  | Yes |  | Inferred from Usage |
| 109 | [azt_name](#index-azt_name) | Name | nvarchar | Yes | required | Solution Export |
| 110 | [azt_newestclosedate](#index-azt_newestclosedate) |  |  | Yes |  | Inferred from Usage |
| 111 | [azt_newestimatedvalue](#index-azt_newestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 112 | [azt_newownerid](#index-azt_newownerid) |  |  | Yes |  | Inferred from Usage |
| 113 | [azt_newprobability](#index-azt_newprobability) |  |  | Yes |  | Inferred from Usage |
| 114 | [azt_nonsaasstatus](#index-azt_nonsaasstatus) |  |  | Yes |  | Inferred from Usage |
| 115 | [azt_nonsaastype](#index-azt_nonsaastype) |  |  | Yes |  | Inferred from Usage |
| 116 | [azt_notes](#index-azt_notes) | Notes | ntext | Yes | none | Solution Export |
| 117 | [azt_nucram](#index-azt_nucram) | NUC RAM | picklist | Yes | none | Solution Export |
| 118 | [azt_nucversion](#index-azt_nucversion) | NUC Version | picklist | Yes | none | Solution Export |
| 119 | [azt_numberoflicenses](#index-azt_numberoflicenses) |  |  | Yes |  | Inferred from Usage |
| 120 | [azt_oldcareerbuilders](#index-azt_oldcareerbuilders) | Old Career Builders | bit | Yes | none | Solution Export |
| 121 | [azt_oldcitizenship](#index-azt_oldcitizenship) | Old Citizenship | bit | Yes | none | Solution Export |
| 122 | [azt_oldcollegereadyseries](#index-azt_oldcollegereadyseries) | Old College Ready Series | bit | Yes | none | Solution Export |
| 123 | [azt_oldfinancialliteracy](#index-azt_oldfinancialliteracy) | Old Financial Literacy | bit | Yes | none | Solution Export |
| 124 | [azt_oldlearningessentials](#index-azt_oldlearningessentials) | Old Learning Essentials | bit | Yes | none | Solution Export |
| 125 | [azt_oldmathskillsforwork](#index-azt_oldmathskillsforwork) | Old Math Skills for Work | bit | Yes | none | Solution Export |
| 126 | [azt_oldoccupationalfoundations](#index-azt_oldoccupationalfoundations) | Old Occupational Foundations | bit | Yes | none | Solution Export |
| 127 | [azt_oldperformingatwork](#index-azt_oldperformingatwork) | Old Performing at Work | bit | Yes | none | Solution Export |
| 128 | [azt_oldpersonalmathskills](#index-azt_oldpersonalmathskills) | Old Personal Math Skills | bit | Yes | none | Solution Export |
| 129 | [azt_oldquickstart](#index-azt_oldquickstart) | Old Quick Start | bit | Yes | none | Solution Export |
| 130 | [azt_oldreadingskillsforwork](#index-azt_oldreadingskillsforwork) | Old Reading Skills for Work | bit | Yes | none | Solution Export |
| 131 | [azt_oldreadyforwork](#index-azt_oldreadyforwork) | Old Ready for Work | bit | Yes | none | Solution Export |
| 132 | [azt_oldworkkeys](#index-azt_oldworkkeys) | Old Work Keys | bit | Yes | none | Solution Export |
| 133 | [azt_oldwritingskillsforwork](#index-azt_oldwritingskillsforwork) | Old Writing Skills for Work | bit | Yes | none | Solution Export |
| 134 | [azt_opportunityauditrecordid](#index-azt_opportunityauditrecordid) |  |  | Yes |  | Inferred from Usage |
| 135 | [azt_opportunityid](#index-azt_opportunityid) |  |  | Yes |  | Inferred from Usage |
| 136 | [azt_opportunityproductid](#index-azt_opportunityproductid) |  |  | Yes |  | Inferred from Usage |
| 137 | [azt_orderid](#index-azt_orderid) |  |  | Yes |  | Inferred from Usage |
| 138 | [azt_orderlineid](#index-azt_orderlineid) | Order Line | lookup | Yes | none | Solution Export |
| 139 | [azt_orderproductid](#index-azt_orderproductid) |  |  | Yes |  | Inferred from Usage |
| 140 | [azt_orderstageid](#index-azt_orderstageid) |  |  | Yes |  | Inferred from Usage |
| 141 | [azt_ordertemplatelines](#index-azt_ordertemplatelines) |  |  | Yes |  | Inferred from Usage |
| 142 | [azt_ordertype](#index-azt_ordertype) |  |  | Yes |  | Inferred from Usage |
| 143 | [azt_originatingleadimportid](#index-azt_originatingleadimportid) |  |  | Yes |  | Inferred from Usage |
| 144 | [azt_paid](#index-azt_paid) |  |  | Yes |  | Inferred from Usage |
| 145 | [azt_paidon](#index-azt_paidon) |  |  | Yes |  | Inferred from Usage |
| 146 | [azt_parentaccountid](#index-azt_parentaccountid) | Parent Account | lookup | Yes | none | Solution Export |
| 147 | [azt_parentopportunityid](#index-azt_parentopportunityid) |  |  | Yes |  | Inferred from Usage |
| 148 | [azt_parentorderid](#index-azt_parentorderid) |  |  | Yes |  | Inferred from Usage |
| 149 | [azt_payablecommission](#index-azt_payablecommission) |  |  | Yes |  | Inferred from Usage |
| 150 | [azt_paymentdate](#index-azt_paymentdate) |  |  | Yes |  | Inferred from Usage |
| 151 | [azt_paymentid](#index-azt_paymentid) |  |  | Yes |  | Inferred from Usage |
...
| 157 | [azt_ponumber](#index-azt_ponumber) |  |  | Yes |  | Inferred from Usage |
| 158 | [azt_prefix](#index-azt_prefix) |  |  | Yes |  | Inferred from Usage |
| 159 | [azt_prefixhasseparator](#index-azt_prefixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 160 | [azt_prefixseparator](#index-azt_prefixseparator) |  |  | Yes |  | Inferred from Usage |
| 161 | [azt_prefixseparatorisspace](#index-azt_prefixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 162 | [azt_previousestclosedate](#index-azt_previousestclosedate) |  |  | Yes |  | Inferred from Usage |
| 163 | [azt_previousestimatedvalue](#index-azt_previousestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 164 | [azt_previousownerid](#index-azt_previousownerid) |  |  | Yes |  | Inferred from Usage |
| 165 | [azt_previousprobability](#index-azt_previousprobability) |  |  | Yes |  | Inferred from Usage |
| 166 | [azt_printproductid](#index-azt_printproductid) |  |  | Yes |  | Inferred from Usage |
| 167 | [azt_printpurchaseid](#index-azt_printpurchaseid) |  |  | Yes |  | Inferred from Usage |
| 168 | [azt_probability](#index-azt_probability) |  |  | Yes |  | Inferred from Usage |
| 169 | [azt_probabilitychangedon](#index-azt_probabilitychangedon) |  |  | Yes |  | Inferred from Usage |
| 170 | [azt_probabilityincreased](#index-azt_probabilityincreased) |  |  | Yes |  | Inferred from Usage |
| 171 | [azt_productdiscountid](#index-azt_productdiscountid) |  |  | Yes |  | Inferred from Usage |
| 172 | [azt_producttype](#index-azt_producttype) |  |  | Yes |  | Inferred from Usage |
| 173 | [azt_purchasedate](#index-azt_purchasedate) | Start Date | datetime | Yes | none | Solution Export |
| 174 | [azt_quantity](#index-azt_quantity) |  |  | Yes |  | Inferred from Usage |
| 175 | [azt_quotenumber](#index-azt_quotenumber) |  |  | Yes |  | Inferred from Usage |
| 176 | [azt_quoteproductid](#index-azt_quoteproductid) |  |  | Yes |  | Inferred from Usage |
| 177 | [azt_reasonforexpense](#index-azt_reasonforexpense) |  |  | Yes |  | Inferred from Usage |
| 178 | [azt_recordowner](#index-azt_recordowner) |  |  | Yes |  | Inferred from Usage |
| 179 | [azt_recordownerid](#index-azt_recordownerid) | Record Owner | lookup | Yes | none | Solution Export |
| 180 | [azt_replacementproductid](#index-azt_replacementproductid) |  |  | Yes |  | Inferred from Usage |
| 181 | [azt_requestedfreightamt](#index-azt_requestedfreightamt) |  |  | Yes |  | Inferred from Usage |
| 182 | [azt_resolvedbyid](#index-azt_resolvedbyid) |  |  | Yes |  | Inferred from Usage |
| 183 | [azt_result](#index-azt_result) |  |  | Yes |  | Inferred from Usage |
| 184 | [azt_saas](#index-azt_saas) |  |  | Yes |  | Inferred from Usage |
| 185 | [azt_saasstatus](#index-azt_saasstatus) |  |  | Yes |  | Inferred from Usage |
| 186 | [azt_salesrepid](#index-azt_salesrepid) |  |  | Yes |  | Inferred from Usage |
| 187 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) | Software License | primarykey | No | systemrequired | Solution Export |
| 188 | [azt_softwareproductid](#index-azt_softwareproductid) | Software Product | lookup | Yes | none | Solution Export |
| 189 | [azt_softwareversionnumber](#index-azt_softwareversionnumber) | Software Version # | picklist | Yes | none | Solution Export |
| 190 | [azt_softwareversiontype](#index-azt_softwareversiontype) | Software Version Type | picklist | Yes | none | Solution Export |
| 191 | [azt_source](#index-azt_source) | Source | picklist | Yes | none | Solution Export |
| 192 | [azt_splitallocations](#index-azt_splitallocations) | # Split Allocations | int | Yes | none | Solution Export |
| 193 | [azt_startdate](#index-azt_startdate) |  |  | Yes |  | Inferred from Usage |
| 194 | [azt_stateabbreviation](#index-azt_stateabbreviation) |  |  | Yes |  | Inferred from Usage |
| 195 | [azt_stateprovince](#index-azt_stateprovince) |  |  | Yes |  | Inferred from Usage |
| 196 | [azt_suffix](#index-azt_suffix) |  |  | Yes |  | Inferred from Usage |
| 197 | [azt_suffixhasseparator](#index-azt_suffixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 198 | [azt_suffixseparator](#index-azt_suffixseparator) |  |  | Yes |  | Inferred from Usage |
| 199 | [azt_suffixseparatorisspace](#index-azt_suffixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 200 | [azt_supportexpirationdate](#index-azt_supportexpirationdate) | End Date | datetime | Yes | none | Solution Export |
| 201 | [azt_total](#index-azt_total) |  |  | Yes |  | Inferred from Usage |
| 202 | [azt_totalamountpaid](#index-azt_totalamountpaid) |  |  | Yes |  | Inferred from Usage |
| 203 | [azt_totalfunding](#index-azt_totalfunding) |  |  | Yes |  | Inferred from Usage |
| 204 | [azt_totalreimbursement](#index-azt_totalreimbursement) |  |  | Yes |  | Inferred from Usage |
| 205 | [azt_totalusers](#index-azt_totalusers) | Total users | int | Yes | none | Solution Export |
| 206 | [azt_trackingnumber](#index-azt_trackingnumber) |  |  | Yes |  | Inferred from Usage |
| 207 | [azt_trackingnumbers](#index-azt_trackingnumbers) |  |  | Yes |  | Inferred from Usage |
| 208 | [azt_trainingid](#index-azt_trainingid) |  |  | Yes |  | Inferred from Usage |
| 209 | [azt_username](#index-azt_username) | User Name | nvarchar | Yes | none | Solution Export |
| 210 | [azt_voucherissued](#index-azt_voucherissued) | Voucher Issued? | bit | Yes | none | Solution Export |
| 211 | [azt_voucherissuedby](#index-azt_voucherissuedby) | Voucher Issued By | nvarchar | Yes | none | Solution Export |
| 212 | [azt_voucherissuedon](#index-azt_voucherissuedon) | Voucher Issued On | datetime | Yes | none | Solution Export |
| 213 | [azt_vouchernumber](#index-azt_vouchernumber) | Voucher # | nvarchar | Yes | none | Solution Export |
| 214 | [azt_year](#index-azt_year) |  |  | Yes |  | Inferred from Usage |
| 215 | [baseamount](#index-baseamount) |  |  | No |  | Inferred from Usage |
| 216 | [billto_line1](#index-billto_line1) |  |  | No |  | Inferred from Usage |
| 217 | [billto_line2](#index-billto_line2) |  |  | No |  | Inferred from Usage |
| 218 | [billto_line3](#index-billto_line3) |  |  | No |  | Inferred from Usage |
| 219 | [billto_name](#index-billto_name) |  |  | No |  | Inferred from Usage |
| 220 | [billto_postalcode](#index-billto_postalcode) |  |  | No |  | Inferred from Usage |
| 221 | [billto_stateorprovince](#index-billto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 222 | [body](#index-body) |  |  | No |  | Inferred from Usage |
| 223 | [bpf_duration](#index-bpf_duration) |  |  | No |  | Inferred from Usage |
| 224 | [bpf_salesorderid](#index-bpf_salesorderid) |  |  | No |  | Inferred from Usage |
| 225 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) |  |  | No |  | Inferred from Usage |
| 226 | [businessunitid](#index-businessunitid) |  |  | No |  | Inferred from Usage |
| 227 | [category](#index-category) |  |  | No |  | Inferred from Usage |
| 228 | [city](#index-city) |  |  | No |  | Inferred from Usage |
| 229 | [closeprobability](#index-closeprobability) |  |  | No |  | Inferred from Usage |
| 230 | [companyname](#index-companyname) |  |  | No |  | Inferred from Usage |
| 231 | [connectionid](#index-connectionid) |  |  | No |  | Inferred from Usage |
| 232 | [connectionroleid](#index-connectionroleid) |  |  | No |  | Inferred from Usage |
| 233 | [connections](#index-connections) |  |  | No |  | Inferred from Usage |
| 234 | [consideronlygoalownersrecords](#index-consideronlygoalownersrecords) |  |  | No |  | Inferred from Usage |
| 235 | [contactid](#index-contactid) |  |  | No |  | Inferred from Usage |
| 236 | [country](#index-country) |  |  | No |  | Inferred from Usage |
| 237 | [county](#index-county) |  |  | No |  | Inferred from Usage |
| 238 | [createdby](#index-createdby) | Created By | lookup | No | none | Solution Export |
| 239 | [createdon](#index-createdon) | Created On | datetime | No | none | Solution Export |
| 240 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup | No | none | Solution Export |
| 241 | [crm3_expenseamount](#index-crm3_expenseamount) |  |  | No |  | Inferred from Usage |
| 242 | [crm3_parentleadid](#index-crm3_parentleadid) |  |  | No |  | Inferred from Usage |
| 243 | [customerid](#index-customerid) |  |  | No |  | Inferred from Usage |
| 244 | [datefulfilled](#index-datefulfilled) |  |  | No |  | Inferred from Usage |
| 245 | [defaultuomid](#index-defaultuomid) |  |  | No |  | Inferred from Usage |
| 246 | [description](#index-description) |  |  | No |  | Inferred from Usage |
| 247 | [discountamount](#index-discountamount) |  |  | No |  | Inferred from Usage |
| 248 | [discountpercentage](#index-discountpercentage) |  |  | No |  | Inferred from Usage |
| 249 | [emailaddress1](#index-emailaddress1) |  |  | No |  | Inferred from Usage |
| 250 | [estimatedclosedate](#index-estimatedclosedate) |  |  | No |  | Inferred from Usage |
| 251 | [estimatedvalue](#index-estimatedvalue) |  |  | No |  | Inferred from Usage |
| 252 | [ext_amt](#index-ext_amt) |  |  | No |  | Inferred from Usage |
| 253 | [extendedamount](#index-extendedamount) |  |  | No |  | Inferred from Usage |
| 254 | [fetchxml](#index-fetchxml) |  |  | No |  | Inferred from Usage |
| 255 | [filename](#index-filename) |  |  | No |  | Inferred from Usage |
| 256 | [firstname](#index-firstname) |  |  | No |  | Inferred from Usage |
| 257 | [freightamount](#index-freightamount) |  |  | No |  | Inferred from Usage |
| 258 | [freighttermscode](#index-freighttermscode) |  |  | No |  | Inferred from Usage |
| 259 | [from](#index-from) |  |  | No |  | Inferred from Usage |
| 260 | [fullname](#index-fullname) |  |  | No |  | Inferred from Usage |
| 261 | [goalenddate](#index-goalenddate) |  |  | No |  | Inferred from Usage |
| 262 | [goalid](#index-goalid) |  |  | No |  | Inferred from Usage |
| 263 | [goalownerid](#index-goalownerid) |  |  | No |  | Inferred from Usage |
| 264 | [goalrollupqueryid](#index-goalrollupqueryid) |  |  | No |  | Inferred from Usage |
| 265 | [goalstartdate](#index-goalstartdate) |  |  | No |  | Inferred from Usage |
| 266 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int | No | none | Solution Export |
| 267 | [incidentid](#index-incidentid) |  |  | No |  | Inferred from Usage |
| 268 | [internalemailaddress](#index-internalemailaddress) |  |  | No |  | Inferred from Usage |
| 269 | [invline.productid](#index-invlineproductid) |  |  | No |  | Inferred from Usage |
| 270 | [invoicedetailid](#index-invoicedetailid) |  |  | No |  | Inferred from Usage |
| 271 | [invoiceid](#index-invoiceid) |  |  | No |  | Inferred from Usage |
| 272 | [invoicenumber](#index-invoicenumber) |  |  | No |  | Inferred from Usage |
| 273 | [isamount](#index-isamount) |  |  | No |  | Inferred from Usage |
| 274 | [isfiscalperiodgoal](#index-isfiscalperiodgoal) |  |  | No |  | Inferred from Usage |
| 275 | [isocurrencycode](#index-isocurrencycode) |  |  | No |  | Inferred from Usage |
| 276 | [ispriceoverridden](#index-ispriceoverridden) |  |  | No |  | Inferred from Usage |
| 277 | [isproductoverridden](#index-isproductoverridden) |  |  | No |  | Inferred from Usage |
| 278 | [isrevenuesystemcalculated](#index-isrevenuesystemcalculated) |  |  | No |  | Inferred from Usage |
| 279 | [jobtitle](#index-jobtitle) |  |  | No |  | Inferred from Usage |
| 280 | [lastname](#index-lastname) |  |  | No |  | Inferred from Usage |
| 281 | [licenseallocations](#index-licenseallocations) |  |  | No |  | Inferred from Usage |
...
| 286 | [modifiedby](#index-modifiedby) | Modified By | lookup | No | none | Solution Export |
| 287 | [modifiedon](#index-modifiedon) | Modified On | datetime | No | none | Solution Export |
| 288 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup | No | none | Solution Export |
| 289 | [name](#index-name) |  |  | No |  | Inferred from Usage |
...
| 295 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime | No | none | Solution Export |
| 296 | [ownerid](#index-ownerid) | Owner | owner | No | systemrequired | Solution Export |
| 297 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup | No | none | Solution Export |
| 298 | [owningteam](#index-owningteam) | Owning Team | lookup | No | none | Solution Export |
| 299 | [owninguser](#index-owninguser) | Owning User | lookup | No | none | Solution Export |
| 300 | [parentaccountid](#index-parentaccountid) |  |  | No |  | Inferred from Usage |
| 301 | [parentcontactid](#index-parentcontactid) |  |  | No |  | Inferred from Usage |
| 302 | [parentcustomerid](#index-parentcustomerid) |  |  | No |  | Inferred from Usage |
| 303 | [parentgoalid](#index-parentgoalid) |  |  | No |  | Inferred from Usage |
| 304 | [parentsystemuserid](#index-parentsystemuserid) |  |  | No |  | Inferred from Usage |
| 305 | [partyid](#index-partyid) |  |  | No |  | Inferred from Usage |
| 306 | [phonenumber](#index-phonenumber) |  |  | No |  | Inferred from Usage |
| 307 | [pricelevelid](#index-pricelevelid) |  |  | No |  | Inferred from Usage |
| 308 | [priceperunit](#index-priceperunit) |  |  | No |  | Inferred from Usage |
| 309 | [primarycontactid](#index-primarycontactid) |  |  | No |  | Inferred from Usage |
| 310 | [prod.productid](#index-prodproductid) |  |  | No |  | Inferred from Usage |
| 311 | [productdescription](#index-productdescription) |  |  | No |  | Inferred from Usage |
| 312 | [productid](#index-productid) |  |  | No |  | Inferred from Usage |
| 313 | [productname](#index-productname) |  |  | No |  | Inferred from Usage |
| 314 | [productnumber](#index-productnumber) |  |  | No |  | Inferred from Usage |
| 315 | [producttypecode](#index-producttypecode) |  |  | No |  | Inferred from Usage |
| 316 | [quantity](#index-quantity) |  |  | No |  | Inferred from Usage |
| 317 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 318 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 319 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 320 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 321 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
...
| 336 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 337 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 338 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 339 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 340 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 341 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 342 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 343 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 344 | [statecode](#index-statecode) | Status | state | No | systemrequired | Solution Export |
| 345 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 346 | [statuscode](#index-statuscode) | Status Reason | status | No | none | Solution Export |
| 347 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 348 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 349 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 350 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 351 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 352 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 353 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 354 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int | No | none | Solution Export |
| 355 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 356 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 357 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 358 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 359 | [transactioncurrencyid](#index-transactioncurrencyid) |  |  | No |  | Inferred from Usage |
| 360 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 361 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int | No | none | Solution Export |
| 362 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 363 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 364 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
