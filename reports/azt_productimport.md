...
- [2. Forms](#2.%20Forms)
  ...
  - [2.2. Product Import - main - Active](#2.2.%20Product%20Import%20-%20main%20-%20Active)
  - [2.3. Information - quick - Active](#2.3.%20Information%20-%20quick%20-%20Active)
- [3. Views](#3.%20Views)
  - [3.1. Active Product Imports](#3.1.%20Active%20Product%20Imports)
  - [3.2. Inactive Product Imports](#3.2.%20Inactive%20Product%20Imports)
  - [3.3. Product Import Advanced Find View](#3.3.%20Product%20Import%20Advanced%20Find%20View)
  - [3.4. Product Import Associated View](#3.4.%20Product%20Import%20Associated%20View)
  - [3.5. Product Import Lookup View](#3.5.%20Product%20Import%20Lookup%20View)
  - [3.6. Product Imports](#3.6.%20Product%20Imports)
  - [3.7. Quick Find Active Product Imports](#3.7.%20Quick%20Find%20Active%20Product%20Imports)
...
| 39 | [azt_description](#azt_description) | Description | ntext |  | Yes | none |  | C R U | false |  |  |  |  |  |  | [1](#2.%20Forms) | [2](#3.%20Views) |  |  |  |  |  | [2](#10.%20Plugin%20Source%20Code%20Analysis) |  |  |  |  |
...
| 134 | [azt_productfamilies](#azt_productfamilies) | Product Families | nvarchar |  | Yes | none |  | C R U | false |  |  |  |  |  |  | [1](#2.%20Forms) | [2](#3.%20Views) |  |  |  |  |  |  |  |  |  |  |
| 135 | [azt_productid](#azt_productid) | Product ID | nvarchar |  | Yes | none |  | C R U | false |  |  |  |  |  |  | [1](#2.%20Forms) | [2](#3.%20Views) |  |  |  |  |  |  |  |  |  |  |
| 136 | [azt_productimportid](#azt_productimportid) | Product Import | primarykey |  | No | systemrequired |  | C R F Re | false |  |  |  |  |  |  |  | [7](#3.%20Views) |  |  |  |  |  |  |  |  |  |  |
...
| 151 | [azt_salesfamilies](#azt_salesfamilies) | Sales Families | nvarchar |  | Yes | none |  | C R U | false |  |  |  |  |  |  | [1](#2.%20Forms) | [1](#3.%20Views) |  |  |  |  |  |  |  |  |  |  |
...
| 193 | [createdon](#createdon) | Created On | datetime |  | No | none |  | R F Re | true |  |  |  |  |  |  | [1](#2.%20Forms) | [6](#3.%20Views) |  |  |  | [7](#7.%20Workflows) |  | [10](#10.%20Plugin%20Source%20Code%20Analysis) |  |  |  |  |
...
| [azt_productid](#azt_productid) | Product ID | No | Yes |
...
| 2 | [azt_productfamilies](#azt_productfamilies) | 200px |
| 3 | [azt_description](#azt_description) | 200px |
| 4 | [azt_productid](#azt_productid) | 150px |
| 5 | [createdon](#createdon) | 125px |
| 6 | [azt_productimportid](#azt_productimportid) |  |
...
| 3 | [azt_productimportid](#azt_productimportid) |  |
...
### 3.3. Product Import Advanced Find View
...
|---|-------|-------|
| 1 | [azt_name](#azt_name) | 300px |
| 2 | [azt_salesfamilies](#azt_salesfamilies) | 200px |
| 3 | [azt_productfamilies](#azt_productfamilies) | 200px |
| 4 | [azt_description](#azt_description) | 200px |
| 5 | [azt_productid](#azt_productid) | 150px |
| 6 | [createdon](#createdon) | 125px |
| 7 | [azt_productimportid](#azt_productimportid) |  |
...
### 3.4. Product Import Associated View
...
### 3.5. Product Import Lookup View
...
| # | Field | Width |
|---|-------|-------|
| 1 | [azt_productimportid](#azt_productimportid) |  |
...
### 3.7. Quick Find Active Product Imports
...
|-------------------|------|-------------------|-------------------|-------------|
| lk_azt_productimport_createdby | N:1 | SystemUser | azt_productimport | [CreatedBy](#CreatedBy) |
| lk_azt_productimport_modifiedby | N:1 | SystemUser | azt_productimport | [ModifiedBy](#ModifiedBy) |
| organization_azt_productimport | N:1 | Organization | azt_productimport | [OrganizationId](#OrganizationId) |
...
- [Field Definitions](#1.%20Field%20Definitions)
- [Form: Product Import > General > General](#2.2.%20Product%20Import%20-%20main%20-%20Active)
- [View: Active Product Imports](#3.1.%20Active%20Product%20Imports)
- [View: Product Import Advanced Find View](#3.3.%20Product%20Import%20Advanced%20Find%20View)
- [Plugin: CloneExpenseLine (Read)](#10.17.%20CloneExpenseLine)
- [Plugin: CloneExpenseLine (Write)](#10.17.%20CloneExpenseLine)
...
- [View: Active Product Imports](#3.1.%20Active%20Product%20Imports)
- [View: Active Product Imports (Sort)](#3.1.%20Active%20Product%20Imports)
- [View: Inactive Product Imports](#3.2.%20Inactive%20Product%20Imports)
- [View: Inactive Product Imports (Sort)](#3.2.%20Inactive%20Product%20Imports)
- [View: Product Import Advanced Find View](#3.3.%20Product%20Import%20Advanced%20Find%20View)
- [View: Product Import Advanced Find View (Sort)](#3.3.%20Product%20Import%20Advanced%20Find%20View)
- [View: Product Import Associated View](#3.4.%20Product%20Import%20Associated%20View)
- [View: Product Import Associated View (Sort)](#3.4.%20Product%20Import%20Associated%20View)
- [View: Product Import Lookup View](#3.5.%20Product%20Import%20Lookup%20View)
- [View: Quick Find Active Product Imports](#3.7.%20Quick%20Find%20Active%20Product%20Imports)
- [View: Quick Find Active Product Imports (Filter)](#3.7.%20Quick%20Find%20Active%20Product%20Imports)
- [View: Quick Find Active Product Imports (Sort)](#3.7.%20Quick%20Find%20Active%20Product%20Imports)
...
- [View: Product Import Associated View](#3.4.%20Product%20Import%20Associated%20View)
- [View: Product Import Lookup View](#3.5.%20Product%20Import%20Lookup%20View)
- [View: Product Imports](#3.6.%20Product%20Imports)
- [View: Quick Find Active Product Imports](#3.7.%20Quick%20Find%20Active%20Product%20Imports)
...
- [Field Definitions](#1.%20Field%20Definitions)
- [Relationship: organization_azt_productimport](#12.%20Relationships)
...
- [Field Definitions](#1.%20Field%20Definitions)
- [View: Active Product Imports (Filter)](#3.1.%20Active%20Product%20Imports)
- [View: Inactive Product Imports (Filter)](#3.2.%20Inactive%20Product%20Imports)
- [View: Product Import Associated View (Filter)](#3.4.%20Product%20Import%20Associated%20View)
- [View: Product Import Lookup View (Filter)](#3.5.%20Product%20Import%20Lookup%20View)
- [View: Product Imports (Filter)](#3.6.%20Product%20Imports)
- [View: Quick Find Active Product Imports (Filter)](#3.7.%20Quick%20Find%20Active%20Product%20Imports)
