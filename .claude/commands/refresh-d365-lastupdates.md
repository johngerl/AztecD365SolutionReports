...
This is Step 3 of the pipeline. It connects to Dataverse via TDS, queries entity-level totalRows and MAX(modifiedon) (inserted after auditEnabled), then queries MAX(modifiedon) per field, and updates the JSON in-place.
