...
| 2 | [exchangerate](#index-exchangerate) | Exchange Rate | decimal |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 3 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [pricelevelid](#index-pricelevelid) | Price List | lookup |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [productid](#index-productid) | Product | lookup |  | No | required | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  |  |  | [33](#10-plugin-source-code-analysis) |  |  |  |  |
| 6 | [productnumber](#index-productnumber) | Product ID | nvarchar |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [productpricelevelid](#index-productpricelevelid) | Product Price List | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 8 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [uomid](#index-uomid) | Unit | lookup |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
