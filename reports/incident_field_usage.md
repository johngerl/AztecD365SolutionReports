...
| 2 | [accessteam](#index-accessteam) |  |  | No |  | Inferred from Usage |
...
| 7 | [actualend](#index-actualend) |  |  | No |  | Inferred from Usage |
| 8 | [address1_stateorprovince](#index-address1_stateorprovince) |  |  | No |  | Inferred from Usage |
| 9 | [address1_telephone1](#index-address1_telephone1) |  |  | No |  | Inferred from Usage |
| 10 | [adx_resolution](#index-adx_resolution) |  |  | No |  | Inferred from Usage |
| 11 | [adx_resolutiondate](#index-adx_resolutiondate) |  |  | No |  | Inferred from Usage |
| 12 | [amountdatatype](#index-amountdatatype) |  |  | No |  | Inferred from Usage |
| 13 | [annotationid](#index-annotationid) |  |  | No |  | Inferred from Usage |
| 14 | [audit](#index-audit) |  |  | No |  | Inferred from Usage |
...
| 20 | [azt_addresssearch](#index-azt_addresssearch) |  |  | Yes |  | Inferred from Usage |
| 21 | [azt_addresssearch2](#index-azt_addresssearch2) |  |  | Yes |  | Inferred from Usage |
| 22 | [azt_addtocrtqueue](#index-azt_addtocrtqueue) |  |  | Yes |  | Inferred from Usage |
...
| 32 | [azt_aztecproduct](#index-azt_aztecproduct) | Aztec Product | picklist | Yes | none | Solution Export |
...
| 50 | [azt_customersupportstatus](#index-azt_customersupportstatus) | Customer Support Status | bit | Yes | none | Solution Export |
| 51 | [azt_customertrainingid](#index-azt_customertrainingid) |  |  | Yes |  | Inferred from Usage |
| 52 | [azt_dateexitedstage](#index-azt_dateexitedstage) |  |  | Yes |  | Inferred from Usage |
| 53 | [azt_daysopen](#index-azt_daysopen) | Days Open | int | Yes | none | Solution Export |
| 54 | [azt_defaultfreightamount](#index-azt_defaultfreightamount) |  |  | Yes |  | Inferred from Usage |
| 55 | [azt_description](#index-azt_description) |  |  | Yes |  | Inferred from Usage |
| 56 | [azt_discountamount](#index-azt_discountamount) |  |  | Yes |  | Inferred from Usage |
| 57 | [azt_discretionarydiscountamt](#index-azt_discretionarydiscountamt) |  |  | Yes |  | Inferred from Usage |
| 58 | [azt_duedate](#index-azt_duedate) |  |  | Yes |  | Inferred from Usage |
| 59 | [azt_effectivedate](#index-azt_effectivedate) |  |  | Yes |  | Inferred from Usage |
| 60 | [azt_email](#index-azt_email) |  |  | Yes |  | Inferred from Usage |
| 61 | [azt_enddate](#index-azt_enddate) |  |  | Yes |  | Inferred from Usage |
| 62 | [azt_engagementid](#index-azt_engagementid) | Engagement | lookup | Yes | none | Solution Export |
| 63 | [azt_estfulfillmentdate](#index-azt_estfulfillmentdate) |  |  | Yes |  | Inferred from Usage |
| 64 | [azt_evaluate](#index-azt_evaluate) |  |  | Yes |  | Inferred from Usage |
| 65 | [azt_expenseamount](#index-azt_expenseamount) |  |  | Yes |  | Inferred from Usage |
| 66 | [azt_expenseid](#index-azt_expenseid) |  |  | Yes |  | Inferred from Usage |
| 67 | [azt_expensereportid](#index-azt_expensereportid) |  |  | Yes |  | Inferred from Usage |
| 68 | [azt_expensetype](#index-azt_expensetype) |  |  | Yes |  | Inferred from Usage |
| 69 | [azt_expirationdate](#index-azt_expirationdate) |  |  | Yes |  | Inferred from Usage |
| 70 | [azt_extension](#index-azt_extension) |  |  | Yes |  | Inferred from Usage |
| 71 | [azt_fieldtoautonumber](#index-azt_fieldtoautonumber) |  |  | Yes |  | Inferred from Usage |
| 72 | [azt_firstname](#index-azt_firstname) |  |  | Yes |  | Inferred from Usage |
| 73 | [azt_firstrecordownerassignment](#index-azt_firstrecordownerassignment) | First Record Owner Assignment | bit | Yes | none | Solution Export |
| 74 | [azt_fiscalperiodend](#index-azt_fiscalperiodend) |  |  | Yes |  | Inferred from Usage |
| 75 | [azt_fiscalperiodstart](#index-azt_fiscalperiodstart) |  |  | Yes |  | Inferred from Usage |
| 76 | [azt_freightamtapproved](#index-azt_freightamtapproved) |  |  | Yes |  | Inferred from Usage |
| 77 | [azt_fsrassignedon](#index-azt_fsrassignedon) |  |  | Yes |  | Inferred from Usage |
| 78 | [azt_fsremail](#index-azt_fsremail) |  |  | Yes |  | Inferred from Usage |
| 79 | [azt_fsrid](#index-azt_fsrid) |  |  | Yes |  | Inferred from Usage |
| 80 | [azt_fsrmobiletelephone](#index-azt_fsrmobiletelephone) |  |  | Yes |  | Inferred from Usage |
| 81 | [azt_fsrtelephone](#index-azt_fsrtelephone) |  |  | Yes |  | Inferred from Usage |
| 82 | [azt_fsrtelephoneextension](#index-azt_fsrtelephoneextension) |  |  | Yes |  | Inferred from Usage |
| 83 | [azt_fundingid](#index-azt_fundingid) |  |  | Yes |  | Inferred from Usage |
| 84 | [azt_fundingyear](#index-azt_fundingyear) |  |  | Yes |  | Inferred from Usage |
| 85 | [azt_goaltype](#index-azt_goaltype) |  |  | Yes |  | Inferred from Usage |
| 86 | [azt_historicalowner](#index-azt_historicalowner) | Historical Owner | nvarchar | Yes | none | Solution Export |
| 87 | [azt_importname](#index-azt_importname) |  |  | Yes |  | Inferred from Usage |
| 88 | [azt_invoiceid](#index-azt_invoiceid) |  |  | Yes |  | Inferred from Usage |
| 89 | [azt_invoiceproductid](#index-azt_invoiceproductid) |  |  | Yes |  | Inferred from Usage |
| 90 | [azt_isbn](#index-azt_isbn) |  |  | Yes |  | Inferred from Usage |
| 91 | [azt_iscompanion](#index-azt_iscompanion) |  |  | Yes |  | Inferred from Usage |
| 92 | [azt_isprint](#index-azt_isprint) |  |  | Yes |  | Inferred from Usage |
| 93 | [azt_issaas](#index-azt_issaas) |  |  | Yes |  | Inferred from Usage |
| 94 | [azt_jobrole](#index-azt_jobrole) |  |  | Yes |  | Inferred from Usage |
| 95 | [azt_jobtitle](#index-azt_jobtitle) |  |  | Yes |  | Inferred from Usage |
| 96 | [azt_lastactivitydate](#index-azt_lastactivitydate) |  |  | Yes |  | Inferred from Usage |
| 97 | [azt_lastmodifiedbyid](#index-azt_lastmodifiedbyid) |  |  | Yes |  | Inferred from Usage |
| 98 | [azt_lastname](#index-azt_lastname) |  |  | Yes |  | Inferred from Usage |
| 99 | [azt_leadimportid](#index-azt_leadimportid) |  |  | Yes |  | Inferred from Usage |
| 100 | [azt_leadsourceid](#index-azt_leadsourceid) |  |  | Yes |  | Inferred from Usage |
| 101 | [azt_licensestatus](#index-azt_licensestatus) |  |  | Yes |  | Inferred from Usage |
| 102 | [azt_licenseterm](#index-azt_licenseterm) |  |  | Yes |  | Inferred from Usage |
| 103 | [azt_licensetermmonths](#index-azt_licensetermmonths) |  |  | Yes |  | Inferred from Usage |
| 104 | [azt_licensetype](#index-azt_licensetype) |  |  | Yes |  | Inferred from Usage |
| 105 | [azt_masecommission](#index-azt_masecommission) |  |  | Yes |  | Inferred from Usage |
| 106 | [azt_mileage](#index-azt_mileage) |  |  | Yes |  | Inferred from Usage |
| 107 | [azt_monthstofilteron](#index-azt_monthstofilteron) |  |  | Yes |  | Inferred from Usage |
| 108 | [azt_name](#index-azt_name) |  |  | Yes |  | Inferred from Usage |
| 109 | [azt_newestclosedate](#index-azt_newestclosedate) |  |  | Yes |  | Inferred from Usage |
| 110 | [azt_newestimatedvalue](#index-azt_newestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 111 | [azt_newownerid](#index-azt_newownerid) |  |  | Yes |  | Inferred from Usage |
| 112 | [azt_newprobability](#index-azt_newprobability) |  |  | Yes |  | Inferred from Usage |
| 113 | [azt_nonsaasstatus](#index-azt_nonsaasstatus) |  |  | Yes |  | Inferred from Usage |
| 114 | [azt_nonsaastype](#index-azt_nonsaastype) |  |  | Yes |  | Inferred from Usage |
| 115 | [azt_numberoflicenses](#index-azt_numberoflicenses) |  |  | Yes |  | Inferred from Usage |
| 116 | [azt_opportunityauditrecordid](#index-azt_opportunityauditrecordid) |  |  | Yes |  | Inferred from Usage |
| 117 | [azt_opportunityid](#index-azt_opportunityid) |  |  | Yes |  | Inferred from Usage |
| 118 | [azt_opportunityproductid](#index-azt_opportunityproductid) |  |  | Yes |  | Inferred from Usage |
| 119 | [azt_orderid](#index-azt_orderid) |  |  | Yes |  | Inferred from Usage |
| 120 | [azt_orderlineid](#index-azt_orderlineid) |  |  | Yes |  | Inferred from Usage |
| 121 | [azt_orderproductid](#index-azt_orderproductid) |  |  | Yes |  | Inferred from Usage |
| 122 | [azt_orderstageid](#index-azt_orderstageid) |  |  | Yes |  | Inferred from Usage |
| 123 | [azt_ordertemplatelines](#index-azt_ordertemplatelines) |  |  | Yes |  | Inferred from Usage |
| 124 | [azt_ordertype](#index-azt_ordertype) |  |  | Yes |  | Inferred from Usage |
| 125 | [azt_originatingleadimportid](#index-azt_originatingleadimportid) |  |  | Yes |  | Inferred from Usage |
| 126 | [azt_paid](#index-azt_paid) |  |  | Yes |  | Inferred from Usage |
| 127 | [azt_paidon](#index-azt_paidon) |  |  | Yes |  | Inferred from Usage |
| 128 | [azt_parentopportunityid](#index-azt_parentopportunityid) |  |  | Yes |  | Inferred from Usage |
| 129 | [azt_parentorderid](#index-azt_parentorderid) |  |  | Yes |  | Inferred from Usage |
| 130 | [azt_payablecommission](#index-azt_payablecommission) |  |  | Yes |  | Inferred from Usage |
| 131 | [azt_paymentdate](#index-azt_paymentdate) |  |  | Yes |  | Inferred from Usage |
| 132 | [azt_paymentid](#index-azt_paymentid) |  |  | Yes |  | Inferred from Usage |
| 133 | [azt_percentage](#index-azt_percentage) |  |  | Yes |  | Inferred from Usage |
| 134 | [azt_percentagepaid](#index-azt_percentagepaid) |  |  | Yes |  | Inferred from Usage |
| 135 | [azt_periodend](#index-azt_periodend) |  |  | Yes |  | Inferred from Usage |
| 136 | [azt_periodstart](#index-azt_periodstart) |  |  | Yes |  | Inferred from Usage |
| 137 | [azt_phone](#index-azt_phone) |  |  | Yes |  | Inferred from Usage |
| 138 | [azt_ponumber](#index-azt_ponumber) |  |  | Yes |  | Inferred from Usage |
| 139 | [azt_prefix](#index-azt_prefix) |  |  | Yes |  | Inferred from Usage |
| 140 | [azt_prefixhasseparator](#index-azt_prefixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 141 | [azt_prefixseparator](#index-azt_prefixseparator) |  |  | Yes |  | Inferred from Usage |
| 142 | [azt_prefixseparatorisspace](#index-azt_prefixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 143 | [azt_previousestclosedate](#index-azt_previousestclosedate) |  |  | Yes |  | Inferred from Usage |
| 144 | [azt_previousestimatedvalue](#index-azt_previousestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 145 | [azt_previousownerid](#index-azt_previousownerid) |  |  | Yes |  | Inferred from Usage |
| 146 | [azt_previousprobability](#index-azt_previousprobability) |  |  | Yes |  | Inferred from Usage |
| 147 | [azt_printproductid](#index-azt_printproductid) |  |  | Yes |  | Inferred from Usage |
| 148 | [azt_printpurchaseid](#index-azt_printpurchaseid) |  |  | Yes |  | Inferred from Usage |
| 149 | [azt_probability](#index-azt_probability) |  |  | Yes |  | Inferred from Usage |
| 150 | [azt_probabilitychangedon](#index-azt_probabilitychangedon) |  |  | Yes |  | Inferred from Usage |
| 151 | [azt_probabilityincreased](#index-azt_probabilityincreased) |  |  | Yes |  | Inferred from Usage |
| 152 | [azt_productdiscountid](#index-azt_productdiscountid) |  |  | Yes |  | Inferred from Usage |
| 153 | [azt_producttype](#index-azt_producttype) |  |  | Yes |  | Inferred from Usage |
| 154 | [azt_purchasedate](#index-azt_purchasedate) |  |  | Yes |  | Inferred from Usage |
| 155 | [azt_quantity](#index-azt_quantity) |  |  | Yes |  | Inferred from Usage |
| 156 | [azt_quotenumber](#index-azt_quotenumber) |  |  | Yes |  | Inferred from Usage |
| 157 | [azt_quoteproductid](#index-azt_quoteproductid) |  |  | Yes |  | Inferred from Usage |
| 158 | [azt_reasonforexpense](#index-azt_reasonforexpense) |  |  | Yes |  | Inferred from Usage |
| 159 | [azt_recordowner](#index-azt_recordowner) |  |  | Yes |  | Inferred from Usage |
| 160 | [azt_recordownerid](#index-azt_recordownerid) | Record Owner | lookup | Yes | none | Solution Export |
| 161 | [azt_replacementproductid](#index-azt_replacementproductid) |  |  | Yes |  | Inferred from Usage |
| 162 | [azt_requestedfreightamt](#index-azt_requestedfreightamt) |  |  | Yes |  | Inferred from Usage |
| 163 | [azt_resolvedbyid](#index-azt_resolvedbyid) | Resolved By | lookup | Yes | none | Solution Export |
| 164 | [azt_responsibletechnicianid](#index-azt_responsibletechnicianid) | Responsible Rep | lookup | Yes | none | Solution Export |
| 165 | [azt_result](#index-azt_result) |  |  | Yes |  | Inferred from Usage |
| 166 | [azt_saas](#index-azt_saas) |  |  | Yes |  | Inferred from Usage |
| 167 | [azt_saasstatus](#index-azt_saasstatus) |  |  | Yes |  | Inferred from Usage |
| 168 | [azt_salesrepid](#index-azt_salesrepid) |  |  | Yes |  | Inferred from Usage |
| 169 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) |  |  | Yes |  | Inferred from Usage |
| 170 | [azt_softwareproductid](#index-azt_softwareproductid) |  |  | Yes |  | Inferred from Usage |
| 171 | [azt_startdate](#index-azt_startdate) |  |  | Yes |  | Inferred from Usage |
| 172 | [azt_stateabbreviation](#index-azt_stateabbreviation) |  |  | Yes |  | Inferred from Usage |
| 173 | [azt_stateprovince](#index-azt_stateprovince) |  |  | Yes |  | Inferred from Usage |
| 174 | [azt_suffix](#index-azt_suffix) |  |  | Yes |  | Inferred from Usage |
| 175 | [azt_suffixhasseparator](#index-azt_suffixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 176 | [azt_suffixseparator](#index-azt_suffixseparator) |  |  | Yes |  | Inferred from Usage |
| 177 | [azt_suffixseparatorisspace](#index-azt_suffixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 178 | [azt_supportexpirationdate](#index-azt_supportexpirationdate) |  |  | Yes |  | Inferred from Usage |
| 179 | [azt_total](#index-azt_total) |  |  | Yes |  | Inferred from Usage |
| 180 | [azt_totalamountpaid](#index-azt_totalamountpaid) |  |  | Yes |  | Inferred from Usage |
| 181 | [azt_totalfunding](#index-azt_totalfunding) |  |  | Yes |  | Inferred from Usage |
| 182 | [azt_totalreimbursement](#index-azt_totalreimbursement) |  |  | Yes |  | Inferred from Usage |
| 183 | [azt_trackingnumber](#index-azt_trackingnumber) |  |  | Yes |  | Inferred from Usage |
| 184 | [azt_trackingnumbers](#index-azt_trackingnumbers) |  |  | Yes |  | Inferred from Usage |
| 185 | [azt_trainingid](#index-azt_trainingid) |  |  | Yes |  | Inferred from Usage |
| 186 | [azt_utrackcase](#index-azt_utrackcase) | U-Track Case# | nvarchar | Yes | none | Solution Export |
| 187 | [azt_year](#index-azt_year) |  |  | Yes |  | Inferred from Usage |
| 188 | [baseamount](#index-baseamount) |  |  | No |  | Inferred from Usage |
| 189 | [billto_line1](#index-billto_line1) |  |  | No |  | Inferred from Usage |
| 190 | [billto_line2](#index-billto_line2) |  |  | No |  | Inferred from Usage |
| 191 | [billto_line3](#index-billto_line3) |  |  | No |  | Inferred from Usage |
| 192 | [billto_name](#index-billto_name) |  |  | No |  | Inferred from Usage |
| 193 | [billto_postalcode](#index-billto_postalcode) |  |  | No |  | Inferred from Usage |
| 194 | [billto_stateorprovince](#index-billto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 195 | [body](#index-body) |  |  | No |  | Inferred from Usage |
| 196 | [bpf_duration](#index-bpf_duration) |  |  | No |  | Inferred from Usage |
| 197 | [bpf_salesorderid](#index-bpf_salesorderid) |  |  | No |  | Inferred from Usage |
| 198 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) |  |  | No |  | Inferred from Usage |
| 199 | [businessunitid](#index-businessunitid) |  |  | No |  | Inferred from Usage |
| 200 | [caseorigincode](#index-caseorigincode) | Case Origin | picklist | No | none | Solution Export |
| 201 | [casetypecode](#index-casetypecode) | Case Type | picklist | No | none | Solution Export |
| 202 | [category](#index-category) |  |  | No |  | Inferred from Usage |
| 203 | [city](#index-city) |  |  | No |  | Inferred from Usage |
| 204 | [closeprobability](#index-closeprobability) |  |  | No |  | Inferred from Usage |
| 205 | [companyname](#index-companyname) |  |  | No |  | Inferred from Usage |
| 206 | [conditionbranchstep2_1](#index-conditionbranchstep2_1) |  |  | No |  | Inferred from Usage |
| 207 | [connectionid](#index-connectionid) |  |  | No |  | Inferred from Usage |
| 208 | [connectionroleid](#index-connectionroleid) |  |  | No |  | Inferred from Usage |
| 209 | [consideronlygoalownersrecords](#index-consideronlygoalownersrecords) |  |  | No |  | Inferred from Usage |
| 210 | [contactid](#index-contactid) |  |  | No |  | Inferred from Usage |
| 211 | [contractdetailid](#index-contractdetailid) |  |  | No |  | Inferred from Usage |
| 212 | [contractid](#index-contractid) |  |  | No |  | Inferred from Usage |
| 213 | [country](#index-country) |  |  | No |  | Inferred from Usage |
| 214 | [county](#index-county) |  |  | No |  | Inferred from Usage |
| 215 | [createdby](#index-createdby) |  |  | No |  | Inferred from Usage |
| 216 | [createdbyexternalparty](#index-createdbyexternalparty) |  |  | No |  | Inferred from Usage |
| 217 | [createdon](#index-createdon) |  |  | No |  | Inferred from Usage |
| 218 | [crm3_expenseamount](#index-crm3_expenseamount) |  |  | No |  | Inferred from Usage |
| 219 | [crm3_parentleadid](#index-crm3_parentleadid) |  |  | No |  | Inferred from Usage |
| 220 | [customerid](#index-customerid) | Customer | customer | No | systemrequired | Solution Export |
| 221 | [datefulfilled](#index-datefulfilled) |  |  | No |  | Inferred from Usage |
| 222 | [defaultuomid](#index-defaultuomid) |  |  | No |  | Inferred from Usage |
| 223 | [description](#index-description) |  |  | No |  | Inferred from Usage |
| 224 | [discountamount](#index-discountamount) |  |  | No |  | Inferred from Usage |
| 225 | [discountpercentage](#index-discountpercentage) |  |  | No |  | Inferred from Usage |
| 226 | [emailaddress1](#index-emailaddress1) |  |  | No |  | Inferred from Usage |
| 227 | [entitlementid](#index-entitlementid) |  |  | No |  | Inferred from Usage |
| 228 | [entityimage](#index-entityimage) | Entity Image | image | No | none | Solution Export |
| 229 | [estimatedclosedate](#index-estimatedclosedate) |  |  | No |  | Inferred from Usage |
| 230 | [estimatedvalue](#index-estimatedvalue) |  |  | No |  | Inferred from Usage |
| 231 | [existingcase](#index-existingcase) |  |  | No |  | Inferred from Usage |
...
| 237 | [firstresponsebykpiid](#index-firstresponsebykpiid) |  |  | No |  | Inferred from Usage |
| 238 | [freightamount](#index-freightamount) |  |  | No |  | Inferred from Usage |
| 239 | [freighttermscode](#index-freighttermscode) |  |  | No |  | Inferred from Usage |
| 240 | [from](#index-from) |  |  | No |  | Inferred from Usage |
| 241 | [fullname](#index-fullname) |  |  | No |  | Inferred from Usage |
| 242 | [goalenddate](#index-goalenddate) |  |  | No |  | Inferred from Usage |
| 243 | [goalid](#index-goalid) |  |  | No |  | Inferred from Usage |
| 244 | [goalownerid](#index-goalownerid) |  |  | No |  | Inferred from Usage |
| 245 | [goalrollupqueryid](#index-goalrollupqueryid) |  |  | No |  | Inferred from Usage |
| 246 | [goalstartdate](#index-goalstartdate) |  |  | No |  | Inferred from Usage |
...
| 260 | [kbarticleid](#index-kbarticleid) |  |  | No |  | Inferred from Usage |
| 261 | [knowledgebase](#index-knowledgebase) |  |  | No |  | Inferred from Usage |
| 262 | [lastname](#index-lastname) |  |  | No |  | Inferred from Usage |
| 263 | [manualdiscountamount](#index-manualdiscountamount) |  |  | No |  | Inferred from Usage |
| 264 | [metricid](#index-metricid) |  |  | No |  | Inferred from Usage |
| 265 | [mimetype](#index-mimetype) |  |  | No |  | Inferred from Usage |
| 266 | [mobilephone](#index-mobilephone) |  |  | No |  | Inferred from Usage |
| 267 | [modifiedby](#index-modifiedby) |  |  | No |  | Inferred from Usage |
| 268 | [modifiedbyexternalparty](#index-modifiedbyexternalparty) |  |  | No |  | Inferred from Usage |
| 269 | [modifiedon](#index-modifiedon) |  |  | No |  | Inferred from Usage |
| 270 | [msa_partnercontactid](#index-msa_partnercontactid) |  |  | No |  | Inferred from Usage |
| 271 | [msa_partnerid](#index-msa_partnerid) |  |  | No |  | Inferred from Usage |
| 272 | [msdyn_aiagentstatus](#index-msdyn_aiagentstatus) |  |  | No |  | Inferred from Usage |
| 273 | [msdyn_iotalert](#index-msdyn_iotalert) |  |  | No |  | Inferred from Usage |
| 274 | [name](#index-name) |  |  | No |  | Inferred from Usage |
| 275 | [notescontrol](#index-notescontrol) |  |  | No |  | Inferred from Usage |
| 276 | [objectid](#index-objectid) |  |  | No |  | Inferred from Usage |
| 277 | [objecttypecode](#index-objecttypecode) |  |  | No |  | Inferred from Usage |
| 278 | [opportunityid](#index-opportunityid) |  |  | No |  | Inferred from Usage |
| 279 | [opportunityproductid](#index-opportunityproductid) |  |  | No |  | Inferred from Usage |
| 280 | [originatingcaseid](#index-originatingcaseid) |  |  | No |  | Inferred from Usage |
| 281 | [originatingleadid](#index-originatingleadid) |  |  | No |  | Inferred from Usage |
| 282 | [ownerid](#index-ownerid) |  |  | No |  | Inferred from Usage |
| 283 | [owningbusinessunit](#index-owningbusinessunit) |  |  | No |  | Inferred from Usage |
| 284 | [owningteam](#index-owningteam) |  |  | No |  | Inferred from Usage |
| 285 | [owninguser](#index-owninguser) |  |  | No |  | Inferred from Usage |
| 286 | [parentaccountid](#index-parentaccountid) |  |  | No |  | Inferred from Usage |
| 287 | [parentcaseid](#index-parentcaseid) |  |  | No |  | Inferred from Usage |
...
| 296 | [primarycontactid](#index-primarycontactid) | Contact | lookup | No | required | Solution Export |
| 297 | [prioritycode](#index-prioritycode) |  |  | No |  | Inferred from Usage |
...
| 316 | [resolveby](#index-resolveby) |  |  | No |  | Inferred from Usage |
| 317 | [resolvebykpiid](#index-resolvebykpiid) |  |  | No |  | Inferred from Usage |
| 318 | [responseby](#index-responseby) |  |  | No |  | Inferred from Usage |
| 319 | [responsiblecontactid](#index-responsiblecontactid) |  |  | No |  | Inferred from Usage |
| 320 | [roleid](#index-roleid) |  |  | No |  | Inferred from Usage |
| 321 | [rolluponlyfromchildgoals](#index-rolluponlyfromchildgoals) |  |  | No |  | Inferred from Usage |
| 322 | [rollupqueryactualmoneyid](#index-rollupqueryactualmoneyid) |  |  | No |  | Inferred from Usage |
| 323 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 324 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 325 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 326 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 327 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 328 | [setattributevaluestep4_1](#index-setattributevaluestep4_1) |  |  | No |  | Inferred from Usage |
| 329 | [setattributevaluestep4_2](#index-setattributevaluestep4_2) |  |  | No |  | Inferred from Usage |
| 330 | [setattributevaluestep4_3](#index-setattributevaluestep4_3) |  |  | No |  | Inferred from Usage |
| 331 | [setattributevaluestep4_4](#index-setattributevaluestep4_4) |  |  | No |  | Inferred from Usage |
| 332 | [setattributevaluestep4_5](#index-setattributevaluestep4_5) |  |  | No |  | Inferred from Usage |
| 333 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 334 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 335 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 336 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 337 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 338 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 339 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 340 | [slaid](#index-slaid) |  |  | No |  | Inferred from Usage |
| 341 | [slainvokedid](#index-slainvokedid) |  |  | No |  | Inferred from Usage |
| 342 | [socialprofileid](#index-socialprofileid) |  |  | No |  | Inferred from Usage |
...
| 349 | [subjectid](#index-subjectid) |  |  | No |  | Inferred from Usage |
| 350 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 351 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 352 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 353 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 354 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 355 | [ticketnumber](#index-ticketnumber) |  |  | No |  | Inferred from Usage |
| 356 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 357 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 358 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 359 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 360 | [transactioncurrencyid](#index-transactioncurrencyid) |  |  | No |  | Inferred from Usage |
| 361 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 362 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 363 | [webresource_recordwall](#index-webresource_recordwall) |  |  | No |  | Inferred from Usage |
| 364 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 365 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
