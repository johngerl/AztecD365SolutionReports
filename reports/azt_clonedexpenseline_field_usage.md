...
| 31 | [azt_clonedexpenselineid](#index-azt_clonedexpenselineid) | Cloned Expense Line | primarykey | No | systemrequired | Solution Export |
...
| 99 | [azt_name](#index-azt_name) | Cloned Expense Line ID | nvarchar | Yes | required | Solution Export |
...
| 273 | [producttypecode](#index-producttypecode) |  |  | No |  | Inferred from Usage |
| 274 | [quantity](#index-quantity) |  |  | No |  | Inferred from Usage |
| 275 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 276 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 277 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 278 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 279 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
| 280 | [record1id](#index-record1id) |  |  | No |  | Inferred from Usage |
| 281 | [record1roleid](#index-record1roleid) |  |  | No |  | Inferred from Usage |
| 282 | [record2id](#index-record2id) |  |  | No |  | Inferred from Usage |
| 283 | [record2roleid](#index-record2roleid) |  |  | No |  | Inferred from Usage |
| 284 | [regardingobjectid](#index-regardingobjectid) |  |  | No |  | Inferred from Usage |
| 285 | [requestdeliveryby](#index-requestdeliveryby) |  |  | No |  | Inferred from Usage |
| 286 | [roleid](#index-roleid) |  |  | No |  | Inferred from Usage |
| 287 | [rolluponlyfromchildgoals](#index-rolluponlyfromchildgoals) |  |  | No |  | Inferred from Usage |
| 288 | [rollupqueryactualmoneyid](#index-rollupqueryactualmoneyid) |  |  | No |  | Inferred from Usage |
| 289 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 290 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 291 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 292 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 293 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 294 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 295 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 296 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 297 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 298 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 299 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 300 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 301 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 302 | [statecode](#index-statecode) | Status | state | No | systemrequired | Solution Export |
| 303 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 304 | [statuscode](#index-statuscode) | Status Reason | status | No | none | Solution Export |
| 305 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 306 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 307 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 308 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 309 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 310 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 311 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 312 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int | No | none | Solution Export |
| 313 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 314 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 315 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 316 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 317 | [transactioncurrencyid](#index-transactioncurrencyid) |  |  | No |  | Inferred from Usage |
| 318 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 319 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int | No | none | Solution Export |
| 320 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 321 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 322 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
