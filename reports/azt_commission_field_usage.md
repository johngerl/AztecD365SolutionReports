...
| 27 | [azt_bonuspoolamount](#index-azt_bonuspoolamount) | Bonus Pool Amount | money | Yes | none | Solution Export |
| 28 | [azt_bonuspoolamount_base](#index-azt_bonuspoolamount_base) | Bonus Pool Amount (Base) | money | Yes | none | Solution Export |
...
| 33 | [azt_combinedsales](#index-azt_combinedsales) | Combined Sales | money | Yes | none | Solution Export |
| 34 | [azt_combinedsales_base](#index-azt_combinedsales_base) | Combined Sales (Base) | money | Yes | none | Solution Export |
| 35 | [azt_commissionamount](#index-azt_commissionamount) |  |  | Yes |  | Inferred from Usage |
| 36 | [azt_commissionid](#index-azt_commissionid) | Commission | primarykey | No | systemrequired | Solution Export |
...
| 67 | [azt_fieldtoautonumber](#index-azt_fieldtoautonumber) |  |  | Yes |  | Inferred from Usage |
| 68 | [azt_firstname](#index-azt_firstname) |  |  | Yes |  | Inferred from Usage |
| 69 | [azt_fiscalperiodend](#index-azt_fiscalperiodend) | Fiscal Period End | datetime | Yes | required | Solution Export |
| 70 | [azt_fiscalperiodstart](#index-azt_fiscalperiodstart) | Fiscal Period Start | datetime | Yes | required | Solution Export |
| 71 | [azt_freightamtapproved](#index-azt_freightamtapproved) |  |  | Yes |  | Inferred from Usage |
| 72 | [azt_fsrassignedon](#index-azt_fsrassignedon) |  |  | Yes |  | Inferred from Usage |
| 73 | [azt_fsremail](#index-azt_fsremail) |  |  | Yes |  | Inferred from Usage |
| 74 | [azt_fsrid](#index-azt_fsrid) |  |  | Yes |  | Inferred from Usage |
| 75 | [azt_fsrmobiletelephone](#index-azt_fsrmobiletelephone) |  |  | Yes |  | Inferred from Usage |
| 76 | [azt_fsrtelephone](#index-azt_fsrtelephone) |  |  | Yes |  | Inferred from Usage |
| 77 | [azt_fsrtelephoneextension](#index-azt_fsrtelephoneextension) |  |  | Yes |  | Inferred from Usage |
| 78 | [azt_fundingid](#index-azt_fundingid) |  |  | Yes |  | Inferred from Usage |
| 79 | [azt_fundingyear](#index-azt_fundingyear) |  |  | Yes |  | Inferred from Usage |
| 80 | [azt_goaltype](#index-azt_goaltype) |  |  | Yes |  | Inferred from Usage |
| 81 | [azt_importname](#index-azt_importname) |  |  | Yes |  | Inferred from Usage |
| 82 | [azt_invoiceid](#index-azt_invoiceid) |  |  | Yes |  | Inferred from Usage |
| 83 | [azt_invoiceproductid](#index-azt_invoiceproductid) |  |  | Yes |  | Inferred from Usage |
| 84 | [azt_isbn](#index-azt_isbn) |  |  | Yes |  | Inferred from Usage |
| 85 | [azt_iscompanion](#index-azt_iscompanion) |  |  | Yes |  | Inferred from Usage |
...
| 102 | [azt_name](#index-azt_name) | Name | nvarchar | Yes | required | Solution Export |
...
| 107 | [azt_nonsaassales](#index-azt_nonsaassales) | Non-SaaS Sales | money | Yes | none | Solution Export |
| 108 | [azt_nonsaassales_base](#index-azt_nonsaassales_base) | Non-SaaS Sales (Base) | money | Yes | none | Solution Export |
...
| 162 | [azt_saassales](#index-azt_saassales) | SaaS Sales Q1 | money | Yes | none | Solution Export |
| 163 | [azt_saassales_base](#index-azt_saassales_base) | SaaS Sales (Base) | money | Yes | none | Solution Export |
| 164 | [azt_saasstatus](#index-azt_saasstatus) |  |  | Yes |  | Inferred from Usage |
| 165 | [azt_salesrepid](#index-azt_salesrepid) |  |  | Yes |  | Inferred from Usage |
| 166 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) |  |  | Yes |  | Inferred from Usage |
| 167 | [azt_softwareproductid](#index-azt_softwareproductid) |  |  | Yes |  | Inferred from Usage |
| 168 | [azt_startdate](#index-azt_startdate) |  |  | Yes |  | Inferred from Usage |
| 169 | [azt_stateabbreviation](#index-azt_stateabbreviation) |  |  | Yes |  | Inferred from Usage |
| 170 | [azt_stateprovince](#index-azt_stateprovince) |  |  | Yes |  | Inferred from Usage |
| 171 | [azt_suffix](#index-azt_suffix) |  |  | Yes |  | Inferred from Usage |
| 172 | [azt_suffixhasseparator](#index-azt_suffixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 173 | [azt_suffixseparator](#index-azt_suffixseparator) |  |  | Yes |  | Inferred from Usage |
| 174 | [azt_suffixseparatorisspace](#index-azt_suffixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 175 | [azt_supportexpirationdate](#index-azt_supportexpirationdate) |  |  | Yes |  | Inferred from Usage |
...
| 184 | [azt_ytdcommissionamt](#index-azt_ytdcommissionamt) | YTD Commission Amt | money | Yes | none | Solution Export |
| 185 | [azt_ytdcommissionamt_base](#index-azt_ytdcommissionamt_base) | YTD Commission Amt (Base) | money | Yes | none | Solution Export |
| 186 | [baseamount](#index-baseamount) |  |  | No |  | Inferred from Usage |
| 187 | [billto_line1](#index-billto_line1) |  |  | No |  | Inferred from Usage |
| 188 | [billto_line2](#index-billto_line2) |  |  | No |  | Inferred from Usage |
| 189 | [billto_line3](#index-billto_line3) |  |  | No |  | Inferred from Usage |
| 190 | [billto_name](#index-billto_name) |  |  | No |  | Inferred from Usage |
| 191 | [billto_postalcode](#index-billto_postalcode) |  |  | No |  | Inferred from Usage |
| 192 | [billto_stateorprovince](#index-billto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 193 | [body](#index-body) |  |  | No |  | Inferred from Usage |
| 194 | [bpf_duration](#index-bpf_duration) |  |  | No |  | Inferred from Usage |
| 195 | [bpf_salesorderid](#index-bpf_salesorderid) |  |  | No |  | Inferred from Usage |
| 196 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) |  |  | No |  | Inferred from Usage |
| 197 | [businessunitid](#index-businessunitid) |  |  | No |  | Inferred from Usage |
| 198 | [category](#index-category) |  |  | No |  | Inferred from Usage |
| 199 | [city](#index-city) |  |  | No |  | Inferred from Usage |
| 200 | [closeprobability](#index-closeprobability) |  |  | No |  | Inferred from Usage |
| 201 | [commissionableorders](#index-commissionableorders) |  |  | No |  | Inferred from Usage |
| 202 | [companyname](#index-companyname) |  |  | No |  | Inferred from Usage |
| 203 | [connectionid](#index-connectionid) |  |  | No |  | Inferred from Usage |
| 204 | [connectionroleid](#index-connectionroleid) |  |  | No |  | Inferred from Usage |
| 205 | [consideronlygoalownersrecords](#index-consideronlygoalownersrecords) |  |  | No |  | Inferred from Usage |
| 206 | [contactid](#index-contactid) |  |  | No |  | Inferred from Usage |
| 207 | [country](#index-country) |  |  | No |  | Inferred from Usage |
| 208 | [county](#index-county) |  |  | No |  | Inferred from Usage |
| 209 | [createdby](#index-createdby) | Created By | lookup | No | none | Solution Export |
| 210 | [createdon](#index-createdon) | Created On | datetime | No | none | Solution Export |
| 211 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup | No | none | Solution Export |
| 212 | [crm3_expenseamount](#index-crm3_expenseamount) |  |  | No |  | Inferred from Usage |
| 213 | [crm3_parentleadid](#index-crm3_parentleadid) |  |  | No |  | Inferred from Usage |
| 214 | [customerid](#index-customerid) |  |  | No |  | Inferred from Usage |
| 215 | [datefulfilled](#index-datefulfilled) |  |  | No |  | Inferred from Usage |
| 216 | [defaultuomid](#index-defaultuomid) |  |  | No |  | Inferred from Usage |
| 217 | [description](#index-description) |  |  | No |  | Inferred from Usage |
| 218 | [discountamount](#index-discountamount) |  |  | No |  | Inferred from Usage |
| 219 | [discountpercentage](#index-discountpercentage) |  |  | No |  | Inferred from Usage |
| 220 | [emailaddress1](#index-emailaddress1) |  |  | No |  | Inferred from Usage |
| 221 | [estimatedclosedate](#index-estimatedclosedate) |  |  | No |  | Inferred from Usage |
| 222 | [estimatedvalue](#index-estimatedvalue) |  |  | No |  | Inferred from Usage |
| 223 | [exchangerate](#index-exchangerate) | Exchange Rate | decimal | No | none | Solution Export |
| 224 | [ext_amt](#index-ext_amt) |  |  | No |  | Inferred from Usage |
| 225 | [extendedamount](#index-extendedamount) |  |  | No |  | Inferred from Usage |
| 226 | [fetchxml](#index-fetchxml) |  |  | No |  | Inferred from Usage |
| 227 | [filename](#index-filename) |  |  | No |  | Inferred from Usage |
| 228 | [firstname](#index-firstname) |  |  | No |  | Inferred from Usage |
| 229 | [freightamount](#index-freightamount) |  |  | No |  | Inferred from Usage |
| 230 | [freighttermscode](#index-freighttermscode) |  |  | No |  | Inferred from Usage |
| 231 | [from](#index-from) |  |  | No |  | Inferred from Usage |
| 232 | [fullname](#index-fullname) |  |  | No |  | Inferred from Usage |
| 233 | [goalenddate](#index-goalenddate) |  |  | No |  | Inferred from Usage |
| 234 | [goalid](#index-goalid) |  |  | No |  | Inferred from Usage |
| 235 | [goalownerid](#index-goalownerid) |  |  | No |  | Inferred from Usage |
| 236 | [goalrollupqueryid](#index-goalrollupqueryid) |  |  | No |  | Inferred from Usage |
| 237 | [goalstartdate](#index-goalstartdate) |  |  | No |  | Inferred from Usage |
| 238 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int | No | none | Solution Export |
| 239 | [incidentid](#index-incidentid) |  |  | No |  | Inferred from Usage |
| 240 | [internalemailaddress](#index-internalemailaddress) |  |  | No |  | Inferred from Usage |
| 241 | [invline.productid](#index-invlineproductid) |  |  | No |  | Inferred from Usage |
| 242 | [invoicedetailid](#index-invoicedetailid) |  |  | No |  | Inferred from Usage |
| 243 | [invoiceid](#index-invoiceid) |  |  | No |  | Inferred from Usage |
| 244 | [invoicenumber](#index-invoicenumber) |  |  | No |  | Inferred from Usage |
| 245 | [isamount](#index-isamount) |  |  | No |  | Inferred from Usage |
| 246 | [isfiscalperiodgoal](#index-isfiscalperiodgoal) |  |  | No |  | Inferred from Usage |
| 247 | [isocurrencycode](#index-isocurrencycode) |  |  | No |  | Inferred from Usage |
| 248 | [ispriceoverridden](#index-ispriceoverridden) |  |  | No |  | Inferred from Usage |
| 249 | [isproductoverridden](#index-isproductoverridden) |  |  | No |  | Inferred from Usage |
| 250 | [isrevenuesystemcalculated](#index-isrevenuesystemcalculated) |  |  | No |  | Inferred from Usage |
| 251 | [jobtitle](#index-jobtitle) |  |  | No |  | Inferred from Usage |
| 252 | [lastname](#index-lastname) |  |  | No |  | Inferred from Usage |
| 253 | [manualdiscountamount](#index-manualdiscountamount) |  |  | No |  | Inferred from Usage |
| 254 | [metricid](#index-metricid) |  |  | No |  | Inferred from Usage |
| 255 | [mimetype](#index-mimetype) |  |  | No |  | Inferred from Usage |
| 256 | [mobilephone](#index-mobilephone) |  |  | No |  | Inferred from Usage |
| 257 | [modifiedby](#index-modifiedby) | Modified By | lookup | No | none | Solution Export |
| 258 | [modifiedon](#index-modifiedon) | Modified On | datetime | No | none | Solution Export |
| 259 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup | No | none | Solution Export |
| 260 | [name](#index-name) |  |  | No |  | Inferred from Usage |
| 261 | [objectid](#index-objectid) |  |  | No |  | Inferred from Usage |
| 262 | [objecttypecode](#index-objecttypecode) |  |  | No |  | Inferred from Usage |
| 263 | [opportunityid](#index-opportunityid) |  |  | No |  | Inferred from Usage |
| 264 | [opportunityproductid](#index-opportunityproductid) |  |  | No |  | Inferred from Usage |
| 265 | [originatingleadid](#index-originatingleadid) |  |  | No |  | Inferred from Usage |
| 266 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime | No | none | Solution Export |
| 267 | [ownerid](#index-ownerid) | Sales Rep | owner | No | systemrequired | Solution Export |
| 268 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup | No | none | Solution Export |
| 269 | [owningteam](#index-owningteam) | Owning Team | lookup | No | none | Solution Export |
| 270 | [owninguser](#index-owninguser) | Owning User | lookup | No | none | Solution Export |
...
| 302 | [rolluprulestep1_1](#index-rolluprulestep1_1) |  |  | No |  | Inferred from Usage |
| 303 | [rolluprulestep1_2](#index-rolluprulestep1_2) |  |  | No |  | Inferred from Usage |
| 304 | [rolluprulestep1_3](#index-rolluprulestep1_3) |  |  | No |  | Inferred from Usage |
| 305 | [rolluprulestep1_4](#index-rolluprulestep1_4) |  |  | No |  | Inferred from Usage |
| 306 | [rolluprulestep1_5](#index-rolluprulestep1_5) |  |  | No |  | Inferred from Usage |
| 307 | [rolluprulestep1_6](#index-rolluprulestep1_6) |  |  | No |  | Inferred from Usage |
| 308 | [rolluprulestep1_7](#index-rolluprulestep1_7) |  |  | No |  | Inferred from Usage |
...
| 314 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 315 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 316 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 317 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 318 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 319 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 320 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 321 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 322 | [statecode](#index-statecode) | Status | state | No | systemrequired | Solution Export |
| 323 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 324 | [statuscode](#index-statuscode) | Status Reason | status | No | none | Solution Export |
| 325 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 326 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 327 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 328 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 329 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 330 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 331 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 332 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int | No | none | Solution Export |
| 333 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 334 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 335 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 336 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 337 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup | No | none | Solution Export |
| 338 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 339 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int | No | none | Solution Export |
| 340 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 341 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 342 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
