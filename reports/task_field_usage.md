...
| 77 | [azt_historicalowner](#index-azt_historicalowner) | Historical Owner | nvarchar | Yes | none | Solution Export |
| 78 | [azt_importname](#index-azt_importname) |  |  | Yes |  | Inferred from Usage |
| 79 | [azt_invoiceid](#index-azt_invoiceid) |  |  | Yes |  | Inferred from Usage |
| 80 | [azt_invoiceproductid](#index-azt_invoiceproductid) |  |  | Yes |  | Inferred from Usage |
| 81 | [azt_isbn](#index-azt_isbn) |  |  | Yes |  | Inferred from Usage |
| 82 | [azt_iscompanion](#index-azt_iscompanion) |  |  | Yes |  | Inferred from Usage |
| 83 | [azt_isprint](#index-azt_isprint) |  |  | Yes |  | Inferred from Usage |
| 84 | [azt_issaas](#index-azt_issaas) |  |  | Yes |  | Inferred from Usage |
| 85 | [azt_jobrole](#index-azt_jobrole) |  |  | Yes |  | Inferred from Usage |
| 86 | [azt_jobtitle](#index-azt_jobtitle) |  |  | Yes |  | Inferred from Usage |
| 87 | [azt_lastactivitydate](#index-azt_lastactivitydate) |  |  | Yes |  | Inferred from Usage |
| 88 | [azt_lastmodifiedbyid](#index-azt_lastmodifiedbyid) |  |  | Yes |  | Inferred from Usage |
| 89 | [azt_lastname](#index-azt_lastname) |  |  | Yes |  | Inferred from Usage |
| 90 | [azt_leadimportid](#index-azt_leadimportid) |  |  | Yes |  | Inferred from Usage |
| 91 | [azt_leadsourceid](#index-azt_leadsourceid) |  |  | Yes |  | Inferred from Usage |
| 92 | [azt_licensestatus](#index-azt_licensestatus) |  |  | Yes |  | Inferred from Usage |
| 93 | [azt_licenseterm](#index-azt_licenseterm) |  |  | Yes |  | Inferred from Usage |
| 94 | [azt_licensetermmonths](#index-azt_licensetermmonths) |  |  | Yes |  | Inferred from Usage |
| 95 | [azt_licensetype](#index-azt_licensetype) |  |  | Yes |  | Inferred from Usage |
| 96 | [azt_masecommission](#index-azt_masecommission) |  |  | Yes |  | Inferred from Usage |
| 97 | [azt_mileage](#index-azt_mileage) |  |  | Yes |  | Inferred from Usage |
| 98 | [azt_monthstofilteron](#index-azt_monthstofilteron) |  |  | Yes |  | Inferred from Usage |
| 99 | [azt_name](#index-azt_name) |  |  | Yes |  | Inferred from Usage |
| 100 | [azt_newestclosedate](#index-azt_newestclosedate) |  |  | Yes |  | Inferred from Usage |
| 101 | [azt_newestimatedvalue](#index-azt_newestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 102 | [azt_newownerid](#index-azt_newownerid) |  |  | Yes |  | Inferred from Usage |
| 103 | [azt_newprobability](#index-azt_newprobability) |  |  | Yes |  | Inferred from Usage |
| 104 | [azt_nonsaasstatus](#index-azt_nonsaasstatus) |  |  | Yes |  | Inferred from Usage |
| 105 | [azt_nonsaastype](#index-azt_nonsaastype) |  |  | Yes |  | Inferred from Usage |
| 106 | [azt_numberoflicenses](#index-azt_numberoflicenses) |  |  | Yes |  | Inferred from Usage |
| 107 | [azt_opportunityauditrecordid](#index-azt_opportunityauditrecordid) |  |  | Yes |  | Inferred from Usage |
| 108 | [azt_opportunityid](#index-azt_opportunityid) |  |  | Yes |  | Inferred from Usage |
| 109 | [azt_opportunityproductid](#index-azt_opportunityproductid) |  |  | Yes |  | Inferred from Usage |
| 110 | [azt_orderid](#index-azt_orderid) |  |  | Yes |  | Inferred from Usage |
| 111 | [azt_orderlineid](#index-azt_orderlineid) |  |  | Yes |  | Inferred from Usage |
| 112 | [azt_orderproductid](#index-azt_orderproductid) |  |  | Yes |  | Inferred from Usage |
| 113 | [azt_orderstageid](#index-azt_orderstageid) |  |  | Yes |  | Inferred from Usage |
| 114 | [azt_ordertemplatelines](#index-azt_ordertemplatelines) |  |  | Yes |  | Inferred from Usage |
| 115 | [azt_ordertype](#index-azt_ordertype) |  |  | Yes |  | Inferred from Usage |
| 116 | [azt_originatingleadimportid](#index-azt_originatingleadimportid) |  |  | Yes |  | Inferred from Usage |
| 117 | [azt_paid](#index-azt_paid) |  |  | Yes |  | Inferred from Usage |
| 118 | [azt_paidon](#index-azt_paidon) |  |  | Yes |  | Inferred from Usage |
| 119 | [azt_parentopportunityid](#index-azt_parentopportunityid) |  |  | Yes |  | Inferred from Usage |
| 120 | [azt_parentorderid](#index-azt_parentorderid) |  |  | Yes |  | Inferred from Usage |
| 121 | [azt_payablecommission](#index-azt_payablecommission) |  |  | Yes |  | Inferred from Usage |
| 122 | [azt_paymentdate](#index-azt_paymentdate) |  |  | Yes |  | Inferred from Usage |
| 123 | [azt_paymentid](#index-azt_paymentid) |  |  | Yes |  | Inferred from Usage |
| 124 | [azt_percentage](#index-azt_percentage) |  |  | Yes |  | Inferred from Usage |
| 125 | [azt_percentagepaid](#index-azt_percentagepaid) |  |  | Yes |  | Inferred from Usage |
| 126 | [azt_periodend](#index-azt_periodend) |  |  | Yes |  | Inferred from Usage |
| 127 | [azt_periodstart](#index-azt_periodstart) |  |  | Yes |  | Inferred from Usage |
| 128 | [azt_phone](#index-azt_phone) |  |  | Yes |  | Inferred from Usage |
| 129 | [azt_ponumber](#index-azt_ponumber) |  |  | Yes |  | Inferred from Usage |
| 130 | [azt_prefix](#index-azt_prefix) |  |  | Yes |  | Inferred from Usage |
| 131 | [azt_prefixhasseparator](#index-azt_prefixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 132 | [azt_prefixseparator](#index-azt_prefixseparator) |  |  | Yes |  | Inferred from Usage |
| 133 | [azt_prefixseparatorisspace](#index-azt_prefixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 134 | [azt_previousestclosedate](#index-azt_previousestclosedate) |  |  | Yes |  | Inferred from Usage |
| 135 | [azt_previousestimatedvalue](#index-azt_previousestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 136 | [azt_previousownerid](#index-azt_previousownerid) |  |  | Yes |  | Inferred from Usage |
| 137 | [azt_previousprobability](#index-azt_previousprobability) |  |  | Yes |  | Inferred from Usage |
| 138 | [azt_printproductid](#index-azt_printproductid) |  |  | Yes |  | Inferred from Usage |
| 139 | [azt_printpurchaseid](#index-azt_printpurchaseid) |  |  | Yes |  | Inferred from Usage |
| 140 | [azt_probability](#index-azt_probability) |  |  | Yes |  | Inferred from Usage |
| 141 | [azt_probabilitychangedon](#index-azt_probabilitychangedon) |  |  | Yes |  | Inferred from Usage |
| 142 | [azt_probabilityincreased](#index-azt_probabilityincreased) |  |  | Yes |  | Inferred from Usage |
| 143 | [azt_productdiscountid](#index-azt_productdiscountid) |  |  | Yes |  | Inferred from Usage |
| 144 | [azt_producttype](#index-azt_producttype) |  |  | Yes |  | Inferred from Usage |
| 145 | [azt_purchasedate](#index-azt_purchasedate) |  |  | Yes |  | Inferred from Usage |
| 146 | [azt_quantity](#index-azt_quantity) |  |  | Yes |  | Inferred from Usage |
| 147 | [azt_quotenumber](#index-azt_quotenumber) |  |  | Yes |  | Inferred from Usage |
| 148 | [azt_quoteproductid](#index-azt_quoteproductid) |  |  | Yes |  | Inferred from Usage |
| 149 | [azt_reasonforexpense](#index-azt_reasonforexpense) |  |  | Yes |  | Inferred from Usage |
| 150 | [azt_recordowner](#index-azt_recordowner) |  |  | Yes |  | Inferred from Usage |
| 151 | [azt_recordownerid](#index-azt_recordownerid) | Record Owner | lookup | Yes | none | Solution Export |
| 152 | [azt_reorderopportunityid](#index-azt_reorderopportunityid) | Reorder Opportunity | lookup | Yes | none | Solution Export |
...
| 160 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) |  |  | Yes |  | Inferred from Usage |
| 161 | [azt_softwareproductid](#index-azt_softwareproductid) |  |  | Yes |  | Inferred from Usage |
| 162 | [azt_startdate](#index-azt_startdate) |  |  | Yes |  | Inferred from Usage |
| 163 | [azt_stateabbreviation](#index-azt_stateabbreviation) |  |  | Yes |  | Inferred from Usage |
| 164 | [azt_stateprovince](#index-azt_stateprovince) |  |  | Yes |  | Inferred from Usage |
| 165 | [azt_suffix](#index-azt_suffix) |  |  | Yes |  | Inferred from Usage |
| 166 | [azt_suffixhasseparator](#index-azt_suffixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 167 | [azt_suffixseparator](#index-azt_suffixseparator) |  |  | Yes |  | Inferred from Usage |
| 168 | [azt_suffixseparatorisspace](#index-azt_suffixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 169 | [azt_supportexpirationdate](#index-azt_supportexpirationdate) |  |  | Yes |  | Inferred from Usage |
| 170 | [azt_tasktype](#index-azt_tasktype) | Task Type | picklist | Yes | none | Solution Export |
| 171 | [azt_total](#index-azt_total) |  |  | Yes |  | Inferred from Usage |
| 172 | [azt_totalamountpaid](#index-azt_totalamountpaid) |  |  | Yes |  | Inferred from Usage |
| 173 | [azt_totalfunding](#index-azt_totalfunding) |  |  | Yes |  | Inferred from Usage |
| 174 | [azt_totalreimbursement](#index-azt_totalreimbursement) |  |  | Yes |  | Inferred from Usage |
| 175 | [azt_trackingnumber](#index-azt_trackingnumber) |  |  | Yes |  | Inferred from Usage |
| 176 | [azt_trackingnumbers](#index-azt_trackingnumbers) |  |  | Yes |  | Inferred from Usage |
| 177 | [azt_trainingid](#index-azt_trainingid) |  |  | Yes |  | Inferred from Usage |
| 178 | [azt_year](#index-azt_year) |  |  | Yes |  | Inferred from Usage |
| 179 | [baseamount](#index-baseamount) |  |  | No |  | Inferred from Usage |
| 180 | [billto_line1](#index-billto_line1) |  |  | No |  | Inferred from Usage |
| 181 | [billto_line2](#index-billto_line2) |  |  | No |  | Inferred from Usage |
| 182 | [billto_line3](#index-billto_line3) |  |  | No |  | Inferred from Usage |
| 183 | [billto_name](#index-billto_name) |  |  | No |  | Inferred from Usage |
| 184 | [billto_postalcode](#index-billto_postalcode) |  |  | No |  | Inferred from Usage |
| 185 | [billto_stateorprovince](#index-billto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 186 | [body](#index-body) |  |  | No |  | Inferred from Usage |
| 187 | [bpf_duration](#index-bpf_duration) |  |  | No |  | Inferred from Usage |
| 188 | [bpf_salesorderid](#index-bpf_salesorderid) |  |  | No |  | Inferred from Usage |
| 189 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) |  |  | No |  | Inferred from Usage |
| 190 | [businessunitid](#index-businessunitid) |  |  | No |  | Inferred from Usage |
| 191 | [category](#index-category) |  |  | No |  | Inferred from Usage |
| 192 | [city](#index-city) |  |  | No |  | Inferred from Usage |
| 193 | [closeprobability](#index-closeprobability) |  |  | No |  | Inferred from Usage |
| 194 | [companyname](#index-companyname) |  |  | No |  | Inferred from Usage |
| 195 | [connectionid](#index-connectionid) |  |  | No |  | Inferred from Usage |
| 196 | [connectionroleid](#index-connectionroleid) |  |  | No |  | Inferred from Usage |
| 197 | [consideronlygoalownersrecords](#index-consideronlygoalownersrecords) |  |  | No |  | Inferred from Usage |
| 198 | [contactid](#index-contactid) |  |  | No |  | Inferred from Usage |
| 199 | [country](#index-country) |  |  | No |  | Inferred from Usage |
| 200 | [county](#index-county) |  |  | No |  | Inferred from Usage |
| 201 | [createdby](#index-createdby) |  |  | No |  | Inferred from Usage |
| 202 | [createdon](#index-createdon) |  |  | No |  | Inferred from Usage |
| 203 | [crm3_expenseamount](#index-crm3_expenseamount) |  |  | No |  | Inferred from Usage |
| 204 | [crm3_parentleadid](#index-crm3_parentleadid) |  |  | No |  | Inferred from Usage |
| 205 | [customerid](#index-customerid) |  |  | No |  | Inferred from Usage |
| 206 | [datefulfilled](#index-datefulfilled) |  |  | No |  | Inferred from Usage |
| 207 | [defaultuomid](#index-defaultuomid) |  |  | No |  | Inferred from Usage |
| 208 | [description](#index-description) |  |  | No |  | Inferred from Usage |
| 209 | [discountamount](#index-discountamount) |  |  | No |  | Inferred from Usage |
| 210 | [discountpercentage](#index-discountpercentage) |  |  | No |  | Inferred from Usage |
| 211 | [emailaddress1](#index-emailaddress1) |  |  | No |  | Inferred from Usage |
| 212 | [estimatedclosedate](#index-estimatedclosedate) |  |  | No |  | Inferred from Usage |
| 213 | [estimatedvalue](#index-estimatedvalue) |  |  | No |  | Inferred from Usage |
| 214 | [ext_amt](#index-ext_amt) |  |  | No |  | Inferred from Usage |
| 215 | [extendedamount](#index-extendedamount) |  |  | No |  | Inferred from Usage |
| 216 | [fetchxml](#index-fetchxml) |  |  | No |  | Inferred from Usage |
| 217 | [filename](#index-filename) |  |  | No |  | Inferred from Usage |
| 218 | [firstname](#index-firstname) |  |  | No |  | Inferred from Usage |
| 219 | [freightamount](#index-freightamount) |  |  | No |  | Inferred from Usage |
| 220 | [freighttermscode](#index-freighttermscode) |  |  | No |  | Inferred from Usage |
| 221 | [from](#index-from) |  |  | No |  | Inferred from Usage |
| 222 | [fullname](#index-fullname) |  |  | No |  | Inferred from Usage |
| 223 | [goalenddate](#index-goalenddate) |  |  | No |  | Inferred from Usage |
| 224 | [goalid](#index-goalid) |  |  | No |  | Inferred from Usage |
| 225 | [goalownerid](#index-goalownerid) |  |  | No |  | Inferred from Usage |
| 226 | [goalrollupqueryid](#index-goalrollupqueryid) |  |  | No |  | Inferred from Usage |
| 227 | [goalstartdate](#index-goalstartdate) |  |  | No |  | Inferred from Usage |
| 228 | [incidentid](#index-incidentid) |  |  | No |  | Inferred from Usage |
| 229 | [internalemailaddress](#index-internalemailaddress) |  |  | No |  | Inferred from Usage |
| 230 | [invline.productid](#index-invlineproductid) |  |  | No |  | Inferred from Usage |
| 231 | [invoicedetailid](#index-invoicedetailid) |  |  | No |  | Inferred from Usage |
| 232 | [invoiceid](#index-invoiceid) |  |  | No |  | Inferred from Usage |
| 233 | [invoicenumber](#index-invoicenumber) |  |  | No |  | Inferred from Usage |
| 234 | [isamount](#index-isamount) |  |  | No |  | Inferred from Usage |
| 235 | [isfiscalperiodgoal](#index-isfiscalperiodgoal) |  |  | No |  | Inferred from Usage |
| 236 | [isocurrencycode](#index-isocurrencycode) |  |  | No |  | Inferred from Usage |
| 237 | [ispriceoverridden](#index-ispriceoverridden) |  |  | No |  | Inferred from Usage |
| 238 | [isproductoverridden](#index-isproductoverridden) |  |  | No |  | Inferred from Usage |
| 239 | [isrevenuesystemcalculated](#index-isrevenuesystemcalculated) |  |  | No |  | Inferred from Usage |
| 240 | [jobtitle](#index-jobtitle) |  |  | No |  | Inferred from Usage |
| 241 | [lastname](#index-lastname) |  |  | No |  | Inferred from Usage |
| 242 | [manualdiscountamount](#index-manualdiscountamount) |  |  | No |  | Inferred from Usage |
| 243 | [metricid](#index-metricid) |  |  | No |  | Inferred from Usage |
| 244 | [mimetype](#index-mimetype) |  |  | No |  | Inferred from Usage |
| 245 | [mobilephone](#index-mobilephone) |  |  | No |  | Inferred from Usage |
| 246 | [modifiedon](#index-modifiedon) |  |  | No |  | Inferred from Usage |
| 247 | [name](#index-name) |  |  | No |  | Inferred from Usage |
| 248 | [objectid](#index-objectid) |  |  | No |  | Inferred from Usage |
| 249 | [objecttypecode](#index-objecttypecode) |  |  | No |  | Inferred from Usage |
| 250 | [opportunityid](#index-opportunityid) |  |  | No |  | Inferred from Usage |
| 251 | [opportunityproductid](#index-opportunityproductid) |  |  | No |  | Inferred from Usage |
| 252 | [originatingleadid](#index-originatingleadid) |  |  | No |  | Inferred from Usage |
| 253 | [ownerid](#index-ownerid) |  |  | No |  | Inferred from Usage |
| 254 | [parentaccountid](#index-parentaccountid) |  |  | No |  | Inferred from Usage |
| 255 | [parentcontactid](#index-parentcontactid) |  |  | No |  | Inferred from Usage |
| 256 | [parentcustomerid](#index-parentcustomerid) |  |  | No |  | Inferred from Usage |
| 257 | [parentgoalid](#index-parentgoalid) |  |  | No |  | Inferred from Usage |
| 258 | [parentsystemuserid](#index-parentsystemuserid) |  |  | No |  | Inferred from Usage |
| 259 | [partyid](#index-partyid) |  |  | No |  | Inferred from Usage |
| 260 | [phonenumber](#index-phonenumber) |  |  | No |  | Inferred from Usage |
| 261 | [pricelevelid](#index-pricelevelid) |  |  | No |  | Inferred from Usage |
| 262 | [priceperunit](#index-priceperunit) |  |  | No |  | Inferred from Usage |
| 263 | [primarycontactid](#index-primarycontactid) |  |  | No |  | Inferred from Usage |
| 264 | [prioritycode](#index-prioritycode) |  |  | No |  | Inferred from Usage |
| 265 | [prod.productid](#index-prodproductid) |  |  | No |  | Inferred from Usage |
| 266 | [productdescription](#index-productdescription) |  |  | No |  | Inferred from Usage |
| 267 | [productid](#index-productid) |  |  | No |  | Inferred from Usage |
| 268 | [productname](#index-productname) |  |  | No |  | Inferred from Usage |
| 269 | [productnumber](#index-productnumber) |  |  | No |  | Inferred from Usage |
| 270 | [producttypecode](#index-producttypecode) |  |  | No |  | Inferred from Usage |
| 271 | [quantity](#index-quantity) |  |  | No |  | Inferred from Usage |
| 272 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 273 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 274 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 275 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 276 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
| 277 | [record1id](#index-record1id) |  |  | No |  | Inferred from Usage |
| 278 | [record1roleid](#index-record1roleid) |  |  | No |  | Inferred from Usage |
| 279 | [record2id](#index-record2id) |  |  | No |  | Inferred from Usage |
| 280 | [record2roleid](#index-record2roleid) |  |  | No |  | Inferred from Usage |
| 281 | [regardingobjectid](#index-regardingobjectid) | Regarding | lookup | No | none | Solution Export |
| 282 | [requestdeliveryby](#index-requestdeliveryby) |  |  | No |  | Inferred from Usage |
| 283 | [roleid](#index-roleid) |  |  | No |  | Inferred from Usage |
| 284 | [rolluponlyfromchildgoals](#index-rolluponlyfromchildgoals) |  |  | No |  | Inferred from Usage |
| 285 | [rollupqueryactualmoneyid](#index-rollupqueryactualmoneyid) |  |  | No |  | Inferred from Usage |
| 286 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 287 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 288 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 289 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 290 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 291 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 292 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 293 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 294 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 295 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 296 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 297 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 298 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 299 | [statecode](#index-statecode) |  |  | No |  | Inferred from Usage |
| 300 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 301 | [statuscode](#index-statuscode) |  |  | No |  | Inferred from Usage |
| 302 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 303 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 304 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 305 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 306 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 307 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 308 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 309 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 310 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 311 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 312 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 313 | [transactioncurrencyid](#index-transactioncurrencyid) |  |  | No |  | Inferred from Usage |
| 314 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 315 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 316 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 317 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
