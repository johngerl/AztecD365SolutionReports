...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_accountleadgenerationid](#index-azt_accountleadgenerationid) | Account Lead Generation | primarykey |  | No | systemrequired | true |  |  |  |  |  |  |  | [7](#3-views) |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 2 | [azt_evaluate](#index-azt_evaluate) | Evaluate? | bit | 1: Yes, 0: No | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [azt_monthstofilteron](#index-azt_monthstofilteron) | Months to Filter On | int |  | Yes | required | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [azt_name](#index-azt_name) | Name | nvarchar |  | Yes | required | true |  |  |  |  |  |  | [3](#2-forms) | [11](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 6 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [7](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 8 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 9 | [modifiedby](#index-modifiedby) | Modified By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 10 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 11 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 12 | [organizationid](#index-organizationid) | Organization Id | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 13 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 14 | [statecode](#index-statecode) | Status | state |  | No | systemrequired | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [statuscode](#index-statuscode) | Status Reason | status |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 16 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 17 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
