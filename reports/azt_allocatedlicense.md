...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_allocatedlicenseid](#index-azt_allocatedlicenseid) | Allocated License | primarykey |  | No | systemrequired | true |  |  |  |  |  |  |  | [10](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_allocatedtoid](#index-azt_allocatedtoid) | Allocated To | lookup |  | Yes | required | true |  |  |  |  |  |  | [2](#2-forms) | [4](#3-views) |  |  |  | [1](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 3 | [azt_allocationtype](#index-azt_allocationtype) | Allocation Type | picklist | 327630000: Software, 327630001: Print | Yes | required | true |  |  |  |  |  |  | [2](#2-forms) | [3](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [azt_companionid](#index-azt_companionid) | Companion | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 5 | [azt_customerid](#index-azt_customerid) | Purchasing Customer | lookup |  | Yes | recommended | true |  |  |  |  |  |  | [2](#2-forms) | [10](#3-views) |  |  |  | [1](#7-workflows) |  | [5](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 6 | [azt_expirationdate](#index-azt_expirationdate) | End Date | datetime |  | Yes | recommended | true |  |  |  |  |  |  | [1](#2-forms) | [12](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [azt_isbn](#index-azt_isbn) | ISBN | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [azt_licensestatus](#index-azt_licensestatus) | License Status | picklist |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [8](#3-views) |  |  |  | [2](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [azt_licensetermmonths](#index-azt_licensetermmonths) | License Term (Months) | int |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [1](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [azt_licensetype](#index-azt_licensetype) | License Type | picklist |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [1](#7-workflows) |  | [25](#10-plugin-source-code-analysis) |  |  |  |  |
| 11 | [azt_name](#index-azt_name) | Name | nvarchar |  | Yes | required | true |  |  |  |  |  |  | [3](#2-forms) | [16](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 12 | [azt_numberoflicenses](#index-azt_numberoflicenses) | # Licenses | int |  | Yes | recommended | true |  |  |  |  |  |  | [2](#2-forms) | [9](#3-views) |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [azt_printpurchaseid](#index-azt_printpurchaseid) | Print Purchase | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 14 | [azt_recordownerid](#index-azt_recordownerid) | Record Owner | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [37](#7-workflows) |  | [9](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 15 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) | Software License | lookup |  | Yes | required | true |  |  |  |  |  |  | [1](#2-forms) | [9](#3-views) |  |  |  | [2](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 16 | [azt_softwareproductid](#index-azt_softwareproductid) | Software Product | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [11](#3-views) |  |  |  | [1](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 17 | [azt_softwareversionnumber](#index-azt_softwareversionnumber) | Version # | picklist |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [5](#3-views) |  |  |  | [1](#7-workflows) |  |  |  |  |  |  |
| 18 | [azt_softwareversiontype](#index-azt_softwareversiontype) | Version Type | picklist |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [4](#3-views) |  |  |  | [1](#7-workflows) |  |  |  |  |  |  |
| 19 | [azt_startdate](#index-azt_startdate) | Start Date | datetime |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [7](#3-views) |  |  |  | [2](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 20 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 21 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 22 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 23 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 24 | [modifiedby](#index-modifiedby) | Modified By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 25 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 26 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 27 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 28 | [ownerid](#index-ownerid) | Owner | owner |  | No | systemrequired | true |  |  |  |  |  |  | [3](#2-forms) | [1](#3-views) |  |  |  | [24](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 29 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 30 | [owningteam](#index-owningteam) | Owning Team | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 31 | [owninguser](#index-owninguser) | Owning User | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 32 | [statecode](#index-statecode) | Status | state |  | No | systemrequired | true |  |  |  |  |  |  |  | [8](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 33 | [statuscode](#index-statuscode) | Status Reason | status |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 34 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 35 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
