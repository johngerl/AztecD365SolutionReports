#!/usr/bin/env python3
"""
generate_d365_entity_csv_mapping_step_02.py
...
Usage:
    python generate_d365_entity_csv_mapping_step_02.py account   # single entity
    python generate_d365_entity_csv_mapping_step_02.py --all     # all source JSONs
"""
