...
|---|-------------|-------------|------|-----------------|--------|----------|-------------|-------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_clonedexpenselineid](#azt_clonedexpenselineid) | Cloned Expense Line | primarykey |  | No | systemrequired | Never | C R F Re | false |  |  |  |  |  |  |  | [7](#3.%20Views) |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_name](#azt_name) | Cloned Expense Line ID | nvarchar |  | Yes | required | Never | C R U S Re | false |  |  |  |  |  |  | [3](#2.%20Forms) | [12](#3.%20Views) |  |  |  | [9](#7.%20Workflows) |  | [18](#10.%20Plugin%20Source%20Code%20Analysis) |  |  |  |  |
| 3 | [createdby](#createdby) | Created By | lookup |  | No | none | Never | R | false |  |  |  |  |  |  |  |  |  |  |  | [25](#7.%20Workflows) |  |  |  | [1](#12.%20Relationships) |  |  |
...
| 7 | [modifiedby](#modifiedby) | Modified By | lookup |  | No | none | Never | R | false |  |  |  |  |  |  |  |  |  |  |  | [2](#7.%20Workflows) |  |  |  | [1](#12.%20Relationships) |  |  |
...
| 9 | [modifiedonbehalfby](#modifiedonbehalfby) | Modified By (Delegate) | lookup |  | No | none | Never | R | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 10 | [organizationid](#organizationid) | Organization Id | lookup |  | No | none | Never | R | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12.%20Relationships) |  |  |
| 11 | [overriddencreatedon](#overriddencreatedon) | Record Created On | datetime |  | No | none | Never | C R | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 12 | [statecode](#statecode) | Status | state |  | No | systemrequired | Never | R U F | false |  |  |  |  |  |  |  | [6](#3.%20Views) |  |  |  | [10](#7.%20Workflows) |  | [20](#10.%20Plugin%20Source%20Code%20Analysis) |  |  |  |  |
| 13 | [statuscode](#statuscode) | Status Reason | status |  | No | none | Never | C R U | false |  |  |  |  |  |  | [1](#2.%20Forms) |  |  |  |  | [5](#7.%20Workflows) |  | [6](#10.%20Plugin%20Source%20Code%20Analysis) |  |  |  |  |
| 14 | [timezoneruleversionnumber](#timezoneruleversionnumber) | Time Zone Rule Version Number | int |  | No | none | Never | C R U | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 15 | [utcconversiontimezonecode](#utcconversiontimezonecode) | UTC Conversion Time Zone Code | int |  | No | none | Never | C R U | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
