...
| 15 | [azt_addressline1](#index-azt_addressline1) | Address Line 1 | nvarchar | Yes | none | Solution Export |
...
| 32 | [azt_city](#index-azt_city) | City | nvarchar | Yes | none | Solution Export |
...
| 44 | [azt_country](#index-azt_country) | Country | nvarchar | Yes | none | Solution Export |
...
| 56 | [azt_emailaddress1](#index-azt_emailaddress1) | Email Address 1 | nvarchar | Yes | none | Solution Export |
| 57 | [azt_emailaddress2](#index-azt_emailaddress2) | Email Address 2 | nvarchar | Yes | none | Solution Export |
...
| 60 | [azt_estfulfillmentdate](#index-azt_estfulfillmentdate) |  |  | Yes |  | Inferred from Usage |
| 61 | [azt_evaluate](#index-azt_evaluate) |  |  | Yes |  | Inferred from Usage |
| 62 | [azt_expenseamount](#index-azt_expenseamount) |  |  | Yes |  | Inferred from Usage |
| 63 | [azt_expenseid](#index-azt_expenseid) |  |  | Yes |  | Inferred from Usage |
| 64 | [azt_expensereportid](#index-azt_expensereportid) |  |  | Yes |  | Inferred from Usage |
| 65 | [azt_expensetype](#index-azt_expensetype) |  |  | Yes |  | Inferred from Usage |
| 66 | [azt_expirationdate](#index-azt_expirationdate) |  |  | Yes |  | Inferred from Usage |
| 67 | [azt_extension](#index-azt_extension) |  |  | Yes |  | Inferred from Usage |
| 68 | [azt_fieldtoautonumber](#index-azt_fieldtoautonumber) |  |  | Yes |  | Inferred from Usage |
| 69 | [azt_firstname](#index-azt_firstname) | First Name | nvarchar | Yes | none | Solution Export |
| 70 | [azt_fiscalperiodend](#index-azt_fiscalperiodend) |  |  | Yes |  | Inferred from Usage |
| 71 | [azt_fiscalperiodstart](#index-azt_fiscalperiodstart) |  |  | Yes |  | Inferred from Usage |
| 72 | [azt_freightamtapproved](#index-azt_freightamtapproved) |  |  | Yes |  | Inferred from Usage |
| 73 | [azt_fsrassignedon](#index-azt_fsrassignedon) |  |  | Yes |  | Inferred from Usage |
| 74 | [azt_fsremail](#index-azt_fsremail) |  |  | Yes |  | Inferred from Usage |
| 75 | [azt_fsrid](#index-azt_fsrid) |  |  | Yes |  | Inferred from Usage |
| 76 | [azt_fsrmobiletelephone](#index-azt_fsrmobiletelephone) |  |  | Yes |  | Inferred from Usage |
| 77 | [azt_fsrtelephone](#index-azt_fsrtelephone) |  |  | Yes |  | Inferred from Usage |
| 78 | [azt_fsrtelephoneextension](#index-azt_fsrtelephoneextension) |  |  | Yes |  | Inferred from Usage |
| 79 | [azt_fundingid](#index-azt_fundingid) |  |  | Yes |  | Inferred from Usage |
| 80 | [azt_fundingyear](#index-azt_fundingyear) |  |  | Yes |  | Inferred from Usage |
| 81 | [azt_goaltype](#index-azt_goaltype) |  |  | Yes |  | Inferred from Usage |
| 82 | [azt_importaccountid](#index-azt_importaccountid) | Import Account | primarykey | No | systemrequired | Solution Export |
...
| 94 | [azt_lastname](#index-azt_lastname) | Last Name | nvarchar | Yes | none | Solution Export |
| 95 | [azt_leadimportid](#index-azt_leadimportid) |  |  | Yes |  | Inferred from Usage |
| 96 | [azt_leadsourceid](#index-azt_leadsourceid) |  |  | Yes |  | Inferred from Usage |
| 97 | [azt_licensestatus](#index-azt_licensestatus) |  |  | Yes |  | Inferred from Usage |
| 98 | [azt_licenseterm](#index-azt_licenseterm) |  |  | Yes |  | Inferred from Usage |
| 99 | [azt_licensetermmonths](#index-azt_licensetermmonths) |  |  | Yes |  | Inferred from Usage |
| 100 | [azt_licensetype](#index-azt_licensetype) |  |  | Yes |  | Inferred from Usage |
| 101 | [azt_masecommission](#index-azt_masecommission) |  |  | Yes |  | Inferred from Usage |
| 102 | [azt_mileage](#index-azt_mileage) |  |  | Yes |  | Inferred from Usage |
| 103 | [azt_monthstofilteron](#index-azt_monthstofilteron) |  |  | Yes |  | Inferred from Usage |
| 104 | [azt_name](#index-azt_name) | Name | nvarchar | Yes | required | Solution Export |
| 105 | [azt_newestclosedate](#index-azt_newestclosedate) |  |  | Yes |  | Inferred from Usage |
| 106 | [azt_newestimatedvalue](#index-azt_newestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 107 | [azt_newownerid](#index-azt_newownerid) |  |  | Yes |  | Inferred from Usage |
| 108 | [azt_newprobability](#index-azt_newprobability) |  |  | Yes |  | Inferred from Usage |
| 109 | [azt_nonsaasstatus](#index-azt_nonsaasstatus) |  |  | Yes |  | Inferred from Usage |
| 110 | [azt_nonsaastype](#index-azt_nonsaastype) |  |  | Yes |  | Inferred from Usage |
| 111 | [azt_numberoflicenses](#index-azt_numberoflicenses) |  |  | Yes |  | Inferred from Usage |
| 112 | [azt_opportunityauditrecordid](#index-azt_opportunityauditrecordid) |  |  | Yes |  | Inferred from Usage |
| 113 | [azt_opportunityid](#index-azt_opportunityid) |  |  | Yes |  | Inferred from Usage |
| 114 | [azt_opportunityproductid](#index-azt_opportunityproductid) |  |  | Yes |  | Inferred from Usage |
| 115 | [azt_orderid](#index-azt_orderid) |  |  | Yes |  | Inferred from Usage |
| 116 | [azt_orderlineid](#index-azt_orderlineid) |  |  | Yes |  | Inferred from Usage |
| 117 | [azt_orderproductid](#index-azt_orderproductid) |  |  | Yes |  | Inferred from Usage |
| 118 | [azt_orderstageid](#index-azt_orderstageid) |  |  | Yes |  | Inferred from Usage |
| 119 | [azt_ordertemplatelines](#index-azt_ordertemplatelines) |  |  | Yes |  | Inferred from Usage |
| 120 | [azt_ordertype](#index-azt_ordertype) |  |  | Yes |  | Inferred from Usage |
| 121 | [azt_originatingleadimportid](#index-azt_originatingleadimportid) |  |  | Yes |  | Inferred from Usage |
| 122 | [azt_paid](#index-azt_paid) |  |  | Yes |  | Inferred from Usage |
| 123 | [azt_paidon](#index-azt_paidon) |  |  | Yes |  | Inferred from Usage |
| 124 | [azt_parentopportunityid](#index-azt_parentopportunityid) |  |  | Yes |  | Inferred from Usage |
| 125 | [azt_parentorderid](#index-azt_parentorderid) |  |  | Yes |  | Inferred from Usage |
| 126 | [azt_payablecommission](#index-azt_payablecommission) |  |  | Yes |  | Inferred from Usage |
| 127 | [azt_paymentdate](#index-azt_paymentdate) |  |  | Yes |  | Inferred from Usage |
| 128 | [azt_paymentid](#index-azt_paymentid) |  |  | Yes |  | Inferred from Usage |
| 129 | [azt_percentage](#index-azt_percentage) |  |  | Yes |  | Inferred from Usage |
| 130 | [azt_percentagepaid](#index-azt_percentagepaid) |  |  | Yes |  | Inferred from Usage |
| 131 | [azt_periodend](#index-azt_periodend) |  |  | Yes |  | Inferred from Usage |
| 132 | [azt_periodstart](#index-azt_periodstart) |  |  | Yes |  | Inferred from Usage |
| 133 | [azt_phone](#index-azt_phone) |  |  | Yes |  | Inferred from Usage |
| 134 | [azt_ponumber](#index-azt_ponumber) |  |  | Yes |  | Inferred from Usage |
| 135 | [azt_prefix](#index-azt_prefix) |  |  | Yes |  | Inferred from Usage |
| 136 | [azt_prefixhasseparator](#index-azt_prefixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 137 | [azt_prefixseparator](#index-azt_prefixseparator) |  |  | Yes |  | Inferred from Usage |
| 138 | [azt_prefixseparatorisspace](#index-azt_prefixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 139 | [azt_previousestclosedate](#index-azt_previousestclosedate) |  |  | Yes |  | Inferred from Usage |
| 140 | [azt_previousestimatedvalue](#index-azt_previousestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 141 | [azt_previousownerid](#index-azt_previousownerid) |  |  | Yes |  | Inferred from Usage |
| 142 | [azt_previousprobability](#index-azt_previousprobability) |  |  | Yes |  | Inferred from Usage |
| 143 | [azt_printproductid](#index-azt_printproductid) |  |  | Yes |  | Inferred from Usage |
| 144 | [azt_printpurchaseid](#index-azt_printpurchaseid) |  |  | Yes |  | Inferred from Usage |
| 145 | [azt_probability](#index-azt_probability) |  |  | Yes |  | Inferred from Usage |
| 146 | [azt_probabilitychangedon](#index-azt_probabilitychangedon) |  |  | Yes |  | Inferred from Usage |
| 147 | [azt_probabilityincreased](#index-azt_probabilityincreased) |  |  | Yes |  | Inferred from Usage |
| 148 | [azt_productdiscountid](#index-azt_productdiscountid) |  |  | Yes |  | Inferred from Usage |
| 149 | [azt_producttype](#index-azt_producttype) |  |  | Yes |  | Inferred from Usage |
| 150 | [azt_purchasedate](#index-azt_purchasedate) |  |  | Yes |  | Inferred from Usage |
| 151 | [azt_quantity](#index-azt_quantity) |  |  | Yes |  | Inferred from Usage |
| 152 | [azt_quotenumber](#index-azt_quotenumber) |  |  | Yes |  | Inferred from Usage |
| 153 | [azt_quoteproductid](#index-azt_quoteproductid) |  |  | Yes |  | Inferred from Usage |
| 154 | [azt_reasonforexpense](#index-azt_reasonforexpense) |  |  | Yes |  | Inferred from Usage |
| 155 | [azt_recordowner](#index-azt_recordowner) |  |  | Yes |  | Inferred from Usage |
| 156 | [azt_recordownerid](#index-azt_recordownerid) |  |  | Yes |  | Inferred from Usage |
| 157 | [azt_replacementproductid](#index-azt_replacementproductid) |  |  | Yes |  | Inferred from Usage |
| 158 | [azt_requestedfreightamt](#index-azt_requestedfreightamt) |  |  | Yes |  | Inferred from Usage |
| 159 | [azt_resolvedbyid](#index-azt_resolvedbyid) |  |  | Yes |  | Inferred from Usage |
| 160 | [azt_result](#index-azt_result) |  |  | Yes |  | Inferred from Usage |
| 161 | [azt_saas](#index-azt_saas) |  |  | Yes |  | Inferred from Usage |
| 162 | [azt_saasstatus](#index-azt_saasstatus) |  |  | Yes |  | Inferred from Usage |
| 163 | [azt_salesrepid](#index-azt_salesrepid) |  |  | Yes |  | Inferred from Usage |
| 164 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) |  |  | Yes |  | Inferred from Usage |
| 165 | [azt_softwareproductid](#index-azt_softwareproductid) |  |  | Yes |  | Inferred from Usage |
| 166 | [azt_startdate](#index-azt_startdate) |  |  | Yes |  | Inferred from Usage |
| 167 | [azt_stateabbreviation](#index-azt_stateabbreviation) |  |  | Yes |  | Inferred from Usage |
| 168 | [azt_stateorprovince](#index-azt_stateorprovince) | State or Province | nvarchar | Yes | none | Solution Export |
| 169 | [azt_stateprovince](#index-azt_stateprovince) |  |  | Yes |  | Inferred from Usage |
| 170 | [azt_suffix](#index-azt_suffix) |  |  | Yes |  | Inferred from Usage |
| 171 | [azt_suffixhasseparator](#index-azt_suffixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 172 | [azt_suffixseparator](#index-azt_suffixseparator) |  |  | Yes |  | Inferred from Usage |
| 173 | [azt_suffixseparatorisspace](#index-azt_suffixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 174 | [azt_supportexpirationdate](#index-azt_supportexpirationdate) |  |  | Yes |  | Inferred from Usage |
| 175 | [azt_telephone](#index-azt_telephone) | Telephone | nvarchar | Yes | none | Solution Export |
| 176 | [azt_total](#index-azt_total) |  |  | Yes |  | Inferred from Usage |
| 177 | [azt_totalamountpaid](#index-azt_totalamountpaid) |  |  | Yes |  | Inferred from Usage |
| 178 | [azt_totalfunding](#index-azt_totalfunding) |  |  | Yes |  | Inferred from Usage |
| 179 | [azt_totalreimbursement](#index-azt_totalreimbursement) |  |  | Yes |  | Inferred from Usage |
| 180 | [azt_trackingnumber](#index-azt_trackingnumber) |  |  | Yes |  | Inferred from Usage |
| 181 | [azt_trackingnumbers](#index-azt_trackingnumbers) |  |  | Yes |  | Inferred from Usage |
| 182 | [azt_trainingid](#index-azt_trainingid) |  |  | Yes |  | Inferred from Usage |
| 183 | [azt_year](#index-azt_year) |  |  | Yes |  | Inferred from Usage |
| 184 | [azt_zip](#index-azt_zip) | Zip | nvarchar | Yes | none | Solution Export |
| 185 | [baseamount](#index-baseamount) |  |  | No |  | Inferred from Usage |
| 186 | [billto_line1](#index-billto_line1) |  |  | No |  | Inferred from Usage |
| 187 | [billto_line2](#index-billto_line2) |  |  | No |  | Inferred from Usage |
| 188 | [billto_line3](#index-billto_line3) |  |  | No |  | Inferred from Usage |
| 189 | [billto_name](#index-billto_name) |  |  | No |  | Inferred from Usage |
| 190 | [billto_postalcode](#index-billto_postalcode) |  |  | No |  | Inferred from Usage |
| 191 | [billto_stateorprovince](#index-billto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 192 | [body](#index-body) |  |  | No |  | Inferred from Usage |
| 193 | [bpf_duration](#index-bpf_duration) |  |  | No |  | Inferred from Usage |
| 194 | [bpf_salesorderid](#index-bpf_salesorderid) |  |  | No |  | Inferred from Usage |
| 195 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) |  |  | No |  | Inferred from Usage |
| 196 | [businessunitid](#index-businessunitid) |  |  | No |  | Inferred from Usage |
| 197 | [category](#index-category) |  |  | No |  | Inferred from Usage |
| 198 | [city](#index-city) |  |  | No |  | Inferred from Usage |
| 199 | [closeprobability](#index-closeprobability) |  |  | No |  | Inferred from Usage |
| 200 | [companyname](#index-companyname) |  |  | No |  | Inferred from Usage |
...
| 276 | [prod.productid](#index-prodproductid) |  |  | No |  | Inferred from Usage |
| 277 | [productdescription](#index-productdescription) |  |  | No |  | Inferred from Usage |
| 278 | [productid](#index-productid) |  |  | No |  | Inferred from Usage |
| 279 | [productname](#index-productname) |  |  | No |  | Inferred from Usage |
| 280 | [productnumber](#index-productnumber) |  |  | No |  | Inferred from Usage |
| 281 | [producttypecode](#index-producttypecode) |  |  | No |  | Inferred from Usage |
| 282 | [quantity](#index-quantity) |  |  | No |  | Inferred from Usage |
| 283 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 284 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 285 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 286 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 287 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
| 288 | [record1id](#index-record1id) |  |  | No |  | Inferred from Usage |
| 289 | [record1roleid](#index-record1roleid) |  |  | No |  | Inferred from Usage |
| 290 | [record2id](#index-record2id) |  |  | No |  | Inferred from Usage |
| 291 | [record2roleid](#index-record2roleid) |  |  | No |  | Inferred from Usage |
| 292 | [regardingobjectid](#index-regardingobjectid) |  |  | No |  | Inferred from Usage |
| 293 | [requestdeliveryby](#index-requestdeliveryby) |  |  | No |  | Inferred from Usage |
| 294 | [roleid](#index-roleid) |  |  | No |  | Inferred from Usage |
| 295 | [rolluponlyfromchildgoals](#index-rolluponlyfromchildgoals) |  |  | No |  | Inferred from Usage |
| 296 | [rollupqueryactualmoneyid](#index-rollupqueryactualmoneyid) |  |  | No |  | Inferred from Usage |
| 297 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 298 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 299 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 300 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 301 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 302 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 303 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 304 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 305 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 306 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 307 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 308 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 309 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 310 | [statecode](#index-statecode) | Status | state | No | systemrequired | Solution Export |
| 311 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 312 | [statuscode](#index-statuscode) | Status Reason | status | No | none | Solution Export |
| 313 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 314 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 315 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 316 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 317 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 318 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 319 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 320 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int | No | none | Solution Export |
| 321 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 322 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 323 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 324 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
