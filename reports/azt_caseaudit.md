...
|---|-------------|-------------|------|-----------------|--------|----------|-------------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_caseauditid](#azt_caseauditid) | Case Audit | primarykey |  | No | systemrequired | Never | true |  |  |  |  |  |  |  | [8](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_caseid](#azt_caseid) | Case | lookup |  | Yes | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 3 | [azt_name](#azt_name) | Name | nvarchar |  | Yes | required | Never | true |  |  |  |  |  |  | [3](#2-forms) | [12](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [azt_newownerid](#azt_newownerid) | New Owner | lookup |  | Yes | none | Never | true |  |  |  |  |  |  | [2](#2-forms) | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 5 | [azt_previousownerid](#azt_previousownerid) | Previous Owner | lookup |  | Yes | none | Never | true |  |  |  |  |  |  | [2](#2-forms) | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 6 | [createdby](#createdby) | Created By | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 7 | [createdon](#createdon) | Created On | datetime |  | No | none | Skipped (createdon) | true |  |  |  |  |  |  | [1](#2-forms) | [6](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 10 | [modifiedby](#modifiedby) | Modified By | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 11 | [modifiedon](#modifiedon) | Audit Date | datetime |  | No | none | Skipped (modifiedon) | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 14 | [ownerid](#ownerid) | Owner | owner |  | No | systemrequired | Never | true |  |  |  |  |  |  | [3](#2-forms) | [1](#3-views) |  |  |  | [24](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 15 | [owningbusinessunit](#owningbusinessunit) | Owning Business Unit | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 16 | [owningteam](#owningteam) | Owning Team | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 17 | [owninguser](#owninguser) | Owning User | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 18 | [statecode](#statecode) | Status | state |  | No | systemrequired | Never | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 19 | [statuscode](#statuscode) | Status Reason | status |  | No | none | Never | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
