...
def adapt_json_fields(json_fields):
    ...
    return [{
        ...
        'count_forms': jf.get('countForms', 0),
        'count_views': jf.get('countViews', 0),
        'count_chart_visualizations': jf.get('countChartVisualizations', 0),
        'count_reports': jf.get('countReports', 0),
        'count_dashboards': jf.get('countDashboards', 0),
        'count_workflows': jf.get('countWorkflows', 0),
        'count_formulas_and_rollups': jf.get('countFormulasAndRollups', 0),
        'count_plugins': jf.get('countPlugins', 0),
        'count_pcf_controls': jf.get('countPCFControls', 0),
        'count_relationships': jf.get('countRelationships', 0),
        'count_ribbon_customizations': jf.get('countRibbonCustomizations', 0),
