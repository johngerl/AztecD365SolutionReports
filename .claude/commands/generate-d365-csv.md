...
This is Step 4 of the pipeline. Preserves confirmed SF mapping columns (sfObjectName, sfFieldDisplayName, sfFieldApiName) from existing CSVs. Clears sfSuggested* columns (regenerated by step 6).
