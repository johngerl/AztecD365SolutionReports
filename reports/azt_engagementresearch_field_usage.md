...
| 54 | [azt_engagementid](#index-azt_engagementid) | Engagement | lookup | Yes | required | Solution Export |
| 55 | [azt_engagementresearchid](#index-azt_engagementresearchid) | Engagement Research | primarykey | No | systemrequired | Solution Export |
...
| 99 | [azt_name](#index-azt_name) | Description | nvarchar | Yes | required | Solution Export |
...
| 154 | [azt_researchsummary](#index-azt_researchsummary) | Research Summary | ntext | Yes | none | Solution Export |
...
| 257 | [ownerid](#index-ownerid) | Owner | owner | No | systemrequired | Solution Export |
| 258 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup | No | none | Solution Export |
| 259 | [owningteam](#index-owningteam) | Owning Team | lookup | No | none | Solution Export |
| 260 | [owninguser](#index-owninguser) | Owning User | lookup | No | none | Solution Export |
| 261 | [parentaccountid](#index-parentaccountid) |  |  | No |  | Inferred from Usage |
| 262 | [parentcontactid](#index-parentcontactid) |  |  | No |  | Inferred from Usage |
| 263 | [parentcustomerid](#index-parentcustomerid) |  |  | No |  | Inferred from Usage |
| 264 | [parentgoalid](#index-parentgoalid) |  |  | No |  | Inferred from Usage |
| 265 | [parentsystemuserid](#index-parentsystemuserid) |  |  | No |  | Inferred from Usage |
| 266 | [partyid](#index-partyid) |  |  | No |  | Inferred from Usage |
| 267 | [phonenumber](#index-phonenumber) |  |  | No |  | Inferred from Usage |
| 268 | [pricelevelid](#index-pricelevelid) |  |  | No |  | Inferred from Usage |
| 269 | [priceperunit](#index-priceperunit) |  |  | No |  | Inferred from Usage |
| 270 | [primarycontactid](#index-primarycontactid) |  |  | No |  | Inferred from Usage |
| 271 | [prod.productid](#index-prodproductid) |  |  | No |  | Inferred from Usage |
| 272 | [productdescription](#index-productdescription) |  |  | No |  | Inferred from Usage |
| 273 | [productid](#index-productid) |  |  | No |  | Inferred from Usage |
| 274 | [productname](#index-productname) |  |  | No |  | Inferred from Usage |
| 275 | [productnumber](#index-productnumber) |  |  | No |  | Inferred from Usage |
| 276 | [producttypecode](#index-producttypecode) |  |  | No |  | Inferred from Usage |
...
| 307 | [statuscode](#index-statuscode) | Status Reason | status | No | none | Solution Export |
...
| 315 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int | No | none | Solution Export |
| 316 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 317 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 318 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 319 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 320 | [transactioncurrencyid](#index-transactioncurrencyid) |  |  | No |  | Inferred from Usage |
| 321 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 322 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int | No | none | Solution Export |
| 323 | [value](#index-value) |  |  | No |  | Inferred from Usage |
| 324 | [zipcode](#index-zipcode) |  |  | No |  | Inferred from Usage |
| 325 | [{0}](#index-0) |  |  | No |  | Inferred from Usage |
