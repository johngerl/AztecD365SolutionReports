...
|---|-------------|-------------|------|-----------------|--------|----------|-------------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_accountdupid](#azt_accountdupid) | Account Dup | primarykey |  | No | systemrequired | Never | true |  |  |  |  |  |  |  | [7](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_name](#azt_name) | Name | nvarchar |  | Yes | required | Never | true |  |  |  |  |  |  | [3](#2-forms) | [12](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [azt_scoredecimal](#azt_scoredecimal) | Score Decimal | decimal |  | Yes | none | Never | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 4 | [azt_scorestring](#azt_scorestring) | Score String | nvarchar |  | Yes | none | Never | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 5 | [createdby](#createdby) | Created By | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 6 | [createdon](#createdon) | Created On | datetime |  | No | none | Skipped (createdon) | true |  |  |  |  |  |  | [1](#2-forms) | [6](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 9 | [modifiedby](#modifiedby) | Modified By | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
...
| 12 | [organizationid](#organizationid) | Organization Id | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 13 | [overriddencreatedon](#overriddencreatedon) | Record Created On | datetime |  | No | none | Never | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 14 | [statecode](#statecode) | Status | state |  | No | systemrequired | Never | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [statuscode](#statuscode) | Status Reason | status |  | No | none | Never | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
