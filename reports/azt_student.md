...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_age](#index-azt_age) | Age | int |  | Yes | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_city](#index-azt_city) | City | nvarchar |  | Yes | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 3 | [azt_email](#index-azt_email) | Email | nvarchar |  | Yes | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [azt_firstname](#index-azt_firstname) | First Name | nvarchar |  | Yes | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [azt_lastname](#index-azt_lastname) | Last Name | nvarchar |  | Yes | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 6 | [azt_lessonid](#index-azt_lessonid) | Lesson | lookup |  | Yes | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 7 | [azt_lessonnumberid](#index-azt_lessonnumberid) | Lesson Number ID | int |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 8 | [azt_name](#index-azt_name) | Name | nvarchar |  | Yes | required | true |  |  |  |  |  |  | [3](#2-forms) | [10](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [azt_studentid](#index-azt_studentid) | Student | primarykey |  | No | systemrequired | true |  |  |  |  |  |  |  | [7](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 10 | [azt_studentnumberid](#index-azt_studentnumberid) | Student Number ID | int |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 11 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 12 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [5](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 14 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 15 | [modifiedby](#index-modifiedby) | Modified By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 16 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 17 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 18 | [organizationid](#index-organizationid) | Organization Id | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 19 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
