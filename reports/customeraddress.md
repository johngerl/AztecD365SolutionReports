...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [addressnumber](#index-addressnumber) | Address Number | int |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_addresssearch](#index-azt_addresssearch) | Address Search | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [city](#index-city) | City | nvarchar |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  |  |  |  | [1](#11-pcf-controls) |  |  |  |
| 4 | [country](#index-country) | Country/Region | nvarchar |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  |  | [1](#11-pcf-controls) |  |  |  |
| 5 | [county](#index-county) | County | nvarchar |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#11-pcf-controls) |  |  |  |
| 6 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [customeraddressid](#index-customeraddressid) | Address | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [2](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 8 | [fax](#index-fax) | Fax | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 9 | [freighttermscode](#index-freighttermscode) | Freight Terms | picklist |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [line1](#index-line1) | Street 1 | nvarchar |  | No | required | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 11 | [line2](#index-line2) | Street 2 | nvarchar |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 12 | [line3](#index-line3) | Street 3 | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 13 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 14 | [name](#index-name) | Address Name | nvarchar |  | No | required | true |  |  |  |  |  |  |  | [4](#3-views) |  |  |  |  |  | [23](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [objecttypecode](#index-objecttypecode) | Object Type  | entityname |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 16 | [ownerid](#index-ownerid) | Owner | lookup |  | No | required | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 17 | [parentid](#index-parentid) | Parent | lookup |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 18 | [postalcode](#index-postalcode) | ZIP/Postal Code | nvarchar |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 19 | [primarycontactname](#index-primarycontactname) | Address Contact | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 20 | [shippingmethodcode](#index-shippingmethodcode) | Shipping Method | picklist |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 21 | [stateorprovince](#index-stateorprovince) | State/Province | nvarchar |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [2](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 22 | [telephone1](#index-telephone1) | Main Phone | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 23 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
