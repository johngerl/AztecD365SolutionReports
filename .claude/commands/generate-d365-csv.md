...
This is Step 6 of the pipeline. Preserves confirmed SF mapping columns (sfObjectName, sfFieldDisplayName, sfFieldApiName) from existing CSVs. Clears sfSuggested* columns (regenerated by Step 5).
