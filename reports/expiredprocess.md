...
|---|-------------|-------------|------|-----------------|--------|----------|-------------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [businessprocessflowinstanceid](#businessprocessflowinstanceid) | Expired Process Instance Id | uniqueidentifier |  | No | required | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 5 | [name](#name) | Process Name | nvarchar |  | No | required | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [23](#10-plugin-source-code-analysis) |  |  |  |  |
| 6 | [statecode](#statecode) | Status | picklist |  | No | required | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [statuscode](#statuscode) | Status Reason | picklist |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [transactioncurrencyid](#transactioncurrencyid) | Currency | lookup |  | No | none | Never | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
