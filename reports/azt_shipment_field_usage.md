...
- [3. Views](#3-views)
  ...
  - [3.3. My Shipments](#33-my-shipments)
  - [3.4. Order Line Shipments](#34-order-line-shipments)
  - [3.5. Quick Find Active Shipments](#35-quick-find-active-shipments)
  - [3.6. Shipment Advanced Find View](#36-shipment-advanced-find-view)
  - [3.7. Shipment Associated View](#37-shipment-associated-view)
  - [3.8. Shipment Lookup View](#38-shipment-lookup-view)
...
| 109 | [azt_orderid](#index-azt_orderid) | Order | lookup | Yes | none | [1](#2-forms) | [2](#3-views) |  |  |  | [2](#7-workflows) |  | [8](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 110 | [azt_orderlineid](#index-azt_orderlineid) | Order Line | lookup | Yes | required | [1](#2-forms) | [11](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
...
| 145 | [azt_quantity](#index-azt_quantity) | QTY | int | Yes | recommended | [1](#2-forms) | [5](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 158 | [azt_shipmentid](#index-azt_shipmentid) | Shipment | primarykey | No | systemrequired |  | [8](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 159 | [azt_shippingdate](#index-azt_shippingdate) | Shipping Date | datetime | Yes | none | [2](#2-forms) | [6](#3-views) |  |  |  |  |  |  |  |  |  |  |
...
| 174 | [azt_trackingnumber](#index-azt_trackingnumber) | Tracking Number | nvarchar | Yes | none | [2](#2-forms) | [8](#3-views) |  |  |  | [1](#7-workflows) |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 201 | [createdon](#index-createdon) | Created On | datetime | No | none | [1](#2-forms) | [14](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 257 | [ownerid](#index-ownerid) | Owner | owner | No | systemrequired | [3](#2-forms) | [2](#3-views) |  |  |  | [24](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
...
| 307 | [statuscode](#index-statuscode) | Status Reason | status | No | none | [3](#2-forms) | [7](#3-views) |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
...
### <a id="22-shipment-main-active"></a>2.2. Shipment (main) -- Active
...
| Field | Label |
|-------|-------|
| [azt_shippingdate](#index-azt_shippingdate) | Shipping Date |
| [azt_trackingnumber](#index-azt_trackingnumber) | Tracking Number |
...
| [statuscode](#index-statuscode) | Status Reason | No | Yes |
| [azt_quantity](#index-azt_quantity) | QTY | No | Yes |
...
| [azt_orderlineid](#index-azt_orderlineid) | Order Line |
...
### <a id="31-active-shipments"></a>3.1. Active Shipments
...
| # | Field | Width |
|---|-------|-------|
| 1 | [azt_trackingnumber](#index-azt_trackingnumber) | 150px |
| 2 | [azt_shippingdate](#index-azt_shippingdate) | 125px |
| 3 | [azt_quantity](#index-azt_quantity) | 100px |
| 4 | [azt_orderlineid](#index-azt_orderlineid) | 150px |
| 5 | [azt_orderid](#index-azt_orderid) | 150px |
| 6 | [statuscode](#index-statuscode) | 150px |
| 7 | [createdon](#index-createdon) | 125px |
| 8 | [azt_shipmentid](#index-azt_shipmentid) |  |
...
| [azt_orderlineid](#index-azt_orderlineid) | Ascending |

### <a id="32-inactive-shipments"></a>3.2. Inactive Shipments
...
| 3 | [azt_quantity](#index-azt_quantity) | 100px |
| 4 | [azt_orderlineid](#index-azt_orderlineid) | 150px |
| 5 | [statuscode](#index-statuscode) | 150px |
| 6 | [createdon](#index-createdon) | 125px |
| 7 | [azt_shipmentid](#index-azt_shipmentid) |  |
...
### <a id="33-my-shipments"></a>3.3. My Shipments
...
| # | Field | Width |
|---|-------|-------|
| 1 | [azt_shipmentid](#index-azt_shipmentid) |  |
...
### <a id="34-order-line-shipments"></a>3.4. Order Line Shipments
...
| # | Field | Width |
|---|-------|-------|
| 1 | [azt_trackingnumber](#index-azt_trackingnumber) | 300px |
| 2 | [azt_shippingdate](#index-azt_shippingdate) | 125px |
| 3 | [azt_quantity](#index-azt_quantity) | 100px |
| 4 | [statuscode](#index-statuscode) | 150px |
| 5 | [createdon](#index-createdon) | 100px |
| 6 | [azt_shipmentid](#index-azt_shipmentid) |  |
...
### <a id="35-quick-find-active-shipments"></a>3.5. Quick Find Active Shipments
...
|---|-------|-------|
| 1 | [azt_trackingnumber](#index-azt_trackingnumber) | 150px |
| 2 | [azt_shippingdate](#index-azt_shippingdate) | 100px |
| 3 | [azt_quantity](#index-azt_quantity) | 100px |
| 4 | [azt_orderlineid](#index-azt_orderlineid) | 150px |
| 5 | [statuscode](#index-statuscode) | 150px |
| 6 | [createdon](#index-createdon) | 125px |
...
|-------|----------|-------|
| [statecode](#index-statecode) | eq | 0 |
| [azt_trackingnumber](#index-azt_trackingnumber) | like | {0} |
...
### <a id="36-shipment-advanced-find-view"></a>3.6. Shipment Advanced Find View
...
|---|-------|-------|
| 1 | [azt_trackingnumber](#index-azt_trackingnumber) | 150px |
| 2 | [azt_orderlineid](#index-azt_orderlineid) | 150px |
| 3 | [statuscode](#index-statuscode) | 150px |
| 4 | [createdon](#index-createdon) | 100px |
| 5 | [azt_shipmentid](#index-azt_shipmentid) |  |
...
### <a id="37-shipment-associated-view"></a>3.7. Shipment Associated View
...
### <a id="38-shipment-lookup-view"></a>3.8. Shipment Lookup View
...
| 2 | [azt_trackingnumber](#index-azt_trackingnumber) | 150px |
| 3 | [azt_orderlineid](#index-azt_orderlineid) | 150px |
| 4 | [azt_shippingdate](#index-azt_shippingdate) | 150px |
...
Total JS files referencing Azt_shipment fields: **6**
...
Total relationships involving Azt_shipment: **8**

| Relationship Name | Type | Referenced Entity | Referencing Entity | Lookup Field |
|-------------------|------|-------------------|-------------------|-------------|
| azt_salesorder_azt_shipment | N:1 | SalesOrder | azt_shipment | [azt_OrderId](#index-azt_orderid) |
| azt_salesorderdetail_azt_shipment | N:1 | SalesOrderDetail | azt_shipment | [azt_OrderLineId](#index-azt_orderlineid) |
| business_unit_azt_shipment | N:1 | BusinessUnit | azt_shipment | [OwningBusinessUnit](#index-owningbusinessunit) |
| lk_azt_shipment_createdby | N:1 | SystemUser | azt_shipment | [CreatedBy](#index-createdby) |
| lk_azt_shipment_modifiedby | N:1 | SystemUser | azt_shipment | [ModifiedBy](#index-modifiedby) |
| owner_azt_shipment | N:1 | Owner | azt_shipment | [OwnerId](#index-ownerid) |
| team_azt_shipment | N:1 | Team | azt_shipment | [OwningTeam](#index-owningteam) |
| user_azt_shipment | N:1 | SystemUser | azt_shipment | [OwningUser](#index-owninguser) |
...
- [View: Inactive Shipments (Sort)](#32-inactive-shipments)
- [View: Quick Find Active Shipments](#35-quick-find-active-shipments)
- [View: Quick Find Active Shipments (Sort)](#35-quick-find-active-shipments)
- [View: Shipment Advanced Find View](#36-shipment-advanced-find-view)
- [View: Shipment Advanced Find View (Sort)](#36-shipment-advanced-find-view)
- [View: Shipment Associated View](#37-shipment-associated-view)
- [View: Shipment Lookup View](#38-shipment-lookup-view)
- [View: Shipment Lookup View (Sort)](#38-shipment-lookup-view)
- [Plugin: OrderManuallyCreateSoftwareLicense (Write)](#1055-ordermanuallycreatesoftwarelicense)
...
**<a id="index-azt_shipmentid"></a>`azt_shipmentid`**

- [Field Definitions](#1-field-definitions)
- [View: Active Shipments](#31-active-shipments)
- [View: Inactive Shipments](#32-inactive-shipments)
- [View: My Shipments](#33-my-shipments)
- [View: Order Line Shipments](#34-order-line-shipments)
- [View: Quick Find Active Shipments](#35-quick-find-active-shipments)
- [View: Shipment Advanced Find View](#36-shipment-advanced-find-view)
- [View: Shipment Associated View](#37-shipment-associated-view)
...
- [View: Inactive Shipments (Sort)](#32-inactive-shipments)
- [View: Order Line Shipments](#34-order-line-shipments)
- [View: Order Line Shipments (Sort)](#34-order-line-shipments)
- [View: Quick Find Active Shipments](#35-quick-find-active-shipments)
- [View: Quick Find Active Shipments (Sort)](#35-quick-find-active-shipments)
- [View: Shipment Advanced Find View](#36-shipment-advanced-find-view)
- [View: Shipment Advanced Find View (Sort)](#36-shipment-advanced-find-view)
- [View: Shipment Associated View](#37-shipment-associated-view)
- [View: Shipment Associated View (Sort)](#37-shipment-associated-view)
- [View: Shipment Lookup View](#38-shipment-lookup-view)
- [View: Shipment Lookup View (Sort)](#38-shipment-lookup-view)
- [Workflow: CasePendingAssignmentNotification (Read)](#77-casependingassignmentnotification)
- [Workflow: CaseRecordOwnerAssignmentNotification (Read)](#710-caserecordownerassignmentnotification)
...
- [Plugin: Utility (Filter)](#1081-utility)
- [Plugin: Utility (Sort)](#1081-utility)
- [Relationship: owner_azt_shipment](#12-relationships)

**<a id="index-owningbusinessunit"></a>`owningbusinessunit`**

- [Field Definitions](#1-field-definitions)
- [Relationship: business_unit_azt_shipment](#12-relationships)
...
- [Field Definitions](#1-field-definitions)
- [View: Active Shipments (Filter)](#31-active-shipments)
- [View: Inactive Shipments (Filter)](#32-inactive-shipments)
- [View: My Shipments (Filter)](#33-my-shipments)
- [View: Quick Find Active Shipments (Filter)](#35-quick-find-active-shipments)
- [View: Shipment Associated View (Filter)](#37-shipment-associated-view)
- [View: Shipment Lookup View (Filter)](#38-shipment-lookup-view)
- [Workflow: BatchConverttoLead (Write)](#75-batchconverttolead)
