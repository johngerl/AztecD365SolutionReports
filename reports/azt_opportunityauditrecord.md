...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_audittype](#index-azt_audittype) | Audit Type | picklist | 327630000: Probability Change, 327630001: Est Close Change, 327630002: Est Value Change | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_name](#index-azt_name) | Name | nvarchar |  | Yes | required | true |  |  |  |  |  |  | [3](#2-forms) | [10](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [azt_newestclosedate](#index-azt_newestclosedate) | New Est Close Date | datetime |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [azt_newestimatedvalue](#index-azt_newestimatedvalue) | New Estimated Value | money |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [azt_newestimatedvalue_base](#index-azt_newestimatedvalue_base) | New Estimated Value (Base) | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 6 | [azt_newprobability](#index-azt_newprobability) | New Probability | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [azt_opportunityauditrecordid](#index-azt_opportunityauditrecordid) | Opportunity Audit Record | primarykey |  | No | systemrequired | true |  |  |  |  |  |  |  | [7](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [azt_opportunityid](#index-azt_opportunityid) | Opportunity | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [7](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 9 | [azt_previousestclosedate](#index-azt_previousestclosedate) | Previous Est Close Date | datetime |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [azt_previousestimatedvalue](#index-azt_previousestimatedvalue) | Previous Estimated Value | money |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 11 | [azt_previousestimatedvalue_base](#index-azt_previousestimatedvalue_base) | Previous Estimated Value (Base) | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 12 | [azt_previousprobability](#index-azt_previousprobability) | Previous Probability | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 14 | [createdon](#index-createdon) | Changed On | datetime |  | No | none | true |  |  |  |  |  |  | [2](#2-forms) | [7](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 16 | [exchangerate](#index-exchangerate) | Exchange Rate | decimal |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 17 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 18 | [modifiedby](#index-modifiedby) | Modified By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 19 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 20 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 21 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 22 | [ownerid](#index-ownerid) | Changed By | owner |  | No | systemrequired | true |  |  |  |  |  |  | [3](#2-forms) | [2](#3-views) |  |  |  | [24](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 23 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 24 | [owningteam](#index-owningteam) | Owning Team | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 25 | [owninguser](#index-owninguser) | Owning User | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 26 | [statecode](#index-statecode) | Status | state |  | No | systemrequired | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 29 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [20](#7-workflows) |  | [8](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 30 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
