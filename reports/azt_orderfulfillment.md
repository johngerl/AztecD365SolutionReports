...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [activestageid](#index-activestageid) | Active Stage | lookup |  | No | none | true |  |  |  |  |  |  |  | [10](#3-views) |  |  |  | [3](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 2 | [activestagestartedon](#index-activestagestartedon) | Active Stage Started On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 3 | [bpf_duration](#index-bpf_duration) | Duration | int |  | Yes | none | true |  |  |  |  |  |  |  | [2](#3-views) |  |  |  |  | [1](#9-formulas-rollups) | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [bpf_name](#index-bpf_name) | Name | nvarchar |  | Yes | required | true |  |  |  |  |  |  |  | [18](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 5 | [bpf_salesorderid](#index-bpf_salesorderid) | Salesorder | lookup |  | Yes | none | true |  |  |  |  |  |  |  | [10](#3-views) |  |  |  | [1](#7-workflows) |  | [1](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 6 | [businessprocessflowinstanceid](#index-businessprocessflowinstanceid) | Order Fulfillment | primarykey |  | No | systemrequired | true |  |  |  |  |  |  |  | [10](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [completedon](#index-completedon) | Completed On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  | [1](#9-formulas-rollups) |  |  |  |  |  |
| 8 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  | [9](#3-views) |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 9 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  | [9](#3-views) |  |  |  | [7](#7-workflows) | [1](#9-formulas-rollups) | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 11 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 12 | [modifiedby](#index-modifiedby) | Modified By | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [2](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 13 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 14 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 15 | [organizationid](#index-organizationid) | Organization Id | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 16 | [overriddencreatedon](#index-overriddencreatedon) | Record Created On | datetime |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 17 | [processid](#index-processid) | Process | lookup |  | No | none | true |  |  |  |  |  |  |  | [9](#3-views) |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 18 | [statecode](#index-statecode) | Status | state |  | No | systemrequired | true |  |  |  |  |  |  |  | [18](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 19 | [statuscode](#index-statuscode) | Status Reason | status |  | No | none | true |  |  |  |  |  |  |  | [9](#3-views) |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 20 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 21 | [traversedpath](#index-traversedpath) | Traversed Path | nvarchar |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 22 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
