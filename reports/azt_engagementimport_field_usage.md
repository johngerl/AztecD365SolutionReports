...
| 14 | [azt_accountnumber](#index-azt_accountnumber) | Account Number | nvarchar | Yes | none | Solution Export |
...
| 56 | [azt_engagementimportid](#index-azt_engagementimportid) | Engagement Import | primarykey | No | systemrequired | Solution Export |
...
| 63 | [azt_expirationdate](#index-azt_expirationdate) |  |  | Yes |  | Inferred from Usage |
...
| 70 | [azt_fsr](#index-azt_fsr) | FSR | nvarchar | Yes | none | Solution Export |
...
| 85 | [azt_isprint](#index-azt_isprint) |  |  | Yes |  | Inferred from Usage |
| 86 | [azt_issaas](#index-azt_issaas) |  |  | Yes |  | Inferred from Usage |
| 87 | [azt_jobrole](#index-azt_jobrole) |  |  | Yes |  | Inferred from Usage |
| 88 | [azt_jobtitle](#index-azt_jobtitle) |  |  | Yes |  | Inferred from Usage |
| 89 | [azt_lastactivitydate](#index-azt_lastactivitydate) |  |  | Yes |  | Inferred from Usage |
| 90 | [azt_lastmodifiedbyid](#index-azt_lastmodifiedbyid) |  |  | Yes |  | Inferred from Usage |
| 91 | [azt_lastname](#index-azt_lastname) |  |  | Yes |  | Inferred from Usage |
| 92 | [azt_leadimportid](#index-azt_leadimportid) |  |  | Yes |  | Inferred from Usage |
| 93 | [azt_leadsourceid](#index-azt_leadsourceid) |  |  | Yes |  | Inferred from Usage |
| 94 | [azt_licensestatus](#index-azt_licensestatus) |  |  | Yes |  | Inferred from Usage |
| 95 | [azt_licenseterm](#index-azt_licenseterm) |  |  | Yes |  | Inferred from Usage |
| 96 | [azt_licensetermmonths](#index-azt_licensetermmonths) |  |  | Yes |  | Inferred from Usage |
| 97 | [azt_licensetype](#index-azt_licensetype) |  |  | Yes |  | Inferred from Usage |
| 98 | [azt_masecommission](#index-azt_masecommission) |  |  | Yes |  | Inferred from Usage |
| 99 | [azt_mileage](#index-azt_mileage) |  |  | Yes |  | Inferred from Usage |
| 100 | [azt_monthstofilteron](#index-azt_monthstofilteron) |  |  | Yes |  | Inferred from Usage |
| 101 | [azt_name](#index-azt_name) | Name | nvarchar | Yes | required | Solution Export |
| 102 | [azt_newestclosedate](#index-azt_newestclosedate) |  |  | Yes |  | Inferred from Usage |
| 103 | [azt_newestimatedvalue](#index-azt_newestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 104 | [azt_newownerid](#index-azt_newownerid) |  |  | Yes |  | Inferred from Usage |
| 105 | [azt_newprobability](#index-azt_newprobability) |  |  | Yes |  | Inferred from Usage |
| 106 | [azt_nonsaasstatus](#index-azt_nonsaasstatus) |  |  | Yes |  | Inferred from Usage |
| 107 | [azt_nonsaastype](#index-azt_nonsaastype) |  |  | Yes |  | Inferred from Usage |
| 108 | [azt_numberoflicenses](#index-azt_numberoflicenses) |  |  | Yes |  | Inferred from Usage |
| 109 | [azt_opportunityauditrecordid](#index-azt_opportunityauditrecordid) |  |  | Yes |  | Inferred from Usage |
| 110 | [azt_opportunityid](#index-azt_opportunityid) |  |  | Yes |  | Inferred from Usage |
| 111 | [azt_opportunityproductid](#index-azt_opportunityproductid) |  |  | Yes |  | Inferred from Usage |
| 112 | [azt_orderid](#index-azt_orderid) |  |  | Yes |  | Inferred from Usage |
| 113 | [azt_orderlineid](#index-azt_orderlineid) |  |  | Yes |  | Inferred from Usage |
| 114 | [azt_orderproductid](#index-azt_orderproductid) |  |  | Yes |  | Inferred from Usage |
| 115 | [azt_orderstageid](#index-azt_orderstageid) |  |  | Yes |  | Inferred from Usage |
| 116 | [azt_ordertemplatelines](#index-azt_ordertemplatelines) |  |  | Yes |  | Inferred from Usage |
| 117 | [azt_ordertype](#index-azt_ordertype) |  |  | Yes |  | Inferred from Usage |
| 118 | [azt_originatingleadimportid](#index-azt_originatingleadimportid) |  |  | Yes |  | Inferred from Usage |
| 119 | [azt_paid](#index-azt_paid) |  |  | Yes |  | Inferred from Usage |
| 120 | [azt_paidon](#index-azt_paidon) |  |  | Yes |  | Inferred from Usage |
| 121 | [azt_parentopportunityid](#index-azt_parentopportunityid) |  |  | Yes |  | Inferred from Usage |
| 122 | [azt_parentorderid](#index-azt_parentorderid) |  |  | Yes |  | Inferred from Usage |
| 123 | [azt_payablecommission](#index-azt_payablecommission) |  |  | Yes |  | Inferred from Usage |
| 124 | [azt_paymentdate](#index-azt_paymentdate) |  |  | Yes |  | Inferred from Usage |
| 125 | [azt_paymentid](#index-azt_paymentid) |  |  | Yes |  | Inferred from Usage |
| 126 | [azt_percentage](#index-azt_percentage) |  |  | Yes |  | Inferred from Usage |
| 127 | [azt_percentagepaid](#index-azt_percentagepaid) |  |  | Yes |  | Inferred from Usage |
| 128 | [azt_periodend](#index-azt_periodend) |  |  | Yes |  | Inferred from Usage |
| 129 | [azt_periodstart](#index-azt_periodstart) |  |  | Yes |  | Inferred from Usage |
| 130 | [azt_phone](#index-azt_phone) |  |  | Yes |  | Inferred from Usage |
| 131 | [azt_ponumber](#index-azt_ponumber) |  |  | Yes |  | Inferred from Usage |
| 132 | [azt_prefix](#index-azt_prefix) |  |  | Yes |  | Inferred from Usage |
| 133 | [azt_prefixhasseparator](#index-azt_prefixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 134 | [azt_prefixseparator](#index-azt_prefixseparator) |  |  | Yes |  | Inferred from Usage |
| 135 | [azt_prefixseparatorisspace](#index-azt_prefixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 136 | [azt_previousestclosedate](#index-azt_previousestclosedate) |  |  | Yes |  | Inferred from Usage |
| 137 | [azt_previousestimatedvalue](#index-azt_previousestimatedvalue) |  |  | Yes |  | Inferred from Usage |
| 138 | [azt_previousownerid](#index-azt_previousownerid) |  |  | Yes |  | Inferred from Usage |
| 139 | [azt_previousprobability](#index-azt_previousprobability) |  |  | Yes |  | Inferred from Usage |
| 140 | [azt_printproductid](#index-azt_printproductid) |  |  | Yes |  | Inferred from Usage |
| 141 | [azt_printpurchaseid](#index-azt_printpurchaseid) |  |  | Yes |  | Inferred from Usage |
| 142 | [azt_probability](#index-azt_probability) |  |  | Yes |  | Inferred from Usage |
| 143 | [azt_probabilitychangedon](#index-azt_probabilitychangedon) |  |  | Yes |  | Inferred from Usage |
| 144 | [azt_probabilityincreased](#index-azt_probabilityincreased) |  |  | Yes |  | Inferred from Usage |
| 145 | [azt_productdiscountid](#index-azt_productdiscountid) |  |  | Yes |  | Inferred from Usage |
| 146 | [azt_producttype](#index-azt_producttype) |  |  | Yes |  | Inferred from Usage |
| 147 | [azt_purchasedate](#index-azt_purchasedate) |  |  | Yes |  | Inferred from Usage |
| 148 | [azt_quantity](#index-azt_quantity) |  |  | Yes |  | Inferred from Usage |
| 149 | [azt_quotenumber](#index-azt_quotenumber) |  |  | Yes |  | Inferred from Usage |
| 150 | [azt_quoteproductid](#index-azt_quoteproductid) |  |  | Yes |  | Inferred from Usage |
| 151 | [azt_reasonforexpense](#index-azt_reasonforexpense) |  |  | Yes |  | Inferred from Usage |
| 152 | [azt_recordowner](#index-azt_recordowner) |  |  | Yes |  | Inferred from Usage |
| 153 | [azt_recordownerid](#index-azt_recordownerid) |  |  | Yes |  | Inferred from Usage |
| 154 | [azt_replacementproductid](#index-azt_replacementproductid) |  |  | Yes |  | Inferred from Usage |
| 155 | [azt_requestedfreightamt](#index-azt_requestedfreightamt) |  |  | Yes |  | Inferred from Usage |
| 156 | [azt_resolvedbyid](#index-azt_resolvedbyid) |  |  | Yes |  | Inferred from Usage |
| 157 | [azt_result](#index-azt_result) |  |  | Yes |  | Inferred from Usage |
| 158 | [azt_saas](#index-azt_saas) |  |  | Yes |  | Inferred from Usage |
| 159 | [azt_saasstatus](#index-azt_saasstatus) |  |  | Yes |  | Inferred from Usage |
| 160 | [azt_salesrepid](#index-azt_salesrepid) |  |  | Yes |  | Inferred from Usage |
