...
- [3. Views](#3-views)
  ...
  - [3.3. CRM Issue Associated View](#33-crm-issue-associated-view)
  - [3.4. CRM Issue Lookup View](#34-crm-issue-lookup-view)
  - [3.5. Inactive CRM Issues](#35-inactive-crm-issues)
  - [3.6. My CRM Issues](#36-my-crm-issues)
  - [3.7. Quick Find Active CRM Issues](#37-quick-find-active-crm-issues)
...
| 24 | [azt_approved](#index-azt_approved) | Approved? | bit | Yes | none | [1](#2-forms) | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
...
| 43 | [azt_crmissueid](#index-azt_crmissueid) | CRM Issue | primarykey | No | systemrequired |  | [7](#3-views) |  |  |  |  |  |  |  |  |  |  |
...
| 49 | [azt_description](#index-azt_description) | Description | ntext | Yes | none | [1](#2-forms) | [1](#3-views) |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 100 | [azt_name](#index-azt_name) | Issue Name | nvarchar | Yes | required | [3](#2-forms) | [12](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 200 | [createdby](#index-createdby) | Reported By | lookup | No | none | [1](#2-forms) | [1](#3-views) |  |  |  | [25](#7-workflows) |  |  |  | [1](#12-relationships) |  |  |
| 201 | [createdon](#index-createdon) | Reported On | datetime | No | none | [2](#2-forms) | [6](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 251 | [objectid](#index-objectid) |  |  | No |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
...
| 307 | [statuscode](#index-statuscode) | Status Reason | status | No | none | [2](#2-forms) |  |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
...
| Field | Label | Disabled | Visible |
|-------|-------|----------|---------|
| [azt_name](#index-azt_name) | Issue Name | No | Yes |
...
| [createdon](#index-createdon) | Reported On | No | Yes |

### <a id="22-crm-issue-main-active"></a>2.2. CRM Issue (main) -- Active
...
| [azt_approved](#index-azt_approved) | Approved? | No | Yes |
| [createdon](#index-createdon) | Reported On | No | Yes |
| [createdby](#index-createdby) | Reported By | No | Yes |
| [statuscode](#index-statuscode) | Status Reason | No | Yes |
| [ownerid](#index-ownerid) | Owner | No | Yes |
...
### <a id="31-active-crm-issues"></a>3.1. Active CRM Issues
...
| 2 | [createdby](#index-createdby) | 112px |
| 3 | [azt_name](#index-azt_name) | 300px |
| 4 | [azt_description](#index-azt_description) | 106px |
| 5 | [azt_approved](#index-azt_approved) | 103px |
| 6 | [azt_crmissueid](#index-azt_crmissueid) |  |
...
### <a id="32-crm-issue-advanced-find-view"></a>3.2. CRM Issue Advanced Find View
...
| 3 | [azt_crmissueid](#index-azt_crmissueid) |  |
...
### <a id="33-crm-issue-associated-view"></a>3.3. CRM Issue Associated View
...
### <a id="34-crm-issue-lookup-view"></a>3.4. CRM Issue Lookup View
...
### <a id="35-inactive-crm-issues"></a>3.5. Inactive CRM Issues
...
### <a id="36-my-crm-issues"></a>3.6. My CRM Issues
...
| # | Field | Width |
|---|-------|-------|
| 1 | [azt_crmissueid](#index-azt_crmissueid) |  |
...
### <a id="37-quick-find-active-crm-issues"></a>3.7. Quick Find Active CRM Issues
...
|-------------------|------|-------------------|-------------------|-------------|
| azt_crmissue_Annotations | 1:N | azt_CRMIssue | Annotation | [ObjectId](#index-objectid) |
| business_unit_azt_crmissue | N:1 | BusinessUnit | azt_CRMIssue | [OwningBusinessUnit](#index-owningbusinessunit) |
| lk_azt_crmissue_createdby | N:1 | SystemUser | azt_CRMIssue | [CreatedBy](#index-createdby) |
| lk_azt_crmissue_modifiedby | N:1 | SystemUser | azt_CRMIssue | [ModifiedBy](#index-modifiedby) |
| owner_azt_crmissue | N:1 | Owner | azt_CRMIssue | [OwnerId](#index-ownerid) |
| team_azt_crmissue | N:1 | Team | azt_CRMIssue | [OwningTeam](#index-owningteam) |
| user_azt_crmissue | N:1 | SystemUser | azt_CRMIssue | [OwningUser](#index-owninguser) |
...
**<a id="index-azt_approved"></a>`azt_approved`**
...
**<a id="index-azt_crmissueid"></a>`azt_crmissueid`**
...
- [View: CRM Issue Lookup View](#34-crm-issue-lookup-view)
- [View: Inactive CRM Issues](#35-inactive-crm-issues)
- [View: My CRM Issues](#36-my-crm-issues)
- [View: Quick Find Active CRM Issues](#37-quick-find-active-crm-issues)
...
- [View: CRM Issue Advanced Find View](#32-crm-issue-advanced-find-view)
- [View: CRM Issue Advanced Find View (Sort)](#32-crm-issue-advanced-find-view)
- [View: CRM Issue Associated View](#33-crm-issue-associated-view)
- [View: CRM Issue Associated View (Sort)](#33-crm-issue-associated-view)
- [View: CRM Issue Lookup View](#34-crm-issue-lookup-view)
- [View: Inactive CRM Issues](#35-inactive-crm-issues)
- [View: Inactive CRM Issues (Sort)](#35-inactive-crm-issues)
- [View: Quick Find Active CRM Issues](#37-quick-find-active-crm-issues)
- [View: Quick Find Active CRM Issues (Filter)](#37-quick-find-active-crm-issues)
- [View: Quick Find Active CRM Issues (Sort)](#37-quick-find-active-crm-issues)
...
- [Plugin: Utility (Filter)](#1081-utility)
- [Plugin: Utility (Sort)](#1081-utility)
- [Relationship: owner_azt_crmissue](#12-relationships)

**<a id="index-owningbusinessunit"></a>`owningbusinessunit`**

- [Field Definitions](#1-field-definitions)
- [Relationship: business_unit_azt_crmissue](#12-relationships)
...
- [Field Definitions](#1-field-definitions)
- [View: Active CRM Issues (Filter)](#31-active-crm-issues)
- [View: CRM Issue Associated View (Filter)](#33-crm-issue-associated-view)
- [View: CRM Issue Lookup View (Filter)](#34-crm-issue-lookup-view)
- [View: Inactive CRM Issues (Filter)](#35-inactive-crm-issues)
- [View: My CRM Issues (Filter)](#36-my-crm-issues)
- [View: Quick Find Active CRM Issues (Filter)](#37-quick-find-active-crm-issues)
- [Workflow: BatchConverttoLead (Write)](#75-batchconverttolead)
