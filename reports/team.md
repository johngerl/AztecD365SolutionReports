...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_regionalteam](#index-azt_regionalteam) | Regional Team? | bit | 1: Yes, 0: No | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 2 | [azt_stateabbreviation](#index-azt_stateabbreviation) | State Abbreviation | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [5](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [businessunitid](#index-businessunitid) | Business Unit | lookup |  | No | required | true |  |  |  |  |  |  |  | [5](#3-views) |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [delegatedauthorizationid](#index-delegatedauthorizationid) | Delegated authorization | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
| 6 | [description](#index-description) | Description | ntext |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [emailaddress](#index-emailaddress) | Email | nvarchar |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  |  |  |  |  |  |
| 8 | [issastokenset](#index-issastokenset) |  | bit |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 9 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [name](#index-name) | Team Name | nvarchar |  | No | required | true |  |  |  |  |  |  |  | [8](#3-views) |  |  |  | [1](#7-workflows) |  | [23](#10-plugin-source-code-analysis) |  |  |  |  |
| 11 | [queueid](#index-queueid) | Default Queue | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 12 | [regardingobjectid](#index-regardingobjectid) | Regarding Object Id | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [teamid](#index-teamid) | Team | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [4](#3-views) |  |  |  | [1](#7-workflows) |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 14 | [teamtype](#index-teamtype) | Team Type | picklist |  | No | required | true |  |  |  |  |  |  |  | [4](#3-views) |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
