...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [address1_stateorprovince](#index-address1_stateorprovince) | Bill To State/Province | nvarchar |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 2 | [address1_telephone1](#index-address1_telephone1) | Main Phone | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [azt_stateabbreviation](#index-azt_stateabbreviation) | State Abbreviation | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [4](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [businessunitid](#index-businessunitid) | Business Unit | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  | [1](#7-workflows) |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 6 | [description](#index-description) | Description | ntext |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [isdisabled](#index-isdisabled) | Is Disabled | bit |  | No | required | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 8 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [name](#index-name) | Name | nvarchar |  | No | systemrequired | true |  |  |  |  |  |  |  | [7](#3-views) |  |  |  | [16](#7-workflows) |  | [23](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [parentbusinessunitid](#index-parentbusinessunitid) | Parent Business | lookup |  | No | required | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 11 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 12 | [websiteurl](#index-websiteurl) | Website | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  |  |  |  |  |  |
