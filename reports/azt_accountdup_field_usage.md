...
| 11 | [azt_accountdupid](#index-azt_accountdupid) | Account Dup | primarykey | No | systemrequired | Solution Export |
...
| 159 | [azt_scoredecimal](#index-azt_scoredecimal) | Score Decimal | decimal | Yes | none | Solution Export |
| 160 | [azt_scorestring](#index-azt_scorestring) | Score String | nvarchar | Yes | none | Solution Export |
| 161 | [azt_softwarelicenseid](#index-azt_softwarelicenseid) |  |  | Yes |  | Inferred from Usage |
| 162 | [azt_softwareproductid](#index-azt_softwareproductid) |  |  | Yes |  | Inferred from Usage |
| 163 | [azt_startdate](#index-azt_startdate) |  |  | Yes |  | Inferred from Usage |
| 164 | [azt_stateabbreviation](#index-azt_stateabbreviation) |  |  | Yes |  | Inferred from Usage |
| 165 | [azt_stateprovince](#index-azt_stateprovince) |  |  | Yes |  | Inferred from Usage |
| 166 | [azt_suffix](#index-azt_suffix) |  |  | Yes |  | Inferred from Usage |
| 167 | [azt_suffixhasseparator](#index-azt_suffixhasseparator) |  |  | Yes |  | Inferred from Usage |
| 168 | [azt_suffixseparator](#index-azt_suffixseparator) |  |  | Yes |  | Inferred from Usage |
| 169 | [azt_suffixseparatorisspace](#index-azt_suffixseparatorisspace) |  |  | Yes |  | Inferred from Usage |
| 170 | [azt_supportexpirationdate](#index-azt_supportexpirationdate) |  |  | Yes |  | Inferred from Usage |
...
| 201 | [createdby](#index-createdby) | Created By | lookup | No | none | Solution Export |
| 202 | [createdon](#index-createdon) | Created On | datetime | No | none | Solution Export |
| 203 | [createdonbehalfby](#index-createdonbehalfby) | Created By (Delegate) | lookup | No | none | Solution Export |
...
| 209 | [description](#index-description) |  |  | No |  | Inferred from Usage |
...
| 213 | [estimatedclosedate](#index-estimatedclosedate) |  |  | No |  | Inferred from Usage |
| 214 | [estimatedvalue](#index-estimatedvalue) |  |  | No |  | Inferred from Usage |
| 215 | [ext_amt](#index-ext_amt) |  |  | No |  | Inferred from Usage |
| 216 | [extendedamount](#index-extendedamount) |  |  | No |  | Inferred from Usage |
| 217 | [fetchxml](#index-fetchxml) |  |  | No |  | Inferred from Usage |
| 218 | [filename](#index-filename) |  |  | No |  | Inferred from Usage |
| 219 | [firstname](#index-firstname) |  |  | No |  | Inferred from Usage |
| 220 | [freightamount](#index-freightamount) |  |  | No |  | Inferred from Usage |
| 221 | [freighttermscode](#index-freighttermscode) |  |  | No |  | Inferred from Usage |
| 222 | [from](#index-from) |  |  | No |  | Inferred from Usage |
| 223 | [fullname](#index-fullname) |  |  | No |  | Inferred from Usage |
| 224 | [goalenddate](#index-goalenddate) |  |  | No |  | Inferred from Usage |
| 225 | [goalid](#index-goalid) |  |  | No |  | Inferred from Usage |
| 226 | [goalownerid](#index-goalownerid) |  |  | No |  | Inferred from Usage |
| 227 | [goalrollupqueryid](#index-goalrollupqueryid) |  |  | No |  | Inferred from Usage |
| 228 | [goalstartdate](#index-goalstartdate) |  |  | No |  | Inferred from Usage |
| 229 | [importsequencenumber](#index-importsequencenumber) | Import Sequence Number | int | No | none | Solution Export |
| 230 | [incidentid](#index-incidentid) |  |  | No |  | Inferred from Usage |
| 231 | [internalemailaddress](#index-internalemailaddress) |  |  | No |  | Inferred from Usage |
| 232 | [invline.productid](#index-invlineproductid) |  |  | No |  | Inferred from Usage |
| 233 | [invoicedetailid](#index-invoicedetailid) |  |  | No |  | Inferred from Usage |
| 234 | [invoiceid](#index-invoiceid) |  |  | No |  | Inferred from Usage |
| 235 | [invoicenumber](#index-invoicenumber) |  |  | No |  | Inferred from Usage |
| 236 | [isamount](#index-isamount) |  |  | No |  | Inferred from Usage |
| 237 | [isfiscalperiodgoal](#index-isfiscalperiodgoal) |  |  | No |  | Inferred from Usage |
| 238 | [isocurrencycode](#index-isocurrencycode) |  |  | No |  | Inferred from Usage |
| 239 | [ispriceoverridden](#index-ispriceoverridden) |  |  | No |  | Inferred from Usage |
| 240 | [isproductoverridden](#index-isproductoverridden) |  |  | No |  | Inferred from Usage |
| 241 | [isrevenuesystemcalculated](#index-isrevenuesystemcalculated) |  |  | No |  | Inferred from Usage |
| 242 | [jobtitle](#index-jobtitle) |  |  | No |  | Inferred from Usage |
| 243 | [lastname](#index-lastname) |  |  | No |  | Inferred from Usage |
| 244 | [manualdiscountamount](#index-manualdiscountamount) |  |  | No |  | Inferred from Usage |
| 245 | [metricid](#index-metricid) |  |  | No |  | Inferred from Usage |
| 246 | [mimetype](#index-mimetype) |  |  | No |  | Inferred from Usage |
| 247 | [mobilephone](#index-mobilephone) |  |  | No |  | Inferred from Usage |
| 248 | [modifiedby](#index-modifiedby) | Modified By | lookup | No | none | Solution Export |
| 249 | [modifiedon](#index-modifiedon) | Modified On | datetime | No | none | Solution Export |
| 250 | [modifiedonbehalfby](#index-modifiedonbehalfby) | Modified By (Delegate) | lookup | No | none | Solution Export |
| 251 | [name](#index-name) |  |  | No |  | Inferred from Usage |
...
| 256 | [organizationid](#index-organizationid) | Organization Id | lookup | No | none | Solution Export |
...
| 259 | [ownerid](#index-ownerid) |  |  | No |  | Inferred from Usage |
