...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [activityid](#index-activityid) | Phone Call | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [15](#3-views) |  |  |  |  |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 2 | [activitytypecode](#index-activitytypecode) | Activity Type | entityname |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 3 | [actualend](#index-actualend) | Actual End | datetime |  | No | none | true |  |  |  |  |  |  |  | [24](#3-views) | [3](#4-chart-visualizations) |  |  |  |  |  |  |  |  |  |
| 4 | [azt_addtocrtqueue](#index-azt_addtocrtqueue) | Add to CRT Queue? | bit | 1: Yes, 0: No | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [azt_autocreatecallback](#index-azt_autocreatecallback) | Autocreate Callback? | bit | 1: Yes, 0: No | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 6 | [azt_callbackin](#index-azt_callbackin) | Callback In: | picklist | 276530000: 1 Day, 276530001: 2 Days, 276530002: 3 Days, 276530003: 1 Week, 276530004: 1 Month, 276530005: Specific Date | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [azt_callbackon](#index-azt_callbackon) | Callback On | datetime |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 8 | [azt_copydescription](#index-azt_copydescription) | Copy Description? | bit | 1: Yes, 0: No | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [azt_copysubject](#index-azt_copysubject) | Copy Subject? | bit | 1: Yes, 0: No | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [azt_historicalowner](#index-azt_historicalowner) | Historical Owner | nvarchar |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  | [2](#7-workflows) |  |  |  |  |  |  |
| 11 | [azt_phonecallstatus](#index-azt_phonecallstatus) | Phonecall Status | picklist | 276530000: Active, 276530001: Failed, 276530002: Qualified | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 12 | [azt_recordownerid](#index-azt_recordownerid) | Record Owner | lookup |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) | [15](#3-views) | [13](#4-chart-visualizations) |  |  | [37](#7-workflows) |  | [9](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 13 | [azt_result](#index-azt_result) | Result | picklist | 327630000: Connected, 327630001: Left VM, 327630002: No Answer | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 14 | [category](#index-category) | Category | nvarchar |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [createdby](#index-createdby) | Created By | lookup |  | No | none | true |  |  |  |  |  |  |  | [2](#3-views) |  |  |  | [3](#7-workflows) |  |  |  |  |  |  |
| 16 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 17 | [description](#index-description) | Description | ntext |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [14](#7-workflows) |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 18 | [directioncode](#index-directioncode) | Direction | bit |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  |  |  |  |  |  |
| 19 | [from](#index-from) | Call From | partylist |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 20 | [leftvoicemail](#index-leftvoicemail) | Left Voice Mail | bit |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  | [1](#7-workflows) |  |  |  |  |  |  |
| 21 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 22 | [ownerid](#index-ownerid) | Owner | lookup |  | No | required | true |  |  |  |  |  |  |  | [4](#3-views) |  |  |  | [1](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 23 | [phonenumber](#index-phonenumber) | Phone Number | nvarchar |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [3](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 24 | [prioritycode](#index-prioritycode) | Priority | picklist |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  | [1](#7-workflows) |  |  |  |  |  |  |
| 25 | [regardingobjectid](#index-regardingobjectid) | Regarding | lookup |  | No | none | true |  |  |  |  |  |  |  | [4](#3-views) |  |  |  | [14](#7-workflows) |  | [8](#10-plugin-source-code-analysis) |  | [35](#12-relationships) |  |  |
| 26 | [scheduledend](#index-scheduledend) | Due | datetime |  | No | none | true |  |  |  |  |  |  |  | [5](#3-views) |  |  |  | [1](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 27 | [statecode](#index-statecode) | Activity Status | picklist |  | No | required | true |  |  |  |  |  |  |  | [4](#3-views) |  |  |  |  |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 28 | [statuscode](#index-statuscode) | Status Reason | picklist |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 29 | [subject](#index-subject) | Subject | nvarchar |  | No | required | true |  |  |  |  |  |  | [2](#2-forms) | [20](#3-views) |  |  |  | [2](#7-workflows) |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 30 | [to](#index-to) | Call To | partylist |  | No | required | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  | [1](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 31 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
