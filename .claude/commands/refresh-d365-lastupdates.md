Refresh lastUpdate field values in d365-entities/*.json by querying the D365 Dataverse TDS endpoint.

This is a standalone utility (not part of the numbered pipeline). It connects to Dataverse via TDS, queries MAX(modifiedon) per field, and updates the JSON in-place.
