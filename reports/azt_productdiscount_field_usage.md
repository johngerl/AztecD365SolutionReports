...
| 24 | [azt_approvalstatus](#index-azt_approvalstatus) | Approval Status | picklist | Yes | none | Solution Export |
...
| 44 | [azt_customerid](#index-azt_customerid) | Customer | lookup | Yes | none | Solution Export |
...
| 49 | [azt_discountamount](#index-azt_discountamount) | Discount Amt | money | Yes | required | Solution Export |
| 50 | [azt_discountamount_base](#index-azt_discountamount_base) | Discount Amount (Base) | money | Yes | none | Solution Export |
...
| 81 | [azt_invoiceproductid](#index-azt_invoiceproductid) | Invoice Product | lookup | Yes | required | Solution Export |
...
| 109 | [azt_opportunityid](#index-azt_opportunityid) | Opportunity | lookup | Yes | none | Solution Export |
| 110 | [azt_opportunityproductid](#index-azt_opportunityproductid) | Opportunity Product | lookup | Yes | required | Solution Export |
...
| 113 | [azt_orderproductid](#index-azt_orderproductid) | Order Product | lookup | Yes | required | Solution Export |
...
| 144 | [azt_productdiscountid](#index-azt_productdiscountid) | Product Discount | primarykey | No | systemrequired | Solution Export |
...
| 149 | [azt_quoteproductid](#index-azt_quoteproductid) | Quote Product | lookup | Yes | required | Solution Export |
...
| 214 | [exchangerate](#index-exchangerate) | Exchange Rate | decimal | No | none | Solution Export |
...
| 258 | [ownerid](#index-ownerid) | Owner | owner | No | systemrequired | Solution Export |
| 259 | [owningbusinessunit](#index-owningbusinessunit) | Owning Business Unit | lookup | No | none | Solution Export |
| 260 | [owningteam](#index-owningteam) | Owning Team | lookup | No | none | Solution Export |
| 261 | [owninguser](#index-owninguser) | Owning User | lookup | No | none | Solution Export |
| 262 | [parentaccountid](#index-parentaccountid) |  |  | No |  | Inferred from Usage |
| 263 | [parentcontactid](#index-parentcontactid) |  |  | No |  | Inferred from Usage |
| 264 | [parentcustomerid](#index-parentcustomerid) |  |  | No |  | Inferred from Usage |
| 265 | [parentgoalid](#index-parentgoalid) |  |  | No |  | Inferred from Usage |
| 266 | [parentsystemuserid](#index-parentsystemuserid) |  |  | No |  | Inferred from Usage |
| 267 | [partyid](#index-partyid) |  |  | No |  | Inferred from Usage |
| 268 | [phonenumber](#index-phonenumber) |  |  | No |  | Inferred from Usage |
| 269 | [pricelevelid](#index-pricelevelid) |  |  | No |  | Inferred from Usage |
| 270 | [priceperunit](#index-priceperunit) |  |  | No |  | Inferred from Usage |
| 271 | [primarycontactid](#index-primarycontactid) |  |  | No |  | Inferred from Usage |
| 272 | [prod.productid](#index-prodproductid) |  |  | No |  | Inferred from Usage |
| 273 | [productdescription](#index-productdescription) |  |  | No |  | Inferred from Usage |
| 274 | [productid](#index-productid) |  |  | No |  | Inferred from Usage |
| 275 | [productname](#index-productname) |  |  | No |  | Inferred from Usage |
| 276 | [productnumber](#index-productnumber) |  |  | No |  | Inferred from Usage |
| 277 | [producttypecode](#index-producttypecode) |  |  | No |  | Inferred from Usage |
| 278 | [quantity](#index-quantity) |  |  | No |  | Inferred from Usage |
| 279 | [queryentitytype](#index-queryentitytype) |  |  | No |  | Inferred from Usage |
| 280 | [queueid](#index-queueid) |  |  | No |  | Inferred from Usage |
| 281 | [queueitemid](#index-queueitemid) |  |  | No |  | Inferred from Usage |
| 282 | [quotedetailid](#index-quotedetailid) |  |  | No |  | Inferred from Usage |
| 283 | [quoteid](#index-quoteid) |  |  | No |  | Inferred from Usage |
...
| 293 | [salesorderdetailid](#index-salesorderdetailid) |  |  | No |  | Inferred from Usage |
| 294 | [salesorderdetailname](#index-salesorderdetailname) |  |  | No |  | Inferred from Usage |
| 295 | [salesorderid](#index-salesorderid) |  |  | No |  | Inferred from Usage |
| 296 | [salesrepid](#index-salesrepid) |  |  | No |  | Inferred from Usage |
| 297 | [scheduledend](#index-scheduledend) |  |  | No |  | Inferred from Usage |
| 298 | [shippingmethodcode](#index-shippingmethodcode) |  |  | No |  | Inferred from Usage |
| 299 | [shipto_line1](#index-shipto_line1) |  |  | No |  | Inferred from Usage |
| 300 | [shipto_line2](#index-shipto_line2) |  |  | No |  | Inferred from Usage |
| 301 | [shipto_line3](#index-shipto_line3) |  |  | No |  | Inferred from Usage |
| 302 | [shipto_name](#index-shipto_name) |  |  | No |  | Inferred from Usage |
| 303 | [shipto_postalcode](#index-shipto_postalcode) |  |  | No |  | Inferred from Usage |
| 304 | [shipto_stateorprovince](#index-shipto_stateorprovince) |  |  | No |  | Inferred from Usage |
| 305 | [state](#index-state) |  |  | No |  | Inferred from Usage |
| 306 | [statecode](#index-statecode) | Status | state | No | systemrequired | Solution Export |
| 307 | [stateorprovince](#index-stateorprovince) |  |  | No |  | Inferred from Usage |
| 308 | [statuscode](#index-statuscode) | Status Reason | status | No | none | Solution Export |
| 309 | [street](#index-street) |  |  | No |  | Inferred from Usage |
| 310 | [subject](#index-subject) |  |  | No |  | Inferred from Usage |
| 311 | [systemuserid](#index-systemuserid) |  |  | No |  | Inferred from Usage |
| 312 | [tax](#index-tax) |  |  | No |  | Inferred from Usage |
| 313 | [teamid](#index-teamid) |  |  | No |  | Inferred from Usage |
| 314 | [teamtype](#index-teamtype) |  |  | No |  | Inferred from Usage |
| 315 | [telephone1](#index-telephone1) |  |  | No |  | Inferred from Usage |
| 316 | [timezoneruleversionnumber](#index-timezoneruleversionnumber) | Time Zone Rule Version Number | int | No | none | Solution Export |
| 317 | [title](#index-title) |  |  | No |  | Inferred from Usage |
| 318 | [tm.systemuserid](#index-tmsystemuserid) |  |  | No |  | Inferred from Usage |
| 319 | [to](#index-to) |  |  | No |  | Inferred from Usage |
| 320 | [totalamount](#index-totalamount) |  |  | No |  | Inferred from Usage |
| 321 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup | No | none | Solution Export |
| 322 | [uomid](#index-uomid) |  |  | No |  | Inferred from Usage |
| 323 | [utcconversiontimezonecode](#index-utcconversiontimezonecode) | UTC Conversion Time Zone Code | int | No | none | Solution Export |
| 324 | [value](#index-value) |  |  | No |  | Inferred from Usage |
