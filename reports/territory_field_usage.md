# Territory Field Usage Analysis
> Date: 2026-02-28
...
| 208 | [entityimage](#index-entityimage) | Entity Image | image | No | none |  |  |  |  |  |  |  |  |  |  |  |  |
...
| 256 | [parentterritoryid](#index-parentterritoryid) |  |  | No |  |  |  |  |  |  |  |  |  |  | [1](#12-relationships) |  |  |
...
Total reports referencing Territory: **0**

---

## <a id="6-dashboards"></a>6. Dashboards

Total dashboards referencing Territory: **0**

---

## <a id="7-workflows"></a>7. Workflows

Total workflows referencing Territory: **0**

---

## <a id="8-javascript-web-resources"></a>8. JavaScript Web Resources

Total JS files referencing Territory fields: **0**

---

## <a id="9-formulas-rollups"></a>9. Formulas & Rollups

Total formulas for Territory: **0**
...
Total relationships involving Territory: **1**

| Relationship Name | Type | Referenced Entity | Referencing Entity | Lookup Field |
|-------------------|------|-------------------|-------------------|-------------|
| territory_parent_territory | 1:N | Territory | Territory | [ParentTerritoryId](#index-parentterritoryid) |
...
**<a id="index-parentterritoryid"></a>`parentterritoryid`**

- [Field Definitions](#1-field-definitions)
- [Relationship: territory_parent_territory](#12-relationships)
