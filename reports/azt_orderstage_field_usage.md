...
| 15 | [azt_activestageid](#index-azt_activestageid) | Active Stage | lookup | Yes | required | Solution Export |
...
| 19 | [azt_ageendedstage](#index-azt_ageendedstage) | Age Ended Stage | int | Yes | none | Solution Export |
...
| 32 | [azt_changinguserid](#index-azt_changinguserid) | Changing User | lookup | Yes | none | Solution Export |
...
| 47 | [azt_dateexitedstage](#index-azt_dateexitedstage) | Date Exited Stage | datetime | Yes | none | Solution Export |
...
| 111 | [azt_orderid](#index-azt_orderid) | Order | lookup | Yes | required | Solution Export |
...
| 114 | [azt_orderstageid](#index-azt_orderstageid) | Order Stage | primarykey | No | systemrequired | Solution Export |
...
| 201 | [createdon](#index-createdon) | Date Entered Stage | datetime | No | none | Solution Export |
