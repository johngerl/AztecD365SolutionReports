...
- [3. Views](#3-views)
  ...
  - [3.3. Invoice Intacct Payments](#33-invoice-intacct-payments)
  - [3.4. Invoice Payments](#34-invoice-payments)
  - [3.5. My Payments](#35-my-payments)
  - [3.6. Payment Advanced Find View](#36-payment-advanced-find-view)
  - [3.7. Payment Associated View](#37-payment-associated-view)
  - [3.8. Payment Lookup View](#38-payment-lookup-view)
  - [3.9. Quick Find Active Payments](#39-quick-find-active-payments)
...
| 21 | [azt_amount](#index-azt_amount) | Amount | money | Yes | none | [1](#2-forms) | [4](#3-views) |  |  |  | [1](#7-workflows) |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 22 | [azt_amount_base](#index-azt_amount_base) | Amount (Base) | money | Yes | none |  |  |  |  |  |  |  |  |  |  |  |  |
...
| 51 | [azt_duedate](#index-azt_duedate) | Due Date | datetime | Yes | none | [1](#2-forms) | [7](#3-views) |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 79 | [azt_invoice](#index-azt_invoice) | Intacct Invoice # | nvarchar | Yes | none | [1](#2-forms) | [3](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 80 | [azt_invoiceid](#index-azt_invoiceid) | Invoice | lookup | Yes | required | [1](#2-forms) | [4](#3-views) |  |  |  | [2](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
| 81 | [azt_invoicenumber](#index-azt_invoicenumber) | Invoice Number | nvarchar | Yes | none | [1](#2-forms) | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
...
| 101 | [azt_name](#index-azt_name) | Name | nvarchar | Yes | required | [3](#2-forms) | [9](#3-views) |  |  |  | [9](#7-workflows) |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 124 | [azt_paymentdate](#index-azt_paymentdate) | Payment Date | datetime | Yes | none | [1](#2-forms) | [6](#3-views) |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 125 | [azt_paymentid](#index-azt_paymentid) | Payment | primarykey | No | systemrequired |  | [9](#3-views) |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 131 | [azt_ponumber](#index-azt_ponumber) | PO Number | nvarchar | Yes | none | [1](#2-forms) | [3](#3-views) |  |  |  | [2](#7-workflows) |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 202 | [createdon](#index-createdon) | Created On | datetime | No | none | [1](#2-forms) | [4](#3-views) |  |  |  | [7](#7-workflows) |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
...
| 259 | [ownerid](#index-ownerid) | Owner | owner | No | systemrequired | [3](#2-forms) | [2](#3-views) |  |  |  | [24](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  | [1](#12-relationships) |  |  |
...
| 307 | [statecode](#index-statecode) | Status | state | No | systemrequired |  | [5](#3-views) |  |  |  | [10](#7-workflows) |  | [20](#10-plugin-source-code-analysis) |  |  |  |  |
| 308 | [stateorprovince](#index-stateorprovince) |  |  | No |  |  |  |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 309 | [statuscode](#index-statuscode) | Status Reason | status | No | none | [2](#2-forms) | [3](#3-views) |  |  |  | [5](#7-workflows) |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
...
### <a id="22-payment-main-active"></a>2.2. Payment (main) -- Active
...
| Field | Label | Disabled | Visible |
|-------|-------|----------|---------|
| [azt_duedate](#index-azt_duedate) | Due Date | No | Yes |
| [azt_paymentdate](#index-azt_paymentdate) | Payment Date | No | Yes |
| [azt_amount](#index-azt_amount) | Amount | No | Yes |
| [azt_invoice](#index-azt_invoice) | Invoice # | No | Yes |

##### Section: Invoice/PO

| Field | Label | Disabled | Visible |
|-------|-------|----------|---------|
| [azt_invoicenumber](#index-azt_invoicenumber) | Invoice Number | No | Yes |
...
### <a id="31-active-payments"></a>3.1. Active Payments
...
| # | Field | Width |
|---|-------|-------|
| 1 | [azt_amount](#index-azt_amount) | 100px |
| 2 | [azt_duedate](#index-azt_duedate) | 125px |
| 3 | [azt_paymentdate](#index-azt_paymentdate) | 125px |
| 4 | [azt_ponumber](#index-azt_ponumber) | 150px |
| 5 | [azt_invoicenumber](#index-azt_invoicenumber) | 150px |
| 6 | [statuscode](#index-statuscode) | 125px |
| 7 | [azt_invoiceid](#index-azt_invoiceid) | 200px |
| 8 | [azt_paymentid](#index-azt_paymentid) |  |
...
| Field | Direction |
|-------|-----------|
| [azt_invoiceid](#index-azt_invoiceid) | Descending |
| [azt_duedate](#index-azt_duedate) | Ascending |

### <a id="32-inactive-payments"></a>3.2. Inactive Payments
...
| 3 | [azt_paymentid](#index-azt_paymentid) |  |
...
### <a id="33-invoice-intacct-payments"></a>3.3. Invoice Intacct Payments
...
| # | Field | Width |
|---|-------|-------|
| 1 | [azt_invoice](#index-azt_invoice) | 300px |
| 2 | [azt_paymentid](#index-azt_paymentid) |  |

**Sort Order:**

| Field | Direction |
|-------|-----------|
| [azt_invoice](#index-azt_invoice) | Ascending |

### <a id="34-invoice-payments"></a>3.4. Invoice Payments
...
| 3 | [azt_paymentdate](#index-azt_paymentdate) | 125px |
| 4 | [azt_ponumber](#index-azt_ponumber) | 150px |
| 5 | [azt_invoice](#index-azt_invoice) | 125px |
| 6 | [statuscode](#index-statuscode) | 125px |
| 7 | [azt_invoiceid](#index-azt_invoiceid) | 200px |
| 8 | [azt_paymentid](#index-azt_paymentid) |  |
...
| Field | Direction |
|-------|-----------|
| [azt_paymentdate](#index-azt_paymentdate) | Ascending |
| [azt_duedate](#index-azt_duedate) | Ascending |

### <a id="35-my-payments"></a>3.5. My Payments
...
| # | Field | Width |
|---|-------|-------|
| 1 | [azt_paymentid](#index-azt_paymentid) |  |
...
### <a id="36-payment-advanced-find-view"></a>3.6. Payment Advanced Find View
...
|---|-------|-------|
| 1 | [azt_name](#index-azt_name) | 300px |
| 2 | [azt_amount](#index-azt_amount) | 100px |
| 3 | [azt_duedate](#index-azt_duedate) | 100px |
| 4 | [azt_paymentdate](#index-azt_paymentdate) | 100px |
| 5 | [azt_ponumber](#index-azt_ponumber) | 100px |
| 6 | [createdon](#index-createdon) | 125px |
| 7 | [azt_paymentid](#index-azt_paymentid) |  |
...
### <a id="37-payment-associated-view"></a>3.7. Payment Associated View
...
| 4 | [azt_duedate](#index-azt_duedate) | 100px |
| 5 | [azt_paymentdate](#index-azt_paymentdate) | 100px |
| 6 | [azt_amount](#index-azt_amount) | 100px |
...
| Field | Direction |
|-------|-----------|
| [azt_paymentdate](#index-azt_paymentdate) | Descending |
| [azt_duedate](#index-azt_duedate) | Descending |

### <a id="38-payment-lookup-view"></a>3.8. Payment Lookup View
...
### <a id="39-quick-find-active-payments"></a>3.9. Quick Find Active Payments
...
Total JS files referencing Azt_payment fields: **7**
...
Total relationships involving Azt_payment: **8**

| Relationship Name | Type | Referenced Entity | Referencing Entity | Lookup Field |
|-------------------|------|-------------------|-------------------|-------------|
| TransactionCurrency_azt_payment | N:1 | TransactionCurrency | azt_payment | [TransactionCurrencyId](#index-transactioncurrencyid) |
| azt_invoice_azt_payment | N:1 | Invoice | azt_payment | [azt_InvoiceId](#index-azt_invoiceid) |
| business_unit_azt_payment | N:1 | BusinessUnit | azt_payment | [OwningBusinessUnit](#index-owningbusinessunit) |
| lk_azt_payment_createdby | N:1 | SystemUser | azt_payment | [CreatedBy](#index-createdby) |
| lk_azt_payment_modifiedby | N:1 | SystemUser | azt_payment | [ModifiedBy](#index-modifiedby) |
| owner_azt_payment | N:1 | Owner | azt_payment | [OwnerId](#index-ownerid) |
| team_azt_payment | N:1 | Team | azt_payment | [OwningTeam](#index-owningteam) |
| user_azt_payment | N:1 | SystemUser | azt_payment | [OwningUser](#index-owninguser) |
...
|-------------|----------|---------|
| Mark as Paid/Canceled | Mscrm.Form.azt_payment.MainTab.Save.Controls._children | `Mscrm.Form.Deactivate` |
...
- [View: Payment Advanced Find View](#36-payment-advanced-find-view)
- [View: Payment Associated View](#37-payment-associated-view)
- [View: Payment Associated View (Sort)](#37-payment-associated-view)
...
**<a id="index-azt_invoice"></a>`azt_invoice`**
...
- [View: Payment Advanced Find View](#36-payment-advanced-find-view)
- [View: Payment Advanced Find View (Sort)](#36-payment-advanced-find-view)
- [View: Payment Associated View](#37-payment-associated-view)
- [View: Payment Lookup View](#38-payment-lookup-view)
- [View: Quick Find Active Payments](#39-quick-find-active-payments)
- [View: Quick Find Active Payments (Filter)](#39-quick-find-active-payments)
- [View: Quick Find Active Payments (Sort)](#39-quick-find-active-payments)
...
- [View: Invoice Intacct Payments](#33-invoice-intacct-payments)
- [View: Invoice Payments](#34-invoice-payments)
- [View: My Payments](#35-my-payments)
- [View: Payment Advanced Find View](#36-payment-advanced-find-view)
- [View: Payment Associated View](#37-payment-associated-view)
- [View: Payment Lookup View](#38-payment-lookup-view)
- [View: Quick Find Active Payments](#39-quick-find-active-payments)
...
- [View: Invoice Payments](#34-invoice-payments)
- [View: Payment Advanced Find View](#36-payment-advanced-find-view)
- [Workflow: CloneAndDeleteQuote (Read)](#713-cloneanddeletequote)
...
- [Plugin: Utility (Filter)](#1081-utility)
- [Plugin: Utility (Sort)](#1081-utility)
- [Relationship: owner_azt_payment](#12-relationships)
...
- [Field Definitions](#1-field-definitions)
- [View: Active Payments (Filter)](#31-active-payments)
- [View: Inactive Payments (Filter)](#32-inactive-payments)
- [View: My Payments (Filter)](#35-my-payments)
- [View: Payment Lookup View (Filter)](#38-payment-lookup-view)
- [View: Quick Find Active Payments (Filter)](#39-quick-find-active-payments)
- [Workflow: BatchConverttoLead (Write)](#75-batchconverttolead)
...
- [Plugin: Utility (Read)](#1081-utility)
- [Plugin: Utility (Write)](#1081-utility)
- [Relationship: TransactionCurrency_azt_payment](#12-relationships)
