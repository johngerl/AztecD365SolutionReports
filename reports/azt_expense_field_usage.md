...
| 57 | [azt_expenseamount](#index-azt_expenseamount) | Expense Amount | money | Yes | none | Solution Export |
| 58 | [azt_expenseamount_base](#index-azt_expenseamount_base) | Expense Amount (Base) | money | Yes | none | Solution Export |
| 59 | [azt_expensedate](#index-azt_expensedate) | Expense Date | datetime | Yes | none | Solution Export |
| 60 | [azt_expenseid](#index-azt_expenseid) | Expense | primarykey | No | systemrequired | Solution Export |
| 61 | [azt_expensereportid](#index-azt_expensereportid) | Expense Report | lookup | Yes | required | Solution Export |
| 62 | [azt_expensetype](#index-azt_expensetype) | Expense Type | picklist | Yes | required | Solution Export |
...
| 98 | [azt_mileage](#index-azt_mileage) | Mileage | int | Yes | none | Solution Export |
...
| 150 | [azt_reasonforexpense](#index-azt_reasonforexpense) | Reason for Expense | picklist | Yes | required | Solution Export |
...
| 252 | [notescontrol](#index-notescontrol) |  |  | No |  | Inferred from Usage |
