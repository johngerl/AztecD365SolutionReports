...
|---|-------------|-------------|------|-----------------|--------|----------|-------------------|-----------|----------|-------------|---------------------|--------------------|-----------------------|-------|-------|----------------------|---------|------------|-----------|--------------------|---------|--------------|--------------|-----------------------|--------------------------|
| 1 | [azt_discretionarydiscountamt](#index-azt_discretionarydiscountamt) | Discretionary Discount Amt | money |  | Yes | none | true |  |  |  |  |  |  | [1](#2-forms) |  |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 2 | [azt_discretionarydiscountamt_base](#index-azt_discretionarydiscountamt_base) | Discretionary Discount Amt (Base) | money |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 3 | [azt_issaas](#index-azt_issaas) | Is SaaS? | bit | 1: Yes, 0: No | Yes | none | true |  |  |  |  |  |  | [2](#2-forms) |  |  |  |  |  |  | [2](#10-plugin-source-code-analysis) |  |  |  |  |
| 4 | [azt_licensetermmonths](#index-azt_licensetermmonths) | License Term (Months) | int |  | Yes | none | true |  |  |  |  |  |  | [2](#2-forms) | [2](#3-views) |  |  |  | [1](#7-workflows) |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 5 | [azt_licensetype](#index-azt_licensetype) | License Type | picklist |  | Yes | required | true |  |  |  |  |  |  | [2](#2-forms) | [5](#3-views) |  |  |  | [1](#7-workflows) |  | [25](#10-plugin-source-code-analysis) |  |  |  |  |
| 6 | [azt_nonsaastype](#index-azt_nonsaastype) | Non-SaaS Type | picklist | 276530000: Life Skills, 276530001: Kaplan Books, 276530003: GED Vouchers, 276530002: Other | Yes | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [1](#10-plugin-source-code-analysis) |  |  |  |  |
| 7 | [azt_pricebookentry](#index-azt_pricebookentry) | SF Price Book Entry | nvarchar |  | Yes | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 8 | [baseamount](#index-baseamount) | Amount | money |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 9 | [createdon](#index-createdon) | Created On | datetime |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [10](#10-plugin-source-code-analysis) |  |  |  |  |
| 10 | [description](#index-description) | Description | ntext |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [7](#10-plugin-source-code-analysis) |  |  |  |  |
| 11 | [entityimage](#index-entityimage) | Entity Image | image |  | No | none | false |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| 12 | [extendedamount](#index-extendedamount) | Extended amount | money |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [13](#10-plugin-source-code-analysis) |  |  |  |  |
| 13 | [ispriceoverridden](#index-ispriceoverridden) | Price Overridden | bit |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [6](#10-plugin-source-code-analysis) |  |  |  |  |
| 14 | [isproductoverridden](#index-isproductoverridden) | Select Product | bit |  | No | none | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 15 | [manualdiscountamount](#index-manualdiscountamount) | Manual Discount Amount | money |  | No | none | true |  |  |  |  |  |  | [2](#2-forms) |  |  |  |  |  |  | [9](#10-plugin-source-code-analysis) |  |  |  |  |
| 16 | [modifiedon](#index-modifiedon) | Modified On | datetime |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [4](#10-plugin-source-code-analysis) |  |  |  |  |
| 17 | [opportunityid](#index-opportunityid) | Opportunity | lookup |  | No | required | true |  |  |  |  |  |  | [2](#2-forms) | [3](#3-views) |  |  |  |  |  | [32](#10-plugin-source-code-analysis) |  |  |  |  |
| 18 | [opportunityproductid](#index-opportunityproductid) | Opportunity Product | uniqueidentifier |  | No | required | true |  |  |  |  |  |  |  | [6](#3-views) |  |  |  |  |  | [14](#10-plugin-source-code-analysis) |  |  |  |  |
| 19 | [opportunityproductname](#index-opportunityproductname) | Name | nvarchar |  | No | required | true |  |  |  |  |  |  |  | [5](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 20 | [opportunitystatecode](#index-opportunitystatecode) | Opportunity Status | picklist |  | No | required | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  |  |  |  |  |  |
| 21 | [ownerid](#index-ownerid) | Owner | lookup |  | No | required | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [22](#10-plugin-source-code-analysis) |  |  |  |  |
| 22 | [priceperunit](#index-priceperunit) | Price per unit | money |  | No | none | true |  |  |  |  |  |  |  | [3](#3-views) |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 23 | [productdescription](#index-productdescription) | Write-In Product | nvarchar |  | No | none | true |  |  |  |  |  |  |  | [2](#3-views) |  |  |  | [1](#7-workflows) |  | [13](#10-plugin-source-code-analysis) |  |  |  |  |
| 24 | [productid](#index-productid) | Existing Product | lookup |  | No | none | true |  |  |  |  |  |  | [1](#2-forms) | [5](#3-views) |  |  |  |  |  | [33](#10-plugin-source-code-analysis) |  |  |  |  |
| 25 | [productname](#index-productname) | Product name | nvarchar |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 26 | [producttypecode](#index-producttypecode) | Product type | picklist |  | No | required | true |  |  |  |  |  |  |  | [1](#3-views) |  |  |  |  |  | [3](#10-plugin-source-code-analysis) |  |  |  |  |
| 27 | [quantity](#index-quantity) | Quantity | decimal |  | No | required | true | Opportunity Product | Quantity | Quantity |  |  |  |  | [7](#3-views) | [2](#4-chart-visualizations) |  |  |  |  | [18](#10-plugin-source-code-analysis) |  |  |  |  |
| 28 | [tax](#index-tax) | Tax | money |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 29 | [transactioncurrencyid](#index-transactioncurrencyid) | Currency | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
| 30 | [uomid](#index-uomid) | Unit | lookup |  | No | none | true |  |  |  |  |  |  |  |  |  |  |  |  |  | [8](#10-plugin-source-code-analysis) |  |  |  |  |
